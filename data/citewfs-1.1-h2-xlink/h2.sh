...
GT_VERSION=2.5-SNAPSHOT
CP="$H2:$M2_REPO/org/openplans/spatialdbbox/1.0-SNAPSHOT/spatialdbbox-1.0-SNAPSHOT.jar:$M2_REPOy/org/geotools/gt-main/$GT_VERSION/gt-main-$GT_VERSION.jar:$M2_REPO/com/vividsolutions/jts/1.8/jts-1.8.jar"
SF="2"
