 ...
 *
 */
public class AdaptingGeoServerCatalog extends AdaptingCatalog
	implements GeoServerCatalog {

	public AdaptingGeoServerCatalog( ResolveAdapterFactoryFinder adapterFinder ) {
		super( new DefaultGeoServerCatalog(), adapterFinder );
	}
	
	public AdaptingGeoServerCatalog( 
		GeoServerCatalog catalog, ResolveAdapterFactoryFinder adapterFinder 
	) {
