...
public class UpdateSuite extends TransactionSuite {
	...
	public void testXml3() throws Exception {
		...
		CompareFilter compFilter = factory
	...
	/*
	 * public void testXml4() throws Exception { // make base comparison objects
	 * UpdateRequest update = new UpdateRequest();
	 * update.setTypeName("TREESA_1M"); FidFilter tempFilter =
	 * factory.createFidFilter("1010"); update.setFilter(tempFilter);
	 * update.addProperty("TREETYPE", "CONIFEROUS"); UpdateRequest update2 = new
	 * UpdateRequest(); update2.setTypeName("OCEANSA_1M"); CompareFilter
	 * compFilter =
	 ...
	 * tempLeftExp.setAttributePath("DEPTH"); LiteralExpression tempRightExp =
	 * factory.createLiteralExpression(2400);
	 * compFilter.addLeftValue(tempLeftExp);
	 * compFilter.addRightValue(tempRightExp); update2.setFilter(compFilter);
	 * update2.addProperty("DEPTH", new Integer(2400)); TransactionRequest
	 * baseRequest = new TransactionRequest();
	 * baseRequest.addSubRequest(update2); baseRequest.addSubRequest(update);
	 * baseRequest.setVersion("1.0.0"); baseRequest.setService("WFS"); // run
	 * test assertTrue(runXmlTest(baseRequest, "update4", true)); }
	 */
	...
	/*
	 * public void testXml6() throws Exception { UpdateRequest update2 = new
	 * UpdateRequest(); update2.setTypeName("OCEANSA_1M"); CompareFilter
	 * compFilter =
	 * factory.createCompareFilter(AbstractFilter.COMPARE_GREATER_THAN);
	 * AttributeExpression tempLeftExp =
	 * factory.createAttributeExpression(null);
	 * tempLeftExp.setAttributePath("DEPTH"); LiteralExpression tempRightExp =
	 * factory.createLiteralExpression(new Integer(2400));
	 * compFilter.addLeftValue(tempLeftExp);
	 * compFilter.addRightValue(tempRightExp); update2.setFilter(compFilter);
	 * update2.addProperty("DEPTH", new Integer(2400));
	 * update2.addProperty("TREASURE", "Booty");
	 * update2.setHandle("update_booty"); TransactionRequest baseRequest = new
	 * TransactionRequest(); baseRequest.addSubRequest(update2);
	 * baseRequest.setVersion("1.0.0"); baseRequest.setService("WFS");
	 * baseRequest.setHandle("oceans"); // run test
