 ...
 * @version $Id: WMSCapabilitiesResponse.java,v 1.9 2004/09/05 17:19:05
 *          cholmesny Exp $
 */
public class WMSCapabilitiesResponse implements Response {
	/** package's logger */
	private static final Logger LOGGER = Logger
			.getLogger(WMSCapabilitiesResponse.class.getPackage().getName());
	...
	/**
	 * Returns the fixed capabilities MIME type (application/vnd.ogc.wms_xml) as
	 * specified in whe WMS spec, version 1.1.1, section 6.5.3, table 3.
	 * 
	 * @param gs
	 *            DOCUMENT ME!
	 * 
