<?xml version="1.0"?>
<xsl:stylesheet xmlns:mb="http://mapbuilder.sourceforge.net/mapbuilder" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"><xsl:output method="xml" encoding="utf-8"/><xsl:param name="listenerFilter"/><xsl:param name="targetFilter"/><xsl:template match="/mb:Logger"><div style="height:300px;overflow:scroll"><table border="1"><tr><td colspan="2">
          Event Log
