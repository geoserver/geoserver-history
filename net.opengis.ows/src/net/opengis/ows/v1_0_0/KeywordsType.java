 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.KeywordsType#getKeyword <em>Keyword</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.KeywordsType#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getKeywordsType()
...
public interface KeywordsType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getKeywordsType_Keyword()
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getKeywordsType_Type()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.KeywordsType#getType <em>Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
