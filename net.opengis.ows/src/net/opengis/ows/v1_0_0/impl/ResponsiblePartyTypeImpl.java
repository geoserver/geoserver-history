 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ResponsiblePartyTypeImpl#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ResponsiblePartyTypeImpl#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ResponsiblePartyTypeImpl#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ResponsiblePartyTypeImpl#getContactInfo <em>Contact Info</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ResponsiblePartyTypeImpl#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResponsiblePartyTypeImpl extends EObjectImpl implements ResponsiblePartyType {
	...
	protected EClass eStaticClass() {
		return OWSPackage.eINSTANCE.getResponsiblePartyType();
	}
