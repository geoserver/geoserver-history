 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.BoundingBoxTypeImpl#getLowerCorner <em>Lower Corner</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.BoundingBoxTypeImpl#getUpperCorner <em>Upper Corner</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.BoundingBoxTypeImpl#getCrs <em>Crs</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.BoundingBoxTypeImpl#getDimensions <em>Dimensions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoundingBoxTypeImpl extends EObjectImpl implements BoundingBoxType {
	...
	protected EClass eStaticClass() {
		return OWSPackage.eINSTANCE.getBoundingBoxType();
	}
