 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.MetadataType#getAbstractMetaDataGroup <em>Abstract Meta Data Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.MetadataType#getAbstractMetaData <em>Abstract Meta Data</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.MetadataType#getAbout <em>About</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getMetadataType()
...
public interface MetadataType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getMetadataType_AbstractMetaDataGroup()
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getMetadataType_AbstractMetaData()
	 * @model containment="true" resolveProxies="false" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see #setAbout(String)
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getMetadataType_About()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.MetadataType#getAbout <em>About</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
