 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.HTTPType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.HTTPType#getGet <em>Get</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.HTTPType#getPost <em>Post</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getHTTPType()
...
public interface HTTPType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getHTTPType_Group()
	 ...
	 * The list contents are of type {@link net.opengis.ows.v1_0_0.RequestMethodType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getHTTPType_Get()
	 * @model type="net.opengis.ows.v1_0_0.RequestMethodType" containment="true" resolveProxies="false" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getHTTPType_Post()
	 * @model type="net.opengis.ows.v1_0_0.RequestMethodType" containment="true" resolveProxies="false" transient="true" volatile="true" derived="true"
