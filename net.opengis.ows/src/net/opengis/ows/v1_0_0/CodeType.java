 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.CodeType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.CodeType#getCodeSpace <em>Code Space</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getCodeType()
...
public interface CodeType extends EObject {
	 ...
	 * @see #setValue(String)
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getCodeType_Value()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.CodeType#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getCodeType_CodeSpace()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.CodeType#getCodeSpace <em>Code Space</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
