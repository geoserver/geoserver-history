 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getContactInfo <em>Contact Info</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartySubsetType()
...
public interface ResponsiblePartySubsetType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartySubsetType_IndividualName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getIndividualName <em>Individual Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartySubsetType_PositionName()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getPositionName <em>Position Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartySubsetType_ContactInfo()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getContactInfo <em>Contact Info</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartySubsetType_Role()
	 * @model containment="true" resolveProxies="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartySubsetType#getRole <em>Role</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
