...
public class GetMapTest extends AbstractGeoserverHttpTest {
    ...
    public void testImage() throws Exception {
        LOGGER.info("Test: GetMapTest.testImage()");
    ...
    public void testSldBody() throws Exception {
        LOGGER.info("Test: GetMapTest.testSldBody()");
    ...
    public void testSldBodyPost() throws Exception {
        LOGGER.info("Test: GetMapTest.testSldBodyPost()");
    ...
    public void testXmlPost() throws Exception {
        LOGGER.info("Test: GetMapTest.testXmlPost()");
