...
rem AMA - Setup for using JDK 5 JMX jnconsole on localhost
rem note that this doesn't show JBoss MBeans. For that JBoss >= 4.0.3 is needed
rem see http://wiki.jboss.org/wiki/Wiki.jsp?page=FAQJBossJMX
