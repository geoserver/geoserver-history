 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.DomainSubsetType#getSpatialSubset <em>Spatial Subset</em>}</li>
 *   <li>{@link net.opengis.wcs.DomainSubsetType#getTemporalSubset <em>Temporal Subset</em>}</li>
 *   <li>{@link net.opengis.wcs.DomainSubsetType#getTemporalSubset1 <em>Temporal Subset1</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getDomainSubsetType()
...
public interface DomainSubsetType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getDomainSubsetType_SpatialSubset()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.DomainSubsetType#getSpatialSubset <em>Spatial Subset</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getDomainSubsetType_TemporalSubset()
     * @model containment="true"
     ...
     * @see net.opengis.wcs.Wcs10Package#getDomainSubsetType_TemporalSubset1()
     * @model containment="true"
     *        extendedMetaData="kind='element' name='temporalSubset' namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.DomainSubsetType#getTemporalSubset1 <em>Temporal Subset1</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
