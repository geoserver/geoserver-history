 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.DomainSetType#getSpatialDomain <em>Spatial Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.DomainSetType#getTemporalDomain <em>Temporal Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.DomainSetType#getTemporalDomain1 <em>Temporal Domain1</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getDomainSetType()
...
public interface DomainSetType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getDomainSetType_SpatialDomain()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.DomainSetType#getSpatialDomain <em>Spatial Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getDomainSetType_TemporalDomain()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.DomainSetType#getTemporalDomain <em>Temporal Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getDomainSetType_TemporalDomain1()
     * @model containment="true"
     *        extendedMetaData="kind='element' name='temporalDomain' namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.DomainSetType#getTemporalDomain1 <em>Temporal Domain1</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
