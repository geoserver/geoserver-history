 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.SupportedFormatsType#getFormats <em>Formats</em>}</li>
 *   <li>{@link net.opengis.wcs.SupportedFormatsType#getNativeFormat <em>Native Format</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getSupportedFormatsType()
...
public interface SupportedFormatsType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getSupportedFormatsType_Formats()
     ...
     * @see net.opengis.wcs.Wcs10Package#getSupportedFormatsType_NativeFormat()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.SupportedFormatsType#getNativeFormat <em>Native Format</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
