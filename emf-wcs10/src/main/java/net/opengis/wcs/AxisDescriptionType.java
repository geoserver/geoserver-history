 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.AxisDescriptionType#getValues <em>Values</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisDescriptionType#getRefSys <em>Ref Sys</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisDescriptionType#getRefSysLabel <em>Ref Sys Label</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisDescriptionType#getSemantic <em>Semantic</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getAxisDescriptionType()
...
public interface AxisDescriptionType extends AbstractDescriptionType {
     ...
     * @see net.opengis.wcs.Wcs10Package#getAxisDescriptionType_Values()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisDescriptionType#getValues <em>Values</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getAxisDescriptionType_RefSys()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisDescriptionType#getRefSys <em>Ref Sys</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getAxisDescriptionType_RefSysLabel()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisDescriptionType#getRefSysLabel <em>Ref Sys Label</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getAxisDescriptionType_Semantic()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisDescriptionType#getSemantic <em>Semantic</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
