 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.WCSCapabilitiesType#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilitiesType#getCapability <em>Capability</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilitiesType#getContentMetadata <em>Content Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilitiesType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getWCSCapabilitiesType()
...
public interface WCSCapabilitiesType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilitiesType_Service()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilitiesType#getService <em>Service</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilitiesType_Capability()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilitiesType#getCapability <em>Capability</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilitiesType_ContentMetadata()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilitiesType#getContentMetadata <em>Content Metadata</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilitiesType_UpdateSequence()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilitiesType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilitiesType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.WCSCapabilitiesType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetVersion()
     * @see #getVersion()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.WCSCapabilitiesType#getVersion <em>Version</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
