 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.HTTPType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.wcs.HTTPType#getGet <em>Get</em>}</li>
 *   <li>{@link net.opengis.wcs.HTTPType#getPost <em>Post</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getHTTPType()
...
public interface HTTPType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getHTTPType_Group()
     ...
     * The list contents are of type {@link net.opengis.wcs.GetType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.Wcs10Package#getHTTPType_Get()
     * @model type="net.opengis.wcs.GetType" containment="true" transient="true" volatile="true" derived="true"
     ...
     * The list contents are of type {@link net.opengis.wcs.PostType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.Wcs10Package#getHTTPType_Post()
     * @model type="net.opengis.wcs.PostType" containment="true" transient="true" volatile="true" derived="true"
