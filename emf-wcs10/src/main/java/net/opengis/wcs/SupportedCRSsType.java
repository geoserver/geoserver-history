 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.SupportedCRSsType#getRequestResponseCRSs <em>Request Response CR Ss</em>}</li>
 *   <li>{@link net.opengis.wcs.SupportedCRSsType#getRequestCRSs <em>Request CR Ss</em>}</li>
 *   <li>{@link net.opengis.wcs.SupportedCRSsType#getResponseCRSs <em>Response CR Ss</em>}</li>
 *   <li>{@link net.opengis.wcs.SupportedCRSsType#getNativeCRSs <em>Native CR Ss</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getSupportedCRSsType()
...
public interface SupportedCRSsType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getSupportedCRSsType_RequestResponseCRSs()
     ...
     * @see net.opengis.wcs.Wcs10Package#getSupportedCRSsType_RequestCRSs()
     * @model type="net.opengis.gml.CodeListType" containment="true"
     ...
     * @see net.opengis.wcs.Wcs10Package#getSupportedCRSsType_ResponseCRSs()
     * @model type="net.opengis.gml.CodeListType" containment="true"
     ...
     * @see net.opengis.wcs.Wcs10Package#getSupportedCRSsType_NativeCRSs()
     * @model type="net.opengis.gml.CodeListType" containment="true"
