 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ValuesType#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getValuesType()
...
public interface ValuesType extends ValueEnumType {
     ...
     * @see net.opengis.wcs.Wcs10Package#getValuesType_Default()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValuesType#getDefault <em>Default</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
