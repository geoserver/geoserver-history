 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.VendorSpecificCapabilitiesType#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getVendorSpecificCapabilitiesType()
...
public interface VendorSpecificCapabilitiesType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getVendorSpecificCapabilitiesType_Any()
