 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ValueEnumBaseType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueEnumBaseType#getInterval <em>Interval</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueEnumBaseType#getSingleValue <em>Single Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getValueEnumBaseType()
...
public interface ValueEnumBaseType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueEnumBaseType_Group()
     ...
     * The list contents are of type {@link net.opengis.wcs.IntervalType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueEnumBaseType_Interval()
     * @model type="net.opengis.wcs.IntervalType" containment="true" transient="true" volatile="true" derived="true"
     ...
     * The list contents are of type {@link net.opengis.wcs.TypedLiteralType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueEnumBaseType_SingleValue()
     * @model type="net.opengis.wcs.TypedLiteralType" containment="true" transient="true" volatile="true" derived="true"
