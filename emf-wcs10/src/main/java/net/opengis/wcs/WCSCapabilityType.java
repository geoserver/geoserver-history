 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.WCSCapabilityType#getRequest <em>Request</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilityType#getException <em>Exception</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilityType#getVendorSpecificCapabilities <em>Vendor Specific Capabilities</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilityType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.WCSCapabilityType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getWCSCapabilityType()
...
public interface WCSCapabilityType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilityType_Request()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilityType#getRequest <em>Request</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilityType_Exception()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilityType#getException <em>Exception</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilityType_VendorSpecificCapabilities()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilityType#getVendorSpecificCapabilities <em>Vendor Specific Capabilities</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilityType_UpdateSequence()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilityType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getWCSCapabilityType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.WCSCapabilityType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.WCSCapabilityType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetVersion()
     * @see #getVersion()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.WCSCapabilityType#getVersion <em>Version</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
