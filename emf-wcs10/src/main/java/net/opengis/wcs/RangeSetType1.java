 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.RangeSetType1#getRangeSet <em>Range Set</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getRangeSetType1()
...
public interface RangeSetType1 extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getRangeSetType1_RangeSet()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RangeSetType1#getRangeSet <em>Range Set</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
