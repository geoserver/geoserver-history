 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.TelephoneType#getVoice <em>Voice</em>}</li>
 *   <li>{@link net.opengis.wcs.TelephoneType#getFacsimile <em>Facsimile</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getTelephoneType()
...
public interface TelephoneType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getTelephoneType_Voice()
     ...
     * @see net.opengis.wcs.Wcs10Package#getTelephoneType_Facsimile()
     * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
