 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.PostType#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getPostType()
...
public interface PostType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getPostType_OnlineResource()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.PostType#getOnlineResource <em>Online Resource</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
