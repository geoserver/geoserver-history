...
import net.opengis.wcs.AbstractDescriptionBaseType;
import net.opengis.wcs.AbstractDescriptionType;
...
import net.opengis.wcs.DCPTypeType;
...
import net.opengis.wcs.ResponsiblePartyType;
...
import net.opengis.wcs.ValueEnumBaseType;
import net.opengis.wcs.ValueEnumType;
import net.opengis.wcs.ValueRangeType;
import net.opengis.wcs.ValuesType;
...
public class Wcs10PackageImpl extends EPackageImpl implements Wcs10Package {
     ...
     * @see net.opengis.wcs.Wcs10Package#eNS_URI
     * @see #init()
     * @generated
     */
