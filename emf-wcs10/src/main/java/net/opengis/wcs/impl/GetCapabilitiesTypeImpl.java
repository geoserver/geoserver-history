 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.GetCapabilitiesTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.GetCapabilitiesTypeImpl#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.GetCapabilitiesTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.GetCapabilitiesTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
