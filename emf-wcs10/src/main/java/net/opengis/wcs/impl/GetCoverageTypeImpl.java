 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.GetCoverageTypeImpl#getSourceCoverage <em>Source Coverage</em>}</li>
 ...
 *   <li>{@link net.opengis.wcs.impl.GetCoverageTypeImpl#getInterpolationMethod <em>Interpolation Method</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.GetCoverageTypeImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.GetCoverageTypeImpl#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.GetCoverageTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
