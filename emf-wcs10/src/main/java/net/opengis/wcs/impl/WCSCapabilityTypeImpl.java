 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilityTypeImpl#getRequest <em>Request</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilityTypeImpl#getException <em>Exception</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilityTypeImpl#getVendorSpecificCapabilities <em>Vendor Specific Capabilities</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilityTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilityTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
