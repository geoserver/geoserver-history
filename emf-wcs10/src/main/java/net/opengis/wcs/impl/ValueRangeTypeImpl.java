 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.ValueRangeTypeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ValueRangeTypeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ValueRangeTypeImpl#isAtomic <em>Atomic</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ValueRangeTypeImpl#getClosure <em>Closure</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ValueRangeTypeImpl#getSemantic <em>Semantic</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ValueRangeTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
