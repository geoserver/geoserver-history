 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.TimeSequenceType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.wcs.TimeSequenceType#getTimePosition <em>Time Position</em>}</li>
 *   <li>{@link net.opengis.wcs.TimeSequenceType#getTimePeriod <em>Time Period</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getTimeSequenceType()
...
public interface TimeSequenceType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getTimeSequenceType_Group()
     ...
     * @see net.opengis.wcs.Wcs10Package#getTimeSequenceType_TimePosition()
     ...
     * The list contents are of type {@link net.opengis.wcs.TimePeriodType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.Wcs10Package#getTimeSequenceType_TimePeriod()
     * @model type="net.opengis.wcs.TimePeriodType" containment="true" transient="true" volatile="true" derived="true"
