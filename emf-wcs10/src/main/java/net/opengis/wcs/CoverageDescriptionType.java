 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getCoverageOffering <em>Coverage Offering</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getCoverageDescriptionType()
...
public interface CoverageDescriptionType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.wcs.CoverageOfferingType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageDescriptionType_CoverageOffering()
     * @model type="net.opengis.wcs.CoverageOfferingType" containment="true" required="true"
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageDescriptionType_UpdateSequence()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageDescriptionType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageDescriptionType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageDescriptionType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.CoverageDescriptionType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetVersion()
     * @see #getVersion()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.CoverageDescriptionType#getVersion <em>Version</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
