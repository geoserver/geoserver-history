 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ContactType#getPhone <em>Phone</em>}</li>
 *   <li>{@link net.opengis.wcs.ContactType#getAddress <em>Address</em>}</li>
 *   <li>{@link net.opengis.wcs.ContactType#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getContactType()
...
public interface ContactType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getContactType_Phone()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ContactType#getPhone <em>Phone</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getContactType_Address()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ContactType#getAddress <em>Address</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getContactType_OnlineResource()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ContactType#getOnlineResource <em>Online Resource</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
