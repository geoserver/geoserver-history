 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.RangeSetType#getAxisDescription <em>Axis Description</em>}</li>
 *   <li>{@link net.opengis.wcs.RangeSetType#getNullValues <em>Null Values</em>}</li>
 *   <li>{@link net.opengis.wcs.RangeSetType#getRefSys <em>Ref Sys</em>}</li>
 *   <li>{@link net.opengis.wcs.RangeSetType#getRefSysLabel <em>Ref Sys Label</em>}</li>
 *   <li>{@link net.opengis.wcs.RangeSetType#getSemantic <em>Semantic</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getRangeSetType()
...
public interface RangeSetType extends AbstractDescriptionType {
     ...
     * The list contents are of type {@link net.opengis.wcs.AxisDescriptionType1}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getRangeSetType_AxisDescription()
     * @model type="net.opengis.wcs.AxisDescriptionType1" containment="true"
     ...
     * @see net.opengis.wcs.Wcs10Package#getRangeSetType_NullValues()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RangeSetType#getNullValues <em>Null Values</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getRangeSetType_RefSys()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RangeSetType#getRefSys <em>Ref Sys</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getRangeSetType_RefSysLabel()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RangeSetType#getRefSysLabel <em>Ref Sys Label</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getRangeSetType_Semantic()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RangeSetType#getSemantic <em>Semantic</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
