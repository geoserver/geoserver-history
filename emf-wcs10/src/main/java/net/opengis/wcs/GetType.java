 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.GetType#getOnlineResource <em>Online Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getGetType()
...
public interface GetType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetType_OnlineResource()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.GetType#getOnlineResource <em>Online Resource</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
