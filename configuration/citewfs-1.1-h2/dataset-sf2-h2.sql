...
INSERT INTO "PrimitiveGeoFeature" VALUES ('description-f001', 'name-f001', NULL, NULL, NULL, 155, 'http://www.opengeospatial.org/', 12765, NULL, ParseDateTime('2006-10-25 GMT','yyyy-MM-dd','en','GMT'), 5.03, NULL, 'f001');
INSERT INTO "geometry" values ('g003', NULL, 'description-g003', 'POINT', GeomFromText('POINT(2.00342 39.73245)',4326) );
INSERT INTO "geometry_associations" VALUES ('PrimitiveGeoFeature.f001', 'pointProperty', 'g003', false );

-- PrimitiveGeoFeature.f002
INSERT INTO "PrimitiveGeoFeature" VALUES ('description-f002', 'name-f002', NULL, NULL, NULL, 154, 'http://www.opengeospatial.org/', 12769, NULL, ParseDateTime('2006-10-23 GMT','yyyy-MM-dd','en','GMT'), 4.02, NULL, 'f002');
INSERT INTO "geometry" values ('g001', NULL, 'description-g001', 'POINT', GeomFromText('POINT(0.22601 59.41276)',4326));
INSERT INTO "geometry_associations" VALUES ('PrimitiveGeoFeature.f002', 'pointProperty', 'g001', false );
...
INSERT INTO "PrimitiveGeoFeature" VALUES ('description-f008', 'name-f008', NULL, NULL, NULL, 300, NULL, 783.5, '2006-06-28T07:08:00+02:00', ParseDateTime('2006-12-12 GMT','yyyy-MM-dd z','en','GMT'), 18.92, NULL, 'f008');
...
INSERT INTO "geometry_associations" VALUES ('PrimitiveGeoFeature.f008', 'polygonProperty', 'g005', false );
...
INSERT INTO "PrimitiveGeoFeature" VALUES ('description-f091', 'name-f091',  NULL, NULL, NULL, -12678967543233, NULL, -0.1278, NULL, NULL, 21.98, 'f003','f091');
INSERT INTO "geometry" values ('g091', NULL, NULL, 'POINT', GeomFromText('POINT(-2.19433 49.84136)',4326));
INSERT INTO "geometry_associations" VALUES ('PrimitiveGeoFeature.f091', 'pointProperty', 'g091', false );
INSERT INTO "feature_associations" VALUES ('PrimitiveGeoFeature.f091', 'PrimitiveGeoFeature', 'id', 'f003' );

-- PrimitiveGeoFeature.f092 (xlink)
INSERT INTO "PrimitiveGeoFeature" VALUES ('description-f092', 'name-f092',  NULL, NULL, NULL, 4567, NULL, 1445.57, '2007-08-21T14:47:24+01:00', NULL, 3.14, 'f091','f092');
INSERT INTO "feature_associations" VALUES ('PrimitiveGeoFeature.f092', 'PrimitiveGeoFeature', 'id', 'f091' );

-- PrimitiveGeoFeature.f093 (xlink)
INSERT INTO "PrimitiveGeoFeature" VALUES ('description-f093', 'name-f093', NULL, GeomFromText('POINT(9.19251 49.63245)',4326), NULL, -1234, NULL, 1594.01, NULL, NULL, 9.86, NULL,'f093');
INSERT INTO "feature_associations" VALUES ('PrimitiveGeoFeature.f093', 'PrimitiveGeoFeature', 'id', 'f094' );

-- PrimitiveGeoFeature.f094 (xlink)
INSERT INTO "PrimitiveGeoFeature" VALUES ('description-f094', 'name-f094', NULL, NULL, GeomFromText('LINESTRING(8.799 36.074,9.466 36.652,10.021 37.114)',4326), 0, NULL, 2.03, NULL, NULL, 11.45,'http://vancouver1.demo.galdosinc.com/wfs/http?request=GetFeature&service=WFS&version=1.1.0&typename=sf:PrimitiveGeoFeature#f205','f094');
INSERT INTO "feature_associations" VALUES ('PrimitiveGeoFeature.f094', 'PrimitiveGeoFeature', 'id', 'http://vancouver1.demo.galdosinc.com/wfs/http?request=GetFeature&service=WFS&version=1.1.0&typename=sf:PrimitiveGeoFeature#f205' );
...
INSERT INTO "EntitéGénérique" VALUES ('description-f004','name-f004',NULL,true,'abc3','name-f003', 'f004');
...
INSERT INTO "geometry_associations" VALUES ( 'EntitéGénérique.f004', 'attribut.Géométrie', 'g002', false );

-- EntitéGénérique.f007
INSERT INTO "EntitéGénérique" VALUES ('description-f007','name-f007',NULL,false,'def4',NULL,'f007');
...
INSERT INTO "geometry_associations" VALUES ( 'EntitéGénérique.f007', 'attribut.Géométrie', 'g004', false );
...
ALTER TABLE "LinkedFeature" ADD "id" varchar not null;
ALTER TABLE "LinkedFeature" ADD primary key ("id");

INSERT INTO "feature_relationships" VALUES ( 'LinkedFeature', 'reference' );

-- LinkedFeature.f201
INSERT INTO "LinkedFeature" VALUES ( NULL, 'name-f201', 'f091', NULL, 'f201' );
INSERT INTO "feature_associations" VALUES ( 'LinkedFeature.f201', 'PrimitiveGeoFeature', 'id', 'f091' );

-- LinkedFeature.f202
INSERT INTO "LinkedFeature" VALUES ( 'description-f202', 'name-f202', 'f092', NULL, 'f202' );
INSERT INTO "geometry" VALUES ( 'g202', NULL, NULL, 'POINT', GeomFromText('POINT(-2.17433 49.86136)' ,4326));
INSERT INTO "geometry_associations" VALUES ('LinkedFeature.f202', 'extent', 'g202', false);
INSERT INTO "feature_associations" VALUES ( 'LinkedFeature.f202', 'PrimitiveGeoFeature', 'id', 'f092' );

-- LinkedFeature.f203
INSERT INTO "LinkedFeature" VALUES ( 'description-f203', 'name-f203', 'f204', NULL, 'f203' );
INSERT INTO "feature_associations" VALUES ( 'LinkedFeature.f203', 'LinkedFeature', 'id', 'f204' );

-- LinkedFeature.f204
INSERT INTO "LinkedFeature" VALUES ( 'description-f204', 'name-f204', 'f201', NULL, 'f204' );
...
INSERT INTO "geometry_associations" VALUES ('LinkedFeature.f204','extent', 'g204', false );
INSERT INTO "feature_associations" VALUES ( 'LinkedFeature.f204', 'LinkedFeature', 'id', 'f201' );

-- LinkedFeature.f205
INSERT INTO "LinkedFeature" VALUES ( NULL, 'name-f205', 'f203', NULL, 'f205' );
INSERT INTO "geometry_associations" VALUES ('LinkedFeature.f205','extent','g002',true);
INSERT INTO "feature_associations" VALUES ('LinkedFeature.f205', 'LinkedFeature', 'id', 'f203');

-- LinkedFeature.f206
INSERT INTO "LinkedFeature" VALUES ( 'description-f206', 'name-f206','f207', GeomFromText('POINT(9.19251 49.63245)',4326),'f206');
INSERT INTO "feature_associations" VALUES ('LinkedFeature.f206', 'LinkedFeature', 'id', 'f207');

-- LinkedFeature.f207
INSERT INTO "LinkedFeature" VALUES ( 'description-f207', 'name-f207', 'f210', NULL,'f207' );
INSERT INTO "feature_associations" VALUES ('LinkedFeature.f207', 'LinkedFeature', 'id', 'f210');

-- LinkedFeature.f208
INSERT INTO "LinkedFeature" VALUES ( 'description-f208', 'name-f208', 'ftp://vancouver1.demo.galdosinc.com/wfs/http?request=GetFeature&service=WFS&version=1.1.0&typename=sf:LinkedFeature#f205', NULL, 'f208');
INSERT INTO "feature_associations" VALUES ('LinkedFeature.f208', 'NonExistant', 'id', 'ftp://vancouver1.demo.galdosinc.com/wfs/http?request=GetFeature&service=WFS&version=1.1.0&typename=sf:LinkedFeature#f205' );

-- LinkedFeature.f209
INSERT INTO "LinkedFeature" VALUES ( 'description-f209', 'name-f209', '_6c566516-a435-11dc-8314-0800200c9a66', NULL,'f209');
INSERT INTO "feature_associations" VALUES ('LinkedFeature.f209', 'NonExistant', 'id', '_6c566516-a435-11dc-8314-0800200c9a66' );

-- LinkedFeature.f210
INSERT INTO "LinkedFeature" VALUES ( 'description-f210', 'name-f210','f206', NULL,'f210' );
INSERT INTO "feature_associations" VALUES ('LinkedFeature.f210', 'LinkedFeature', 'id', 'f206');
