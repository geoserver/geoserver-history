...
set CP="%H2%";"%M2_REPO%/org/openplans/spatialdbbox/1.0-SNAPSHOT/spatialdbbox-1.0-SNAPSHOT.jar";"%M2_REPO%/org/geotools/gt2-main/2.4-SNAPSHOT/gt2-main-2.4-SNAPSHOT.jar";"%M2_REPO%/com/vividsolutions/jts/1.8/jts-1.8.jar"
echo Classpath: %CP%
set SF="2"
