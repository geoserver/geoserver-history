...
public class TestConfig {
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().appendSuper(super.equals(object)).append(this.args, rhs.args)
                                  .append(this.plugIn, rhs.plugIn)
                                  .append(this.description, rhs.description)
                                  .append(this.pds, rhs.pds).append(this.name, rhs.name).isEquals();
    }
     ...
     */
    public int hashCode() {
        return new HashCodeBuilder(335894267, -1174578945).appendSuper(super.hashCode())
                                                          .append(this.args).append(this.plugIn)
                                                          .append(this.description).append(this.pds)
