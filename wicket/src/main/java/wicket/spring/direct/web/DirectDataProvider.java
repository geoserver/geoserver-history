/*
 * $Id: DirectDataProvider.java 3482 2005-12-23 23:04:02Z ivaynberg $
 * $Revision: 3482 $
...
import wicket.spring.common.web.GeoServerApplication;

public class DirectDataProvider extends ContactDataProvider {

	protected ContactDao getContactDao() {
		return ((GeoServerApplication)Application.get()).getContactDao();
	}
