 ...
 * XML Schema.
 * $Id: MetadataURLTypeDescriptor.java,v 1.1 2002/08/22 15:34:26 robhranac Exp $
 */
...
**/
public class MetadataURLTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MetadataURLTypeDescriptor() {
        super();
        xmlName = "MetadataURLType";
        ...
        //-- _format
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_format", "format", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public Object getValue( Object object ) 
                throws IllegalStateException
    ...
    } //-- org.vfny.geoserver.config.featureType.MetadataURLTypeDescriptor()
    ...
    **/
    ...
    {
        return org.vfny.geoserver.config.featureType.MetadataURLType.class;
