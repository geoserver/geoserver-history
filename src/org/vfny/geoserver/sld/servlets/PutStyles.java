...
public class PutStyles extends AbstractService {
	...
	public void doPost(HttpServletRequest request,
        ...
        PutStylesRequest serviceRequest = new PutStylesRequest();
	...
	{
		javax.xml.parsers.DocumentBuilderFactory dbf = javax.xml.
			parsers.DocumentBuilderFactory.newInstance();
	 ...
	 * @throws WmsException 
	 */
	private void processSLD(PutStylesRequest serviceRequest, HttpServletRequest request, HttpServletResponse response, ServletContext context) 
