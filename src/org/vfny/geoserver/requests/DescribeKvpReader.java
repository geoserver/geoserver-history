 ...
 * @version $Id: DescribeKvpReader.java,v 1.3 2003/09/12 21:04:25 cholmesny Exp $
 */
public class DescribeKvpReader extends RequestKvpReader {
    /**
     * Constructor with raw request string.  Calls parent.
     *
     * @param request The raw request containing describe.
     */
    public DescribeKvpReader(String request) {
        super(request);
    }
     ...
     *
     * @return Describe request object.
     */
    public DescribeRequest getRequest() {
        ...
        currentRequest.setFeatureTypes(readFlat(
                (String) kvpPairs.get("TYPENAME"), INNER_DELIMETER));
