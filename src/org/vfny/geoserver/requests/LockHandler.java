...
public class LockHandler 
    ...
    private LockRequest.Lock curLock;

    /** Empty constructor. */
    public LockHandler () { super(); }
    

    /** Returns the GetLock request. */ 
    public LockRequest getRequest() { return request; }
    ...
    public void filter(Filter filter) {
	    ...
	    /* REVISIT: most likely do nothing here...
