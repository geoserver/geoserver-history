 ...
 * @version $Id: LockRequest.java,v 1.4 2003/09/15 16:29:52 cholmesny Exp $
 */
public class LockRequest extends Request {
     ...
     *
     * @param lockAll <tt>true</tt> If the request should fail if all are not locked.
     */
    ...
    /**
     * Sets the lock list for this request.  Gets rid of the old
     * lock list.
     *
