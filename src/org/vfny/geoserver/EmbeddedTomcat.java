...
public class EmbeddedTomcat {
	...
	public void unregisterWAR(String contextPath) throws Exception {
		...
		if (context != null) {
			...
			throw new Exception(
				"Context does not exist for named path : " + contextPath);
		}
	}
	...
	public static void main(String args[]) {
		...
		if (System.getProperty("GEOSERVER_HOME") != null) {
			File testHome =
				new File(
					System.getProperty("GEOSERVER_HOME")
						+ "/libraries/catalina/embedded.jar");
			if (testHome.exists()) {
			...
			if (testHome.exists()) {
				...
				System.out.println("Startup/Shutdown command unsucessful...");
				System.out.println(
					"You have not specified the GEOSERVER_HOME ");
				System.out.println("environmental variable and you are not");
				System.out.println(
					"starting GeoServer from the root GeoServer");
