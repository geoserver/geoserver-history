 ...
 * @version $Id: DataDataStoresSelectAction.java,v 1.3 2004/01/21 00:26:07 dmzwiers Exp $
 */
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        if ("edit".equals(buttonAction)) {
            ...
            System.out.println("@@@@@ BEFORE @@@@ "
                + ConfigRequests.getDataConfig(request).listDataStoreIds());
        ...
        throw new ServletException(
            "Action must equal either 'edit' or 'delete'");
    }
}
