...
public class GWCCatalogListener implements CatalogListener, Configuration {
    ...
    public GWCCatalogListener(Catalog cat, Dispatcher gsDispatcher, GridSetBroker gridSetBroker,
            ApplicationContextProvider ctxProv, GWCCleanser cleanser) {
    ...
    public List<TileLayer> getTileLayers(boolean reload) throws GeoWebCacheException {
        ...
        log.fine("Responding with " + list.size()
