...
class ColorMapLegendCreator {
    ...
    static class Builder {
         ...
         * 
         * @param cEntry
         *            a {@link ColorMapEntry} element for this builder so that it can take it into
        ...
        public void addColorMapEntry(final ColorMapEntry cEntry) {
            ...
            switch (colorMapType) {
            case UNIQUE_VALUES:
                element = new SingleColorMapEntryLegendBuilder(Arrays.asList(cEntry), hAlign,
                        vAlign, backgroundColor, 1.0, grayChannelName, requestedDimension,
                        labelFont, labelFontColor, extended, borderColor);
                break;
            case RAMP:
                element = new RampColorMapEntryLegendBuilder(Arrays.asList(previousCMapEntry,
                        cEntry), hAlign, vAlign, backgroundColor, 1.0, grayChannelName,
                        requestedDimension, labelFont, labelFontColor, extended, borderColor);
                break;
            case CLASSES:
                element = new ClassesEntryLegendBuilder(Arrays.asList(previousCMapEntry, cEntry),
                        hAlign, vAlign, backgroundColor, 1.0, grayChannelName, requestedDimension,
                        labelFont, labelFontColor, extended, borderColor);
                break;
            default:
         ...
         * 
         * @param colorMapType
         *            the {@link ColorMapType} for this legend builder in order to instruct it on
         ...
         * 
         * @param colorMapType
         *            a int representing a {@link ColorMapType} for this legend builder in order to
