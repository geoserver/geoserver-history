...
public class DimensionsGetFeatureInfoTest extends WMSDimensionsTestSupport {
    ...
    protected void setUpInternal() throws Exception {
        ...
        baseFeatureInfo = "wms?service=WMS&version=1.1.1&request=GetFeatureInfo&bbox=-180,-90,180,90"
            + "&styles=&Format=image/png&width=80&height=40&srs=EPSG:4326&layers=" + getLayerId(V_TIME_ELEVATION) +
            "&query_layers=" + getLayerId(V_TIME_ELEVATION) + "&feature_count=50";
