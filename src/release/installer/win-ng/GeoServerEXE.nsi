...
!define APPNAMEANDVERSION "GeoServer 2.0.0"

; Main Install settings
Name "${APPNAMEANDVERSION}"
InstallDir "$PROGRAMFILES\${APPNAMEANDVERSION}"
InstallDirRegKey HKLM "Software\${APPNAME}" ""
OutFile "geoserver-2.0.0-ng.exe"
...
; Optional welcome text here
  !define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the installation of GeoServer 2.0.0. \r\n\r\n\
