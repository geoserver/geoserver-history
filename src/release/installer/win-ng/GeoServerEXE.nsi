...
!define APPNAMEANDVERSION "GeoServer 2.0-RC1"

; Main Install settings
Name "${APPNAMEANDVERSION}"
InstallDir "$PROGRAMFILES\${APPNAMEANDVERSION}"
InstallDirRegKey HKLM "Software\${APPNAME}" ""
OutFile "geoserver-2.0-RC1-ng.exe"
...
; Optional welcome text here
  !define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the installation of GeoServer 2.0-RC1. \r\n\r\n\
