...
;General
  ...
  ;Name and file
  Name "GeoServer 1.7.5-SNAPSHOT"
  OutFile "geoserver-1.7.5-SNAPSHOT.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\GeoServer 1.7.5-SNAPSHOT"
  
  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "Software\GeoServer-1.7.5-SNAPSHOT" ""
...
;Interface Settings
  ...
  !define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the \
                                installation of GeoServer 1.7.5-SNAPSHOT.  \
...
Section "GeoServer Section" SecGeoServer
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\Start GeoServer.lnk" \
                   ...
                   "$INSTDIR\webapps\geoserver\images\gs.ico" 0 SW_SHOWNORMAL
    CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\Stop GeoServer.lnk" \
                   ...
                   "$INSTDIR\webapps\geoserver\images\gs.ico" 0 SW_SHOWMINIMIZED
...
Section "Uninstall"
  ...
  IfFileExists "$INSTDIR" 0 Removed
     MessageBox MB_YESNO|MB_ICONQUESTION \
          "Remove all files in your GeoServer 1.7.5-SNAPSHOT directory? (If you have anything you created that you want to keep, click No)" IDNO Removed
     Delete "$INSTDIR\*.*"
     RMDIR /r "$INSTDIR"
     Sleep 500
     IfFileExists "$INSTDIR" 0 Removed
