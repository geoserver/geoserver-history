...
;General
  ...
  ;Name and file
  Name "GeoServer 1.7.7"
  OutFile "geoserver-1.7.7.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\GeoServer 1.7.7"
  
  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "Software\GeoServer-1.7.7" ""
...
;Interface Settings
  ...
  !define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the \
                                installation of GeoServer 1.7.7.  \
...
Section "Uninstall"
  ...
  IfFileExists "$INSTDIR" 0 Removed
     MessageBox MB_YESNO|MB_ICONQUESTION \
          "Remove all files in your GeoServer 1.7.7 directory? (If you have anything you created that you want to keep, click No)" IDNO Removed
     Delete "$INSTDIR\*.*"
     RMDIR /r "$INSTDIR"
     Sleep 500
     IfFileExists "$INSTDIR" 0 Removed
