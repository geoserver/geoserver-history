 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.DescribeCoverageType1#getDCPType <em>DCP Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getDescribeCoverageType1()
...
public interface DescribeCoverageType1 extends EObject {
     ...
     * The list contents are of type {@link net.opengis.wcs.DCPTypeType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.Wcs10Package#getDescribeCoverageType1_DCPType()
     * @model type="net.opengis.wcs.DCPTypeType" containment="true" required="true"
