 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.KeywordsType#getKeyword <em>Keyword</em>}</li>
 *   <li>{@link net.opengis.wcs.KeywordsType#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getKeywordsType()
...
public interface KeywordsType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getKeywordsType_Keyword()
     ...
     * @see net.opengis.wcs.Wcs10Package#getKeywordsType_Type()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.KeywordsType#getType <em>Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
