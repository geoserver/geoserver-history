 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.RangeSubsetType#getAxisSubset <em>Axis Subset</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getRangeSubsetType()
...
public interface RangeSubsetType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getRangeSubsetType_AxisSubset()
     * @model type="net.opengis.wcs.AxisSubsetType" containment="true" required="true"
