 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.GetCoverageType1#getDCPType <em>DCP Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getGetCoverageType1()
...
public interface GetCoverageType1 extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType1_DCPType()
