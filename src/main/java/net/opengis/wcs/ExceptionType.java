 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ExceptionType#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getExceptionType()
...
public interface ExceptionType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getExceptionType_Format()
