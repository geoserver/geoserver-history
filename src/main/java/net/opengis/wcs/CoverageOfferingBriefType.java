 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.CoverageOfferingBriefType#getLonLatEnvelope <em>Lon Lat Envelope</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageOfferingBriefType#getKeywords <em>Keywords</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingBriefType()
...
public interface CoverageOfferingBriefType extends AbstractDescriptionType {
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingBriefType_LonLatEnvelope()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageOfferingBriefType#getLonLatEnvelope <em>Lon Lat Envelope</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingBriefType_Keywords()
