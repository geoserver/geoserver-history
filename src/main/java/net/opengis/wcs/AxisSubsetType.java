 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.AxisSubsetType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getAxisSubsetType()
...
public interface AxisSubsetType extends ValueEnumBaseType {
     ...
     * @see #setName(String)
     * @see net.opengis.wcs.Wcs10Package#getAxisSubsetType_Name()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisSubsetType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
