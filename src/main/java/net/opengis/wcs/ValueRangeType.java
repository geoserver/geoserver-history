 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ValueRangeType#getMin <em>Min</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueRangeType#getMax <em>Max</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueRangeType#isAtomic <em>Atomic</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueRangeType#getClosure <em>Closure</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueRangeType#getSemantic <em>Semantic</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueRangeType#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getValueRangeType()
...
public interface ValueRangeType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueRangeType_Min()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueRangeType#getMin <em>Min</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueRangeType_Max()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueRangeType#getMax <em>Max</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueRangeType_Atomic()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueRangeType#isAtomic <em>Atomic</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.ValueRangeType#isAtomic <em>Atomic</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetAtomic()
     * @see #isAtomic()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.ValueRangeType#isAtomic <em>Atomic</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueRangeType_Closure()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueRangeType#getClosure <em>Closure</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.ValueRangeType#getClosure <em>Closure</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetClosure()
     * @see #getClosure()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.ValueRangeType#getClosure <em>Closure</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueRangeType_Semantic()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueRangeType#getSemantic <em>Semantic</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setType(String)
     * @see net.opengis.wcs.Wcs10Package#getValueRangeType_Type()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueRangeType#getType <em>Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
