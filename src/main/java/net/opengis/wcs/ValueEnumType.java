 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ValueEnumType#getSemantic <em>Semantic</em>}</li>
 *   <li>{@link net.opengis.wcs.ValueEnumType#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getValueEnumType()
...
public interface ValueEnumType extends ValueEnumBaseType {
     ...
     * @see net.opengis.wcs.Wcs10Package#getValueEnumType_Semantic()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueEnumType#getSemantic <em>Semantic</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setType(String)
     * @see net.opengis.wcs.Wcs10Package#getValueEnumType_Type()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ValueEnumType#getType <em>Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
