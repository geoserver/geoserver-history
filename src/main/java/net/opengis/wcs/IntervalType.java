 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.IntervalType#getRes <em>Res</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getIntervalType()
...
public interface IntervalType extends ValueRangeType {
     ...
     * @see net.opengis.wcs.Wcs10Package#getIntervalType_Res()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.IntervalType#getRes <em>Res</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
