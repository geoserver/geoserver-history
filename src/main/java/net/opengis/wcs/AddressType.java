 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.AddressType#getDeliveryPoint <em>Delivery Point</em>}</li>
 *   <li>{@link net.opengis.wcs.AddressType#getCity <em>City</em>}</li>
 *   <li>{@link net.opengis.wcs.AddressType#getAdministrativeArea <em>Administrative Area</em>}</li>
 *   <li>{@link net.opengis.wcs.AddressType#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link net.opengis.wcs.AddressType#getCountry <em>Country</em>}</li>
 *   <li>{@link net.opengis.wcs.AddressType#getElectronicMailAddress <em>Electronic Mail Address</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getAddressType()
...
public interface AddressType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getAddressType_DeliveryPoint()
     ...
     * @see #setCity(String)
     * @see net.opengis.wcs.Wcs10Package#getAddressType_City()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AddressType#getCity <em>City</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getAddressType_AdministrativeArea()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AddressType#getAdministrativeArea <em>Administrative Area</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getAddressType_PostalCode()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AddressType#getPostalCode <em>Postal Code</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getAddressType_Country()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AddressType#getCountry <em>Country</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getAddressType_ElectronicMailAddress()
     * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
