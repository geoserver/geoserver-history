 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.OutputType#getCrs <em>Crs</em>}</li>
 *   <li>{@link net.opengis.wcs.OutputType#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getOutputType()
...
public interface OutputType extends EObject {
     ...
     * @see #setCrs(CodeType)
     * @see net.opengis.wcs.Wcs10Package#getOutputType_Crs()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.OutputType#getCrs <em>Crs</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getOutputType_Format()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.OutputType#getFormat <em>Format</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
