 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.SpatialDomainTypeImpl#getEnvelopeGroup <em>Envelope Group</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.SpatialDomainTypeImpl#getEnvelope <em>Envelope</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.SpatialDomainTypeImpl#getGridGroup <em>Grid Group</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.SpatialDomainTypeImpl#getGrid <em>Grid</em>}</li>
