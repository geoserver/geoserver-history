 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilitiesTypeImpl#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilitiesTypeImpl#getCapability <em>Capability</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilitiesTypeImpl#getContentMetadata <em>Content Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilitiesTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.WCSCapabilitiesTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
