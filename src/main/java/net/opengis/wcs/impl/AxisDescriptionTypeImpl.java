 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.AxisDescriptionTypeImpl#getValues <em>Values</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.AxisDescriptionTypeImpl#getRefSys <em>Ref Sys</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.AxisDescriptionTypeImpl#getRefSysLabel <em>Ref Sys Label</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.AxisDescriptionTypeImpl#getSemantic <em>Semantic</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
