 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.ResponsiblePartyTypeImpl#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ResponsiblePartyTypeImpl#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ResponsiblePartyTypeImpl#getOrganisationName1 <em>Organisation Name1</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ResponsiblePartyTypeImpl#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ResponsiblePartyTypeImpl#getContactInfo <em>Contact Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
