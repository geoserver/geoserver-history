 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.RangeSetTypeImpl#getAxisDescription <em>Axis Description</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.RangeSetTypeImpl#getNullValues <em>Null Values</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.RangeSetTypeImpl#getRefSys <em>Ref Sys</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.RangeSetTypeImpl#getRefSysLabel <em>Ref Sys Label</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.RangeSetTypeImpl#getSemantic <em>Semantic</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
