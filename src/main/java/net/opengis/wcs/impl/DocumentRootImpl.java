...
import net.opengis.wcs.Wcs10Package;
 ...
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getAxisDescription <em>Axis Description</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getAxisDescription1 <em>Axis Description1</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getCapability <em>Capability</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getContentMetadata <em>Content Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getCoverageDescription <em>Coverage Description</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getCoverageOffering <em>Coverage Offering</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getCoverageOfferingBrief <em>Coverage Offering Brief</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getDescribeCoverage <em>Describe Coverage</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getDomainSet <em>Domain Set</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getFormats <em>Formats</em>}</li>
 ...
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getInterpolationMethod <em>Interpolation Method</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getInterval <em>Interval</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getLonLatEnvelope <em>Lon Lat Envelope</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getMetadataLink <em>Metadata Link</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getRangeSet <em>Range Set</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getRangeSet1 <em>Range Set1</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getSingleValue <em>Single Value</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getSpatialDomain <em>Spatial Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getSpatialSubset <em>Spatial Subset</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getSupportedCRSs <em>Supported CR Ss</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getSupportedFormats <em>Supported Formats</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getSupportedInterpolations <em>Supported Interpolations</em>}</li>
 ...
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getTimePeriod <em>Time Period</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getTimeSequence <em>Time Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getWCSCapabilities <em>WCS Capabilities</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getClosure <em>Closure</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getSemantic <em>Semantic</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.DocumentRootImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
