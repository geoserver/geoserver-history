 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getCoverageOfferingBrief <em>Coverage Offering Brief</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.ContentMetadataTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
