 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ServiceType#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link net.opengis.wcs.ServiceType#getResponsibleParty <em>Responsible Party</em>}</li>
 *   <li>{@link net.opengis.wcs.ServiceType#getFees <em>Fees</em>}</li>
 *   <li>{@link net.opengis.wcs.ServiceType#getAccessConstraints <em>Access Constraints</em>}</li>
 *   <li>{@link net.opengis.wcs.ServiceType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.ServiceType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getServiceType()
...
public interface ServiceType extends AbstractDescriptionType {
     ...
     * The list contents are of type {@link net.opengis.wcs.KeywordsType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getServiceType_Keywords()
     * @model type="net.opengis.wcs.KeywordsType" containment="true"
     ...
     * @see net.opengis.wcs.Wcs10Package#getServiceType_ResponsibleParty()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ServiceType#getResponsibleParty <em>Responsible Party</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getServiceType_Fees()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ServiceType#getFees <em>Fees</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getServiceType_AccessConstraints()
     ...
     * @see net.opengis.wcs.Wcs10Package#getServiceType_UpdateSequence()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ServiceType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getServiceType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ServiceType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.ServiceType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetVersion()
     * @see #getVersion()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.ServiceType#getVersion <em>Version</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
