 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.MetadataLinkType#getMetadataType <em>Metadata Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getMetadataLinkType()
...
public interface MetadataLinkType extends MetadataAssociationType {
     ...
     * The literals are from the enumeration {@link net.opengis.wcs.MetadataTypeType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.Wcs10Package#getMetadataLinkType_MetadataType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.MetadataLinkType#getMetadataType <em>Metadata Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.MetadataLinkType#getMetadataType <em>Metadata Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetMetadataType()
     * @see #getMetadataType()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.MetadataLinkType#getMetadataType <em>Metadata Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
