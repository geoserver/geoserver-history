 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.CoverageOfferingType#getDomainSet <em>Domain Set</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageOfferingType#getRangeSet <em>Range Set</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageOfferingType#getSupportedCRSs <em>Supported CR Ss</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageOfferingType#getSupportedFormats <em>Supported Formats</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageOfferingType#getSupportedInterpolations <em>Supported Interpolations</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingType()
...
public interface CoverageOfferingType extends CoverageOfferingBriefType {
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingType_DomainSet()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageOfferingType#getDomainSet <em>Domain Set</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingType_RangeSet()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageOfferingType#getRangeSet <em>Range Set</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingType_SupportedCRSs()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageOfferingType#getSupportedCRSs <em>Supported CR Ss</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingType_SupportedFormats()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageOfferingType#getSupportedFormats <em>Supported Formats</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getCoverageOfferingType_SupportedInterpolations()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageOfferingType#getSupportedInterpolations <em>Supported Interpolations</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
