 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link net.opengis.wcs.ResponsiblePartyType#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link net.opengis.wcs.ResponsiblePartyType#getOrganisationName1 <em>Organisation Name1</em>}</li>
 *   <li>{@link net.opengis.wcs.ResponsiblePartyType#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link net.opengis.wcs.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getResponsiblePartyType()
...
public interface ResponsiblePartyType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getResponsiblePartyType_IndividualName()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getResponsiblePartyType_OrganisationName()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ResponsiblePartyType#getOrganisationName <em>Organisation Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getResponsiblePartyType_OrganisationName1()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
     *        extendedMetaData="kind='element' name='organisationName' namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ResponsiblePartyType#getOrganisationName1 <em>Organisation Name1</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getResponsiblePartyType_PositionName()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ResponsiblePartyType#getPositionName <em>Position Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getResponsiblePartyType_ContactInfo()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
