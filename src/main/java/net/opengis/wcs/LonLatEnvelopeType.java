 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.LonLatEnvelopeType#getTimePosition <em>Time Position</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getLonLatEnvelopeType()
...
public interface LonLatEnvelopeType extends LonLatEnvelopeBaseType {
     ...
     * @see net.opengis.wcs.Wcs10Package#getLonLatEnvelopeType_TimePosition()
