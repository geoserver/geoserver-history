 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.TypedLiteralType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.wcs.TypedLiteralType#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getTypedLiteralType()
...
public interface TypedLiteralType extends EObject {
     ...
     * @see #setValue(String)
     * @see net.opengis.wcs.Wcs10Package#getTypedLiteralType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TypedLiteralType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setType(String)
     * @see net.opengis.wcs.Wcs10Package#getTypedLiteralType_Type()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TypedLiteralType#getType <em>Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
