 ...
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getTimePeriodType()
...
public interface TimePeriodType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getTimePeriodType_BeginPosition()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TimePeriodType#getBeginPosition <em>Begin Position</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getTimePeriodType_EndPosition()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TimePeriodType#getEndPosition <em>End Position</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getTimePeriodType_TimeResolution()
     ...
     * @see #unsetFrame()
     * @see #setFrame(String)
     * @see net.opengis.wcs.Wcs10Package#getTimePeriodType_Frame()
