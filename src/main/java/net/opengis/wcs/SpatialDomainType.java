 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.SpatialDomainType#getEnvelopeGroup <em>Envelope Group</em>}</li>
 *   <li>{@link net.opengis.wcs.SpatialDomainType#getEnvelope <em>Envelope</em>}</li>
 *   <li>{@link net.opengis.wcs.SpatialDomainType#getGridGroup <em>Grid Group</em>}</li>
 *   <li>{@link net.opengis.wcs.SpatialDomainType#getGrid <em>Grid</em>}</li>
 *   <li>{@link net.opengis.wcs.SpatialDomainType#getPolygon <em>Polygon</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getSpatialDomainType()
...
public interface SpatialDomainType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getSpatialDomainType_EnvelopeGroup()
     ...
     * @see net.opengis.wcs.Wcs10Package#getSpatialDomainType_Envelope()
     ...
     * @see net.opengis.wcs.Wcs10Package#getSpatialDomainType_GridGroup()
     ...
     * @see net.opengis.wcs.Wcs10Package#getSpatialDomainType_Grid()
     ...
     * @see net.opengis.wcs.Wcs10Package#getSpatialDomainType_Polygon()
