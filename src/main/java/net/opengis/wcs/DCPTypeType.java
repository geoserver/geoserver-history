 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.DCPTypeType#getHTTP <em>HTTP</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getDCPTypeType()
...
public interface DCPTypeType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getDCPTypeType_HTTP()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.DCPTypeType#getHTTP <em>HTTP</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
