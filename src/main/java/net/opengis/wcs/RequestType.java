 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.RequestType#getGetCapabilities <em>Get Capabilities</em>}</li>
 *   <li>{@link net.opengis.wcs.RequestType#getDescribeCoverage <em>Describe Coverage</em>}</li>
 *   <li>{@link net.opengis.wcs.RequestType#getGetCoverage <em>Get Coverage</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getRequestType()
...
public interface RequestType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getRequestType_GetCapabilities()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RequestType#getGetCapabilities <em>Get Capabilities</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getRequestType_DescribeCoverage()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RequestType#getDescribeCoverage <em>Describe Coverage</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getRequestType_GetCoverage()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.RequestType#getGetCoverage <em>Get Coverage</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
