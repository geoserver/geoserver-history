 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.GetCoverageType#getSourceCoverage <em>Source Coverage</em>}</li>
 ...
 *   <li>{@link net.opengis.wcs.GetCoverageType#getInterpolationMethod <em>Interpolation Method</em>}</li>
 *   <li>{@link net.opengis.wcs.GetCoverageType#getOutput <em>Output</em>}</li>
 *   <li>{@link net.opengis.wcs.GetCoverageType#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wcs.GetCoverageType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.Wcs10Package#getGetCoverageType()
...
public interface GetCoverageType extends EObject {
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType_SourceCoverage()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.GetCoverageType#getSourceCoverage <em>Source Coverage</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType_DomainSubset()
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType_RangeSubset()
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType_InterpolationMethod()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.GetCoverageType#getInterpolationMethod <em>Interpolation Method</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.GetCoverageType#getInterpolationMethod <em>Interpolation Method</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetInterpolationMethod()
     * @see #getInterpolationMethod()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.GetCoverageType#getInterpolationMethod <em>Interpolation Method</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType_Output()
     * @model containment="true" required="true"
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType_Service()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.GetCoverageType#getService <em>Service</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.GetCoverageType#getService <em>Service</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetService()
     * @see #getService()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.GetCoverageType#getService <em>Service</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.Wcs10Package#getGetCoverageType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.GetCoverageType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.GetCoverageType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetVersion()
     * @see #getVersion()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.GetCoverageType#getVersion <em>Version</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
