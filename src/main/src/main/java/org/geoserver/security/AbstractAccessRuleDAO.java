...
public abstract class AbstractAccessRuleDAO<R extends Comparable> {
    ...
    protected AbstractAccessRuleDAO(String propertyFileName) throws IOException {
        try {
            this.securityDir = GeoserverDataDirectory.findConfigDir(null, "security");
        } 
