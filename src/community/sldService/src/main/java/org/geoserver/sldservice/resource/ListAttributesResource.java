    ...
    protected Object handleObjectGet() {
        ...
        if (layerInfo != null) {
    		...
    		if (obj instanceof FeatureTypeInfo) {
    			...
    			List<AttributeTypeInfoDTO> generated;
				try {
					generated = DataTransferObjectFactory.generateAttributes(fTpInfo.getFeatureType());
				} catch (IOException e) {
					return new ArrayList();
				}
    			...
    			for (AttributeTypeInfoDTO attr : generated) {
    				out.addAttribute(attr.getName(), attr.getType());
    			}
