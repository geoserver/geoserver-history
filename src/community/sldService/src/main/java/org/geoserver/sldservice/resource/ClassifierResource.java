...
public class ClassifierResource extends AbstractCatalogResource {
    ...
    public ClassifierResource(Context context, Request request,
	...
	protected Object handleObjectGet() throws Exception {
        ...
        if (rules != null)
            jsonRules = generateRulesList(getRequest(), rules);
    ...
    private RulesList generateRulesList(Request req, List<Rule> rules) {

    	RulesList ruleList = new RulesList();
        for (Rule rule : rules) {
	...
	/* (non-Javadoc)
	 * @see org.geoserver.catalog.rest.AbstractCatalogResource#createJSONFormat(org.restlet.data.Request, org.restlet.data.Response)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.geoserver.catalog.rest.CatalogResourceBase#createHTMLFormat(org.restlet.data.Request, org.restlet.data.Response)
	 */
	@Override
