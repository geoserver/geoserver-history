...
/**
 * Mainly copied from FeatureTypeInfoImpl. <BR>
...
public class FeatureTypeInfoImplHb extends FeatureTypeInfoImpl implements FeatureTypeInfo,
        Hibernable {
    ...
    public String toString() {
        return new StringBuilder(getClass().getSimpleName()).append('[').append("id:").append(
                getId()).append(" name:").append(getName()).append(" ").append(
                getStore() != null ? getStore().toString() : " noStore").append(" llbbox:").append(
                getLatLonBoundingBox()).append(" natbbox:").append(getNativeBoundingBox()).append(
                ']').toString();
    }
