...
public class SampleDataAccessMockData implements TestData {
	...
	public SampleDataAccessMockData() throws IOException {
		data = IOUtils.createRandomDirectory("./target",
				"sample-data-access-mock", "data");
		data.delete();
		data.mkdir();
	}
	...
	public void setUp() throws Exception {
		setUpCatalog();
		copyTo(MockData.class.getResourceAsStream("services.xml"),
				"services.xml");
	}
	...
	protected void setUpCatalog() throws IOException {
		...
		writer.coverageStores(new HashMap(), new HashMap(),
