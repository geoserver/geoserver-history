...
public class RBACPolicyFinder extends PolicyFinder {
	...
	/* 
	 * @see com.sun.xacml.finder.PolicyFinder#getModules()
	 * throws nsupportedOperationException
	 */
	@Override
	...
	/*
	 * @see com.sun.xacml.finder.PolicyFinder#setModules(java.util.Set)
    ...
    /**
     * 
     * @return the RPS Modules
     * Uses the functionallity of the base class
     */
    ...
    /**
     * @param modules, the RPS finder modules
     * Uses the functionallity of the base class
     */
     ...
     * @param modules, Set of PPS finder modules
     * @return null if all finder modules support find by reference,
     * 			otherwise the first module found not supporting find by reference
     */
	...
	public PolicyFinderResult findPolicy(URI idReference, int type, VersionConstraints constraints, PolicyMetaData parentMetaData) throws IllegalArgumentException {
		...
		PolicyFinderResult result = ppsFinder.findPolicy(idReference, type, constraints, parentMetaData);
		
		if (result.indeterminate()) return result; // error condition
