...
public class PolymorphismWfsTest extends AbstractAppSchemaWfsTestSupport {
    ...
    /**
     * Test filtering polymorphism with feature chaining set up works. 
     * Also tests filtering when mappingName is used as linkElement. 
     */
...
//                <OCQL>VALUE_ID</OCQL>   
//                <linkElement>
//                    Recode(CLASS_TEXT, 'numeric', 'NumericType', 'literal', 'gsml:CGI_TermValue', 'invalid', Expression.NIL)
//                </linkElement>
...
//        <isMultiple>true</isMultiple>
    ...
    /**
     * Test filtering polymorphism with no feature chaining works. 
     * Also tests filtering when mappingName is used as linkElement. 
     */
...
//            <sourceExpression>
//                    <linkElement>
//                        Recode(CLASS_TEXT, 'NULL', 'NullValue', 'numeric', 'NumericType', 'literal', 'TermValue2')
//                    </linkElement>
//            </sourceExpression>
//        </AttributeMapping>
        String xml = //
...
//        </AttributeMapping>
    ...
    private void checkPolymorphismOnly() {
        ...
        assertXpathEvaluatesTo("0",
                "//ex:PolymorphicFeature[@gml:id='f2']/ex:secondValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("1",
                "//ex:PolymorphicFeature[@gml:id='f4']/ex:secondValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("0",
                "//ex:PolymorphicFeature[@gml:id='f5']/ex:secondValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("1000",
                "//ex:PolymorphicFeature[@gml:id='f6']/ex:secondValue/gsml:CGI_TermValue/gsml:value", doc);
    }
    ...
    private void checkNullValues() {
        ...
        assertXpathEvaluatesTo("urn:ogc:def:nil:OGC::missing",
                "//ex:PolymorphicFeature[@gml:id='f1']/ex:fourthValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("urn:ogc:def:nil:OGC::missing",
                "//ex:PolymorphicFeature[@gml:id='f2']/ex:fourthValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("urn:ogc:def:nil:OGC::missing",
                "//ex:PolymorphicFeature[@gml:id='f3']/ex:fourthValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("urn:ogc:def:nil:OGC::missing",
                "//ex:PolymorphicFeature[@gml:id='f4']/ex:fourthValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("urn:ogc:def:nil:OGC::missing",
                "//ex:PolymorphicFeature[@gml:id='f5']/ex:fourthValue/gsml:CGI_TermValue/gsml:value", doc);
    ...
    private void checkAnyType() {
        ...
        assertXpathEvaluatesTo("0",
                "//ex:PolymorphicFeature[@gml:id='f2']/ex:anyValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("urn:ogc:def:nil:OGC::missing",
                "//ex:PolymorphicFeature[@gml:id='f4']/ex:anyValue/gsml:CGI_TermValue/gsml:value", doc);
        ...
        assertXpathEvaluatesTo("0",
                "//ex:PolymorphicFeature[@gml:id='f5']/ex:anyValue/gsml:CGI_TermValue/gsml:value", doc);
