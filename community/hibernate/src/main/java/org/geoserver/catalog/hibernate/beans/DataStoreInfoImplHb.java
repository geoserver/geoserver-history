...
/**
 * Mainly copied from DataStoreInfoImpl. <BR>
...
public class DataStoreInfoImplHb extends DataStoreInfoImpl implements Hibernable {
    ...
    public DataAccess<? extends FeatureType, ? extends Feature> getDataStore(
        ...
        if (catalog.getResourcePool() == null)
            throw new NullPointerException("resourcepool is null");
    ...
    public String toString() {
        return new StringBuilder(getClass().getSimpleName()).append('[').append(
                getWorkspace() != null ? getWorkspace().getName() : "--").append(':').append(name)
                .append(']').toString();
    }
