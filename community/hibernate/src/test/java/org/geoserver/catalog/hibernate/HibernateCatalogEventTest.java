...
//            LOGGER.warning("EVENT: handleAddEvent " + event.getSource().getClass().getSimpleName());
            added = true;
        }

        public void handleRemoveEvent(CatalogRemoveEvent event) {
//            LOGGER.warning("EVENT: handleRemoveEvent " + event.getSource().getClass().getSimpleName());
            removed = true;
        }

        public void handleModifyEvent(CatalogModifyEvent event) {
//            LOGGER.warning("EVENT: handleModifyEvent " + event.getSource().getClass().getSimpleName());
            modified = true;
        }
        ...
        public void handlePostModifyEvent(CatalogPostModifyEvent event) {
            Logger.getLogger(Listener.class.getName()).warning("PostModify " + event.getSource().getClass().getSimpleName());
        }
