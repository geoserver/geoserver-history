...
/**
 * Abstract base class for supporting GML encoding and 
 * GML Parsing 
 * 
 * 
...
public abstract class GMLSupport {
    ...
    protected void encodeStartTag(String elemName,StringBuffer buff, Map<String,String> attributeMap) {
	...
	protected Map<String,String> abstractGeometryAttribueMap(GeometryAttribute attr) {
		...
		if (attr.getSrsName()!=null) res.put("srsName",attr.getSrsName());
		if (attr.getGid()!=null) res.put("gid",attr.getGid());
