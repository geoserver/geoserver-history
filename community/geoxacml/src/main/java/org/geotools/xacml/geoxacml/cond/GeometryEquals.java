 ...
 * 
 * IMPORTANT: the logic must be in the equals Method of GeomtryAttribute, 
 * otherwise the Bag and Set functions would not work as described in the 
 * GeoXACML specification
 * 
