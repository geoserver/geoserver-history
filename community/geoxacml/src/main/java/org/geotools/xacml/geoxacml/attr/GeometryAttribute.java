...
/**
 * This class is the implemtation of a XACML geometry attribute as described in
 * the GeoXACML specification
 * 
 * 
...
public class GeometryAttribute extends AttributeValue {
	 ...
	 * @param srsName		the srsName, derived from the GML srsName attribute, may be null
	 * @param gid			the gid (GML global identifier, my be null)
	 * @param gmlVersion	gmlVersion (Version2 or Version3)	
	 * @param gmlType		the gml type encoded as xml type
	 * @throws URISyntaxException
	 */
	public GeometryAttribute(Geometry geometry, String srsName, String gid,
			GMLVersion gmlVersion, String gmlType) throws URISyntaxException {
	...
	/**
	 * @param root			GML node from an GML DOM
	 * @return				instance of this class or null if  there
	 * 						is no Node in the GML namespace
	 * @throws Exception	Thrown if GML tree could not be interpreted
	 */
	public static GeometryAttribute getInstance(Node root) throws Exception {
		...
		// System.out.println(retval.getGeometry().getClass()+"\t"+retval.getSrsName()+"\t"+retval.hashCode()+"\t"+retval.getGeometry());
		return retval;
	}

	/**
	 * @param value			The gml string of a geometry 
	 * @return				instance of this class or null if  there
	 * 						is no Node in the GML namespace
	 * @throws Exception   Thrown if GML String is not valid or GML tree could not be interpreted
	 */
	 ...
	 * Must behave like the equals function in the GeoXACML specification.
	 * Check for SRS and check the coordinates
	 * 
	 */
	 ...
	 * 
	 * procues an hash value, the  following rule is important
	 * if 2 instances of this class are compared with equal and the result is true,
	 * the hasCodes must be identical 
	 */
	public int hashCode() {
		int hashValue = 1;
		if (srsName != null)
