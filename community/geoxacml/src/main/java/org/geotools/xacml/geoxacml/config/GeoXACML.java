...
public class GeoXACML {
	...
	public static synchronized Validator getPolicyValidator() {
		...
		if (XACMLPolicySchema!=null) return XACMLPolicySchema.newValidator();
    ...
    private static void registerGeoXACMLBaseFunctions() {
        ...
        factory.addFunction(BagFunction.getIsInInstance(functionName, GeometryAttribute.identifier));
        
        functionName = bagPrefix+BagFunction.NAME_BASE_BAG_SIZE;
        factory.addFunction(BagFunction.getBagSizeInstance(functionName, GeometryAttribute.identifier));
        ...
        factory.addFunction(SetFunction.getIntersectionInstance(functionName, GeometryAttribute.identifier));

        functionName = setPrefix+SetFunction.NAME_BASE_SUBSET;
        factory.addFunction(SetFunction.getSubsetInstance(functionName, GeometryAttribute.identifier));
        
        functionName = setPrefix+SetFunction.NAME_BASE_UNION;
        factory.addFunction(SetFunction.getUnionInstance(functionName, GeometryAttribute.identifier));
