 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.GetFeatureType#getQuery <em>Query</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GetFeatureType#getMaxFeatures <em>Max Features</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GetFeatureType#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GetFeatureType#getResultType <em>Result Type</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GetFeatureType#getTraverseXlinkDepth <em>Traverse Xlink Depth</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GetFeatureType#getTraverseXlinkExpiry <em>Traverse Xlink Expiry</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGetFeatureType()
...
public interface GetFeatureType extends BaseRequestType {
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGetFeatureType_Query()
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGetFeatureType_MaxFeatures()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getMaxFeatures <em>Max Features</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGetFeatureType_OutputFormat()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getOutputFormat <em>Output Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getOutputFormat <em>Output Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetOutputFormat()
	 * @see #getOutputFormat()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getOutputFormat <em>Output Format</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGetFeatureType_ResultType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getResultType <em>Result Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getResultType <em>Result Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetResultType()
	 * @see #getResultType()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getResultType <em>Result Type</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGetFeatureType_TraverseXlinkDepth()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getTraverseXlinkDepth <em>Traverse Xlink Depth</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGetFeatureType_TraverseXlinkExpiry()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.PositiveInteger"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GetFeatureType#getTraverseXlinkExpiry <em>Traverse Xlink Expiry</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
