...
public class WFSValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "net.opengis.wfs.v1_1_0";
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map context) {
		switch (classifierID) {
			...
			case WFSPackage.INSERT_RESULT_TYPE:
				return validateInsertResultType((InsertResultType)value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateInsertResultType(InsertResultType insertResultType, DiagnosticChain diagnostics, Map context) {
		return validate_EveryDefaultConstraint(insertResultType, diagnostics, context);
	}
