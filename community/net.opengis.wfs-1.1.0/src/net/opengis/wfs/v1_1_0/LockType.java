 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockType#getFilter <em>Filter</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockType#getHandle <em>Handle</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockType#getTypeName <em>Type Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockType()
...
public interface LockType extends EObject {
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockType_Filter()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockType#getFilter <em>Filter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockType_Handle()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockType#getHandle <em>Handle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockType_TypeName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockType#getTypeName <em>Type Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
