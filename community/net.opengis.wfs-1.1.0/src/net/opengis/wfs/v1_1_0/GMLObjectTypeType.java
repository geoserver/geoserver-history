 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getName <em>Name</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getOutputFormats <em>Output Formats</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGMLObjectTypeType()
...
public interface GMLObjectTypeType extends EObject {
	 ...
	 * @see #setName(Object)
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGMLObjectTypeType_Name()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTitle(String)
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGMLObjectTypeType_Title()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getTitle <em>Title</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGMLObjectTypeType_Abstract()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getAbstract <em>Abstract</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGMLObjectTypeType_Keywords()
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getGMLObjectTypeType_OutputFormats()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.GMLObjectTypeType#getOutputFormats <em>Output Formats</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
