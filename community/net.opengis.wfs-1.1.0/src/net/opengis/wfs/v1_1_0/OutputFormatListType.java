 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.OutputFormatListType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.OutputFormatListType#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getOutputFormatListType()
...
public interface OutputFormatListType extends EObject{
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getOutputFormatListType_Group()
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getOutputFormatListType_Format()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.OutputFormatListType#getFormat <em>Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
