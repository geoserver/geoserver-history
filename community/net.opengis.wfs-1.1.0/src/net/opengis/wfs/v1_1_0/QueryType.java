 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getFunction <em>Function</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getFilter <em>Filter</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getSortBy <em>Sort By</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getFeatureVersion <em>Feature Version</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getHandle <em>Handle</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.QueryType#getTypeName <em>Type Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType()
...
public interface QueryType extends EObject {
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_Group()
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_PropertyName()
	 * @model type="java.lang.Object" unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_Function()
	 * @model type="java.lang.Object" unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_Filter()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.QueryType#getFilter <em>Filter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_SortBy()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.QueryType#getSortBy <em>Sort By</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_FeatureVersion()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.QueryType#getFeatureVersion <em>Feature Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_Handle()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.QueryType#getHandle <em>Handle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getQueryType_SrsName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.QueryType#getSrsName <em>Srs Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @model unique="false" dataType="net.opengis.wfs.v1_1_0.TypeNameListType" required="true" many="false"
