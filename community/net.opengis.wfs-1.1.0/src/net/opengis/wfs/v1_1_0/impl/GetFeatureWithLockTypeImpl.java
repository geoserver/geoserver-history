 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.GetFeatureWithLockTypeImpl#getQuery <em>Query</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.GetFeatureWithLockTypeImpl#getExpiry <em>Expiry</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.GetFeatureWithLockTypeImpl#getMaxFeatures <em>Max Features</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.GetFeatureWithLockTypeImpl#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.GetFeatureWithLockTypeImpl#getResultType <em>Result Type</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.GetFeatureWithLockTypeImpl#getTraverseXlinkDepth <em>Traverse Xlink Depth</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.GetFeatureWithLockTypeImpl#getTraverseXlinkExpiry <em>Traverse Xlink Expiry</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
