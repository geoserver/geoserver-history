...
import net.opengis.ows.v1_0_0.impl.OWSPackageImpl;

import net.opengis.wfs.v1_1_0.ActionType;
import net.opengis.wfs.v1_1_0.AllSomeType;
import net.opengis.wfs.v1_1_0.BaseRequestType;
import net.opengis.wfs.v1_1_0.DeleteElementType;
import net.opengis.wfs.v1_1_0.DescribeFeatureTypeType;
import net.opengis.wfs.v1_1_0.DocumentRoot;
import net.opengis.wfs.v1_1_0.FeatureCollectionType;
import net.opengis.wfs.v1_1_0.FeatureTypeListType;
import net.opengis.wfs.v1_1_0.FeatureTypeType;
import net.opengis.wfs.v1_1_0.FeaturesLockedType;
...
import net.opengis.wfs.v1_1_0.GetFeatureWithLockType;
...
import net.opengis.wfs.v1_1_0.InsertResultType;
import net.opengis.wfs.v1_1_0.InsertedFeatureType;
import net.opengis.wfs.v1_1_0.LockFeatureResponseType;
import net.opengis.wfs.v1_1_0.LockFeatureType;
import net.opengis.wfs.v1_1_0.LockType;
...
import net.opengis.wfs.v1_1_0.OperationType;
import net.opengis.wfs.v1_1_0.OperationsType;
import net.opengis.wfs.v1_1_0.OutputFormatListType;
import net.opengis.wfs.v1_1_0.PropertyType;
import net.opengis.wfs.v1_1_0.QueryType;
import net.opengis.wfs.v1_1_0.ResultTypeType;
import net.opengis.wfs.v1_1_0.TransactionResponseType;
import net.opengis.wfs.v1_1_0.TransactionResultsType;
import net.opengis.wfs.v1_1_0.TransactionSummaryType;
import net.opengis.wfs.v1_1_0.TransactionType;
import net.opengis.wfs.v1_1_0.UpdateElementType;
...
import net.opengis.wfs.v1_1_0.util.WFSValidator;
...
public class WFSPackageImpl extends EPackageImpl implements WFSPackage {
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getDocumentRoot_ProperyName() {
	 ...
	 * @generated
	 */
	public EAttribute getDocumentRoot_XlinkPropertyName() {
	 ...
	 * @generated
	 */
	public EAttribute getInsertElementType_FeatureCollection() {
	 ...
	 * @generated
	 */
	public EReference getInsertResultType_Feature() {
	...
	public void createPackageContents() {
		...
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__PROPERY_NAME);
		...
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__XLINK_PROPERTY_NAME);
		...
		createEAttribute(insertElementTypeEClass, INSERT_ELEMENT_TYPE__FEATURE_COLLECTION);
		...
		createEReference(insertResultTypeEClass, INSERT_RESULT_TYPE__FEATURE);
	...
	public void initializePackageContents() {
		...
		OWSPackageImpl theOWSPackage = (OWSPackageImpl)EPackage.Registry.INSTANCE.getEPackage(OWSPackage.eNS_URI);
		...
		initEAttribute(getDeleteElementType_Filter(), theXMLTypePackage.getAnySimpleType(), "filter", null, 1, 1, DeleteElementType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDocumentRoot_ProperyName(), theXMLTypePackage.getQName(), "properyName", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDocumentRoot_XlinkPropertyName(), theXMLTypePackage.getQName(), "xlinkPropertyName", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFeatureTypeType_WGS84BoundingBox(), theOWSPackage.getWGS84BoundingBoxType(), null, "wGS84BoundingBox", null, 1, -1, FeatureTypeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInsertedFeatureType_FeatureId(), theXMLTypePackage.getAnySimpleType(), "featureId", null, 1, -1, InsertedFeatureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInsertElementType_FeatureCollection(), theXMLTypePackage.getAnySimpleType(), "featureCollection", null, 0, 1, InsertElementType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInsertElementType_Feature(), theXMLTypePackage.getAnySimpleType(), "feature", null, 0, -1, InsertElementType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInsertResultType_Feature(), this.getInsertedFeatureType(), null, "feature", null, 1, -1, InsertResultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getQueryType_PropertyName(), theXMLTypePackage.getAnySimpleType(), "propertyName", null, 0, -1, QueryType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getQueryType_Function(), theXMLTypePackage.getAnySimpleType(), "function", null, 0, -1, QueryType.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getQueryType_Filter(), theXMLTypePackage.getAnySimpleType(), "filter", null, 0, 1, QueryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getQueryType_SortBy(), theXMLTypePackage.getAnySimpleType(), "sortBy", null, 0, 1, QueryType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransactionResponseType_InsertResults(), this.getInsertResultType(), null, "insertResults", null, 1, 1, TransactionResponseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUpdateElementType_Filter(), theXMLTypePackage.getAnySimpleType(), "filter", null, 0, 1, UpdateElementType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(operationTypeEEnum, OperationType.UNSERT_LITERAL);
	...
	protected void createNullAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "appinfo", "owsGetCapabilities.xsd 2005-11-21\r\nowsServiceIdentification.xsd 2005-11-21\r\nowsDataIdentification.xsd 2005-11-21\r\nowsCommon.xsd 2005-11-21\r\nows19115subset.xsd 2005-11-21\r\nowsServiceProvider.xsd 2005-11-21\r\nowsOperationsMetadata.xsd 2005-11-21"
		   });																																																																																																																																																																																																																																																																																																																		
	}
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getDocumentRoot_WfsCapabilities(), 
		   ...
		   new String[] {
			 ...
			 "namespace", "##targetNamespace",
			 "affiliation", "http://www.opengis.net/ows#Capabilities"
		   });			
		addAnnotation
		...
		addAnnotation
		  (formatTypeEDataType, 
		   ...
		   new String[] {
			 ...
			 "enumeration", "text/xml text/html text/sgml text/plain"
		   });			
		addAnnotation
		...
		addAnnotation
		  (getInsertElementType_FeatureCollection(), 
		   source, 
		   new String[] {
			 "kind", "element",
		...
		addAnnotation
		  (typeTypeEDataType, 
		   ...
		   new String[] {
			 "name", "type_._type",
			 "baseType", "http://www.eclipse.org/emf/2003/XMLType#NMTOKEN",
			 "enumeration", "TC211 FGDC 19115 19139"
		   });		
		addAnnotation
