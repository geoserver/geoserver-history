 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.impl.InsertResultTypeImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InsertResultTypeImpl extends EObjectImpl implements InsertResultType {
	...
	public EList getFeature() {
		if (feature == null) {
			feature = new EObjectContainmentEList(InsertedFeatureType.class, this, WFSPackage.INSERT_RESULT_TYPE__FEATURE);
		}
		return feature;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case WFSPackage.INSERT_RESULT_TYPE__FEATURE:
