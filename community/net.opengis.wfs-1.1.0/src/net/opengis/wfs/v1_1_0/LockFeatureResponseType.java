 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockFeatureResponseType#getLockId <em>Lock Id</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockFeatureResponseType#getFeaturesLocked <em>Features Locked</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockFeatureResponseType#getFeaturesNotLocked <em>Features Not Locked</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureResponseType()
...
public interface LockFeatureResponseType extends EObject{
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureResponseType_LockId()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureResponseType#getLockId <em>Lock Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureResponseType_FeaturesLocked()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureResponseType#getFeaturesLocked <em>Features Locked</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureResponseType_FeaturesNotLocked()
	 * @model containment="true" resolveProxies="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureResponseType#getFeaturesNotLocked <em>Features Not Locked</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
