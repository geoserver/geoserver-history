 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockFeatureType#getLock <em>Lock</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockFeatureType#getExpiry <em>Expiry</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.LockFeatureType#getLockAction <em>Lock Action</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureType()
...
public interface LockFeatureType extends BaseRequestType{
	 ...
	 * The list contents are of type {@link net.opengis.wfs.v1_1_0.LockType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * 
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureType_Lock()
	 * @model type="net.opengis.wfs.v1_1_0.LockType" containment="true" resolveProxies="false" required="true"
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureType_Expiry()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureType#getExpiry <em>Expiry</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureType#getExpiry <em>Expiry</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetExpiry()
	 * @see #getExpiry()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureType#getExpiry <em>Expiry</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getLockFeatureType_LockAction()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureType#getLockAction <em>Lock Action</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureType#getLockAction <em>Lock Action</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetLockAction()
	 * @see #getLockAction()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.v1_1_0.LockFeatureType#getLockAction <em>Lock Action</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
