 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getTransactionSummary <em>Transaction Summary</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getTransactionResults <em>Transaction Results</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getInsertResults <em>Insert Results</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getTransactionResponseType()
...
public interface TransactionResponseType extends EObject{
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getTransactionResponseType_TransactionSummary()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getTransactionSummary <em>Transaction Summary</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getTransactionResponseType_TransactionResults()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getTransactionResults <em>Transaction Results</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getTransactionResponseType_InsertResults()
	 * @model containment="true" resolveProxies="false" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getInsertResults <em>Insert Results</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getTransactionResponseType_Version()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetVersion()
	 * @see #getVersion()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.v1_1_0.TransactionResponseType#getVersion <em>Version</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
