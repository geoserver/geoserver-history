 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getFeatureTypeList <em>Feature Type List</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getServesGMLObjectTypeList <em>Serves GML Object Type List</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getSupportsGMLObjectTypeList <em>Supports GML Object Type List</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getFilterCapabilities <em>Filter Capabilities</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getWFSCapabilitiesType()
...
public interface WFSCapabilitiesType extends CapabilitiesBaseType{
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getWFSCapabilitiesType_FeatureTypeList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getFeatureTypeList <em>Feature Type List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getWFSCapabilitiesType_ServesGMLObjectTypeList()
	 * @model containment="true" resolveProxies="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getServesGMLObjectTypeList <em>Serves GML Object Type List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getWFSCapabilitiesType_SupportsGMLObjectTypeList()
	 * @model containment="true" resolveProxies="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getSupportsGMLObjectTypeList <em>Supports GML Object Type List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getWFSCapabilitiesType_FilterCapabilities()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.WFSCapabilitiesType#getFilterCapabilities <em>Filter Capabilities</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
