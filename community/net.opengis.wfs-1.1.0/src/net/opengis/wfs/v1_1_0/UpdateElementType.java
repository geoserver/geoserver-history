 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.v1_1_0.UpdateElementType#getProperty <em>Property</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.UpdateElementType#getFilter <em>Filter</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.UpdateElementType#getHandle <em>Handle</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.UpdateElementType#getInputFormat <em>Input Format</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.UpdateElementType#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.wfs.v1_1_0.UpdateElementType#getTypeName <em>Type Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.v1_1_0.WFSPackage#getUpdateElementType()
...
public interface UpdateElementType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.wfs.v1_1_0.PropertyType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * 
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getUpdateElementType_Property()
	 * @model type="net.opengis.wfs.v1_1_0.PropertyType" containment="true" resolveProxies="false" required="true"
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getUpdateElementType_Filter()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.UpdateElementType#getFilter <em>Filter</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getUpdateElementType_Handle()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.UpdateElementType#getHandle <em>Handle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getUpdateElementType_InputFormat()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.UpdateElementType#getInputFormat <em>Input Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wfs.v1_1_0.UpdateElementType#getInputFormat <em>Input Format</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetInputFormat()
	 * @see #getInputFormat()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wfs.v1_1_0.UpdateElementType#getInputFormat <em>Input Format</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getUpdateElementType_SrsName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.UpdateElementType#getSrsName <em>Srs Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wfs.v1_1_0.WFSPackage#getUpdateElementType_TypeName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.v1_1_0.UpdateElementType#getTypeName <em>Type Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
