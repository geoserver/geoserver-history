...
public abstract class CapabilitiesTransformer extends TransformerBase {
     ...
     */
    public CapabilitiesTransformer(WFS wfs, GeoServerCatalog catalog) {
        super();
    ...
    public static class WFS1_0 extends CapabilitiesTransformer {
    	...
    	public WFS1_0 ( WFS wfs, GeoServerCatalog catalog ) {
    		super( wfs, catalog );
    	}
    	...
    	class CapabilitiesTranslator1_0 extends TranslatorSupport {
        	...
        	public void encode( Object object ) throws IllegalArgumentException {
                ...
                String locationDef = 
                	ResponseUtils.appendPath( wfs.getSchemaBaseURL(), "wfs/1.0.0/WFS-capabilities.xsd" );
    ...
    public static class WFS1_1 extends CapabilitiesTransformer {
    	...
    	public WFS1_1 ( WFS wfs, GeoServerCatalog catalog ) {
    		super( wfs, catalog );
    	}
        	...
        	public void encode( Object object ) throws IllegalArgumentException {
    			...
    			AttributesImpl attributes = attributes( 
    				new String[] { 
    					...
    					"xsi:schemaLocation", 
    					org.geoserver.wfs.xml.v1_1_0.WFS.NAMESPACE + " " + ResponseUtils.appendPath( wfs.getSchemaBaseURL(), "wfs/1.1.0/wfs.xsd" ) 
    	            }
    			);
