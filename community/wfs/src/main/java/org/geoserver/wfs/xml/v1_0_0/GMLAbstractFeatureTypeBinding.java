...
public final class GMLAbstractFeatureTypeBinding extends
	...
	public GMLAbstractFeatureTypeBinding( 
		FeatureTypeCache featureTypeCache, GeometryFactory geometryFactory, GeoServerCatalog catalog 
	) {
		super( featureTypeCache );
	...
	public Object parse( ElementInstance instance, Node node, Object value ) throws Exception {
		...
		FeatureTypeInfo meta = catalog.featureType( instance.getNamespace(), instance.getName() );
		if ( meta != null ) {
