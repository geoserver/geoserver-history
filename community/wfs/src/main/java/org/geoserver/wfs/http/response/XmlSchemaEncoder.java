...
public class XmlSchemaEncoder extends FeatureTypeEncoder {
	...
	public XmlSchemaEncoder( WFS wfs, GeoServerCatalog catalog ) {
		super( "text/xml", "XMLSCHEMA" );
		this.wfs = wfs;
		this.catalog = catalog;
	}
	
	public void encode(FeatureTypeInfo[] featureTypeInfos, OutputStream output) throws IOException {
     ...
     */
    private final String generateTypes( FeatureTypeInfo[] infos ) throws IOException {
...
//                + "gml/2.1.2/feature.xsd\"/>\n\n");
    ...
    private StringBuffer getNSImport(
		String prefix, FeatureTypeInfo[] infos ) {
