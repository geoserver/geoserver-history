 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.DescribeCoverageType#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getDescribeCoverageType()
...
public interface DescribeCoverageType extends RequestBaseType {
     ...
     * @see net.opengis.wcs.wcsPackage#getDescribeCoverageType_Identifier()
