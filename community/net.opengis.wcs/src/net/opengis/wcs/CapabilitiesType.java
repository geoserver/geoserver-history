 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.CapabilitiesType#getContents <em>Contents</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getCapabilitiesType()
...
public interface CapabilitiesType extends CapabilitiesBaseType {
     ...
     * @see net.opengis.wcs.wcsPackage#getCapabilitiesType_Contents()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CapabilitiesType#getContents <em>Contents</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
