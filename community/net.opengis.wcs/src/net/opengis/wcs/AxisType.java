 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.AxisType#getAvailableKeys <em>Available Keys</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisType#getMeaning <em>Meaning</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisType#getDataType <em>Data Type</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisType#getUOM <em>UOM</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisType#getReferenceSystem <em>Reference System</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisType#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getAxisType()
...
public interface AxisType extends DescriptionType {
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisType_AvailableKeys()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisType#getAvailableKeys <em>Available Keys</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisType_Meaning()
     * @model containment="true"
     *        extendedMetaData="kind='element' name='Meaning' namespace='http://www.opengis.net/wcs/1.1/ows'"
     * @generated
     */
    DomainMetadataType getMeaning();

    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisType#getMeaning <em>Meaning</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisType_DataType()
     * @model containment="true"
     *        extendedMetaData="kind='element' name='DataType' namespace='http://www.opengis.net/wcs/1.1/ows'"
     * @generated
     */
    DomainMetadataType getDataType();

    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisType#getDataType <em>Data Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisType_UOM()
     * @model containment="true"
     *        extendedMetaData="kind='element' name='UOM' namespace='http://www.opengis.net/wcs/1.1/ows'"
     * @generated
     */
    DomainMetadataType getUOM();

    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisType#getUOM <em>UOM</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisType_ReferenceSystem()
     * @model containment="true"
     *        extendedMetaData="kind='element' name='ReferenceSystem' namespace='http://www.opengis.net/wcs/1.1/ows'"
     * @generated
     */
    DomainMetadataType getReferenceSystem();

    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisType#getReferenceSystem <em>Reference System</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisType_Metadata()
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisType#getIdentifier <em>Identifier</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
