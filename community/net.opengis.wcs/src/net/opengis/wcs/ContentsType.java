 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ContentsType#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link net.opengis.wcs.ContentsType#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.ContentsType#getSupportedFormat <em>Supported Format</em>}</li>
 *   <li>{@link net.opengis.wcs.ContentsType#getOtherSource <em>Other Source</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getContentsType()
...
public interface ContentsType extends EObject {
     ...
     * @see net.opengis.wcs.wcsPackage#getContentsType_CoverageSummary()
     ...
     * @see net.opengis.wcs.wcsPackage#getContentsType_SupportedCRS()
     ...
     * @see net.opengis.wcs.wcsPackage#getContentsType_SupportedFormat()
    ...
    /**
     * Returns the value of the '<em><b>Other Source</b></em>' attribute list.
     * The list contents are of type {@link java.lang.Object}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * <!-- end-model-doc -->
     * @return the value of the '<em>Other Source</em>' attribute list.
     * @see net.opengis.wcs.wcsPackage#getContentsType_OtherSource()
     * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType"
