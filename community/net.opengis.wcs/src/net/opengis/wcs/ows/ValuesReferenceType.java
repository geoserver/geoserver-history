 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.ValuesReferenceType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.ValuesReferenceType#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getValuesReferenceType()
...
public interface ValuesReferenceType extends EObject {
     ...
     * @see #setValue(String)
     * @see net.opengis.wcs.ows.owcsPackage#getValuesReferenceType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.ValuesReferenceType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getValuesReferenceType_Reference()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.ValuesReferenceType#getReference <em>Reference</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
