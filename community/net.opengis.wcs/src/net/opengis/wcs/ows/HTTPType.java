 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.HTTPType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.HTTPType#getGet <em>Get</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.HTTPType#getPost <em>Post</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getHTTPType()
...
public interface HTTPType extends EObject {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getHTTPType_Group()
     ...
     * The list contents are of type {@link net.opengis.wcs.ows.RequestMethodType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getHTTPType_Get()
     * @model type="net.opengis.wcs.ows.RequestMethodType" containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getHTTPType_Post()
     * @model type="net.opengis.wcs.ows.RequestMethodType" containment="true" transient="true" volatile="true" derived="true"
