 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.AcceptVersionsType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getAcceptVersionsType()
...
public interface AcceptVersionsType extends EObject {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getAcceptVersionsType_Version()
