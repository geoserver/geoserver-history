 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.impl.ReferenceGroupTypeImpl#getAbstractReferenceBaseGroup <em>Abstract Reference Base Group</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.ReferenceGroupTypeImpl#getAbstractReferenceBase <em>Abstract Reference Base</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceGroupTypeImpl extends BasicIdentificationTypeImpl implements ReferenceGroupType {
    ...
    protected EClass eStaticClass() {
        return owcsPackage.Literals.REFERENCE_GROUP_TYPE;
    }
    ...
    public FeatureMap getAbstractReferenceBaseGroup() {
        if (abstractReferenceBaseGroup == null) {
            abstractReferenceBaseGroup = new BasicFeatureMap(this, owcsPackage.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE_GROUP);
        }
    ...
    public EList getAbstractReferenceBase() {
        return getAbstractReferenceBaseGroup().list(owcsPackage.Literals.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE);
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case owcsPackage.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE_GROUP:
                return ((InternalEList)getAbstractReferenceBaseGroup()).basicRemove(otherEnd, msgs);
            case owcsPackage.REFERENCE_GROUP_TYPE__ABSTRACT_REFERENCE_BASE:
