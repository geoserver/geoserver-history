 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.impl.SectionsTypeImpl#getSection <em>Section</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SectionsTypeImpl extends EObjectImpl implements SectionsType {
    ...
    protected EClass eStaticClass() {
        return owcsPackage.Literals.SECTIONS_TYPE;
    }
    ...
    public EList getSection() {
        if (section == null) {
            section = new EDataTypeEList(String.class, this, owcsPackage.SECTIONS_TYPE__SECTION);
        }
        return section;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case owcsPackage.SECTIONS_TYPE__SECTION:
                return getSection();
        }
