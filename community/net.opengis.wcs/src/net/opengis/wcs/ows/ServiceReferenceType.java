 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.ServiceReferenceType#getRequestMessage <em>Request Message</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.ServiceReferenceType#getRequestMessageReference <em>Request Message Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getServiceReferenceType()
...
public interface ServiceReferenceType extends ReferenceType {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getServiceReferenceType_RequestMessage()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.ServiceReferenceType#getRequestMessage <em>Request Message</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getServiceReferenceType_RequestMessageReference()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.ServiceReferenceType#getRequestMessageReference <em>Request Message Reference</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
