 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.ValueType#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getValueType()
...
public interface ValueType extends EObject {
     ...
     * @see #setValue(String)
     * @see net.opengis.wcs.ows.owcsPackage#getValueType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.ValueType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
