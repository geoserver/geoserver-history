 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.DomainMetadataType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.DomainMetadataType#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getDomainMetadataType()
...
public interface DomainMetadataType extends EObject {
     ...
     * @see #setValue(String)
     * @see net.opengis.wcs.ows.owcsPackage#getDomainMetadataType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.DomainMetadataType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getDomainMetadataType_Reference()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.DomainMetadataType#getReference <em>Reference</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
