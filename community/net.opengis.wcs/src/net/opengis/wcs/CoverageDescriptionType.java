 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getDomain <em>Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getRange <em>Range</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionType#getSupportedFormat <em>Supported Format</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionType()
...
public interface CoverageDescriptionType extends DescriptionType {
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageDescriptionType#getIdentifier <em>Identifier</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionType_Metadata()
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionType_Domain()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageDescriptionType#getDomain <em>Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionType_Range()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageDescriptionType#getRange <em>Range</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionType_SupportedCRS()
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionType_SupportedFormat()
