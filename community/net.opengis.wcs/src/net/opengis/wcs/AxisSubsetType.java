 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.AxisSubsetType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.AxisSubsetType#getKey <em>Key</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getAxisSubsetType()
...
public interface AxisSubsetType extends EObject {
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisSubsetType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.AxisSubsetType#getIdentifier <em>Identifier</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getAxisSubsetType_Key()
     * @model unique="false" dataType="net.opengis.wcs.IdentifierType" required="true"
