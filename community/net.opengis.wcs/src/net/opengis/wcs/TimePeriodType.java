 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.TimePeriodType#getBeginPosition <em>Begin Position</em>}</li>
 *   <li>{@link net.opengis.wcs.TimePeriodType#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link net.opengis.wcs.TimePeriodType#getTimeResolution <em>Time Resolution</em>}</li>
 *   <li>{@link net.opengis.wcs.TimePeriodType#getFrame <em>Frame</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getTimePeriodType()
...
public interface TimePeriodType extends EObject {
     ...
     * @see net.opengis.wcs.wcsPackage#getTimePeriodType_BeginPosition()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TimePeriodType#getBeginPosition <em>Begin Position</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getTimePeriodType_EndPosition()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TimePeriodType#getEndPosition <em>End Position</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getTimePeriodType_TimeResolution()
     * @model dataType="net.opengis.wcs.TimeDurationType"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TimePeriodType#getTimeResolution <em>Time Resolution</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #unsetFrame()
     * @see #setFrame(String)
     * @see net.opengis.wcs.wcsPackage#getTimePeriodType_Frame()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.TimePeriodType#getFrame <em>Frame</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.TimePeriodType#getFrame <em>Frame</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetFrame()
     * @see #getFrame()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.TimePeriodType#getFrame <em>Frame</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
