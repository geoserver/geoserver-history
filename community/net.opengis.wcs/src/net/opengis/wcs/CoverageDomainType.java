 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.CoverageDomainType#getSpatialDomain <em>Spatial Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.CoverageDomainType#getTemporalDomain <em>Temporal Domain</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getCoverageDomainType()
...
public interface CoverageDomainType extends EObject {
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDomainType_SpatialDomain()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageDomainType#getSpatialDomain <em>Spatial Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDomainType_TemporalDomain()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.CoverageDomainType#getTemporalDomain <em>Temporal Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
