 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.CoverageSummaryTypeImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.CoverageSummaryTypeImpl#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.CoverageSummaryTypeImpl#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.CoverageSummaryTypeImpl#getSupportedFormat <em>Supported Format</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.CoverageSummaryTypeImpl#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.CoverageSummaryTypeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.CoverageSummaryTypeImpl#getIdentifier1 <em>Identifier1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoverageSummaryTypeImpl extends DescriptionTypeImpl implements CoverageSummaryType {
    ...
    /**
     * The cached value of the '{@link #getWGS84BoundingBox() <em>WGS84 Bounding Box</em>}' attribute list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    protected EClass eStaticClass() {
        return wcsPackage.Literals.COVERAGE_SUMMARY_TYPE;
    }
    ...
    public EList getMetadata() {
        if (metadata == null) {
            metadata = new EDataTypeEList(Object.class, this, wcsPackage.COVERAGE_SUMMARY_TYPE__METADATA);
        }
        return metadata;
    }
    ...
    public EList getWGS84BoundingBox() {
        if (wGS84BoundingBox == null) {
            wGS84BoundingBox = new EDataTypeEList(Object.class, this, wcsPackage.COVERAGE_SUMMARY_TYPE__WGS84_BOUNDING_BOX);
        }
    ...
    public EList getSupportedCRS() {
        if (supportedCRS == null) {
            supportedCRS = new EDataTypeEList(String.class, this, wcsPackage.COVERAGE_SUMMARY_TYPE__SUPPORTED_CRS);
        }
        return supportedCRS;
    }
    ...
    public EList getSupportedFormat() {
        if (supportedFormat == null) {
            supportedFormat = new EDataTypeEList(Object.class, this, wcsPackage.COVERAGE_SUMMARY_TYPE__SUPPORTED_FORMAT);
        }
    ...
    public EList getCoverageSummary() {
        if (coverageSummary == null) {
            coverageSummary = new EObjectContainmentEList(CoverageSummaryType.class, this, wcsPackage.COVERAGE_SUMMARY_TYPE__COVERAGE_SUMMARY);
        }
    ...
    public void setIdentifier(String newIdentifier) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.COVERAGE_SUMMARY_TYPE__IDENTIFIER, oldIdentifier, identifier));
    }
    ...
    public void setIdentifier1(String newIdentifier1) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.COVERAGE_SUMMARY_TYPE__IDENTIFIER1, oldIdentifier1, identifier1));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wcsPackage.COVERAGE_SUMMARY_TYPE__COVERAGE_SUMMARY:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wcsPackage.COVERAGE_SUMMARY_TYPE__METADATA:
                return getMetadata();
            case wcsPackage.COVERAGE_SUMMARY_TYPE__WGS84_BOUNDING_BOX:
                return getWGS84BoundingBox();
            case wcsPackage.COVERAGE_SUMMARY_TYPE__SUPPORTED_CRS:
                return getSupportedCRS();
            case wcsPackage.COVERAGE_SUMMARY_TYPE__SUPPORTED_FORMAT:
                return getSupportedFormat();
            case wcsPackage.COVERAGE_SUMMARY_TYPE__COVERAGE_SUMMARY:
                return getCoverageSummary();
            case wcsPackage.COVERAGE_SUMMARY_TYPE__IDENTIFIER:
                return getIdentifier();
            case wcsPackage.COVERAGE_SUMMARY_TYPE__IDENTIFIER1:
    ...
    public String toString() {
        ...
        result.append(metadata);
        result.append(", wGS84BoundingBox: ");
        result.append(wGS84BoundingBox);
