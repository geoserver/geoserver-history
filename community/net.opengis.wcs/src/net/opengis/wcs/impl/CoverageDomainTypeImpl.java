 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.CoverageDomainTypeImpl#getSpatialDomain <em>Spatial Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.CoverageDomainTypeImpl#getTemporalDomain <em>Temporal Domain</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CoverageDomainTypeImpl extends EObjectImpl implements CoverageDomainType {
    ...
    protected EClass eStaticClass() {
        return wcsPackage.Literals.COVERAGE_DOMAIN_TYPE;
    }
    ...
    public NotificationChain basicSetSpatialDomain(SpatialDomainType newSpatialDomain, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wcsPackage.COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN, oldSpatialDomain, newSpatialDomain);
    ...
    public void setSpatialDomain(SpatialDomainType newSpatialDomain) {
        if (newSpatialDomain != spatialDomain) {
            ...
            if (spatialDomain != null)
                msgs = ((InternalEObject)spatialDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wcsPackage.COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN, null, msgs);
            if (newSpatialDomain != null)
                msgs = ((InternalEObject)newSpatialDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wcsPackage.COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN, null, msgs);
            msgs = basicSetSpatialDomain(newSpatialDomain, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN, newSpatialDomain, newSpatialDomain));
    }
    ...
    public NotificationChain basicSetTemporalDomain(TimeSequenceType newTemporalDomain, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wcsPackage.COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN, oldTemporalDomain, newTemporalDomain);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setTemporalDomain(TimeSequenceType newTemporalDomain) {
        if (newTemporalDomain != temporalDomain) {
            ...
            if (temporalDomain != null)
                msgs = ((InternalEObject)temporalDomain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wcsPackage.COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN, null, msgs);
            if (newTemporalDomain != null)
                msgs = ((InternalEObject)newTemporalDomain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wcsPackage.COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN, null, msgs);
            msgs = basicSetTemporalDomain(newTemporalDomain, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN, newTemporalDomain, newTemporalDomain));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wcsPackage.COVERAGE_DOMAIN_TYPE__SPATIAL_DOMAIN:
                return basicSetSpatialDomain(null, msgs);
            case wcsPackage.COVERAGE_DOMAIN_TYPE__TEMPORAL_DOMAIN:
