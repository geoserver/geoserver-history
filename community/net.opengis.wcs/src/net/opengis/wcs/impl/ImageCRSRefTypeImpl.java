 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.ImageCRSRefTypeImpl#getImageCRS <em>Image CRS</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImageCRSRefTypeImpl extends EObjectImpl implements ImageCRSRefType {
    ...
    protected EClass eStaticClass() {
        return wcsPackage.Literals.IMAGE_CRS_REF_TYPE;
    }
    ...
    public void setImageCRS(Object newImageCRS) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.IMAGE_CRS_REF_TYPE__IMAGE_CRS, oldImageCRS, imageCRS));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wcsPackage.IMAGE_CRS_REF_TYPE__IMAGE_CRS:
                return getImageCRS();
        }
