 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.RangeSubsetTypeImpl#getFieldSubset <em>Field Subset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RangeSubsetTypeImpl extends EObjectImpl implements RangeSubsetType {
    ...
    protected EClass eStaticClass() {
        return wcsPackage.Literals.RANGE_SUBSET_TYPE;
    }
    ...
    public EList getFieldSubset() {
        if (fieldSubset == null) {
            fieldSubset = new EObjectContainmentEList(FieldSubsetType.class, this, wcsPackage.RANGE_SUBSET_TYPE__FIELD_SUBSET);
        }
        return fieldSubset;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wcsPackage.RANGE_SUBSET_TYPE__FIELD_SUBSET:
