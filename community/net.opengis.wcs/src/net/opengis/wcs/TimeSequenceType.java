 ...
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getTimeSequenceType()
...
public interface TimeSequenceType extends EObject {
     ...
     * @see net.opengis.wcs.wcsPackage#getTimeSequenceType_Group()
     ...
     * @see net.opengis.wcs.wcsPackage#getTimeSequenceType_TimePosition()
     ...
     * @see net.opengis.wcs.wcsPackage#getTimeSequenceType_TimePeriod()
