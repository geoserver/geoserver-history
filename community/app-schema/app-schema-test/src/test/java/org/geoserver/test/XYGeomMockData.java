...
public class XYGeomMockData implements TestData {

    public static final String TEST_DATA = "/test-data/";

    public static final String TEST_NAMESPACE_PREFIX = "test";

    public static final String OASIS_CATALOG = "mappedPolygons.oasis.xml";

    public static final String SCHEMAS_DIR = ".";

    public static final String TEST_NAMESPACE_URI = "http://test";
    ...
    public static final Map<String, String> NAMESPACES = new LinkedHashMap<String, String>() {
        {
            put(TEST_NAMESPACE_PREFIX, TEST_NAMESPACE_URI);
     ...
     * @throws IOException
     */
    public XYGeomMockData() throws Exception {
        ...
        addFeatureType(TEST_NAMESPACE_PREFIX, "PointFeature", "PointFeature.xml",
