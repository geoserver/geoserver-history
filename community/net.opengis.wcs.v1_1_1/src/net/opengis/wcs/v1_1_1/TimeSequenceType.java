 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.TimeSequenceType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.TimeSequenceType#getTimePosition <em>Time Position</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.TimeSequenceType#getTimePeriod <em>Time Period</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getTimeSequenceType()
...
public interface TimeSequenceType extends EObject {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getTimeSequenceType_Group()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getTimeSequenceType_TimePosition()
     ...
     * The list contents are of type {@link net.opengis.wcs.v1_1_1.TimePeriodType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getTimeSequenceType_TimePeriod()
     * @model type="net.opengis.wcs.v1_1_1.TimePeriodType" containment="true" transient="true" volatile="true" derived="true"
