 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getSupportedFormat <em>Supported Format</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getIdentifier1 <em>Identifier1</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType()
...
public interface CoverageSummaryType extends DescriptionType {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType_Metadata()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType_WGS84BoundingBox()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType_SupportedCRS()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType_SupportedFormat()
     * @model unique="false" dataType="net.opengis.ows.v1_1_0.MimeType"
     ...
     * The list contents are of type {@link net.opengis.wcs.v1_1_1.CoverageSummaryType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType_CoverageSummary()
     * @model type="net.opengis.wcs.v1_1_1.CoverageSummaryType" containment="true"
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType_Identifier()
     * @model dataType="net.opengis.wcs.v1_1_1.IdentifierType"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getIdentifier <em>Identifier</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageSummaryType_Identifier1()
     * @model dataType="net.opengis.wcs.v1_1_1.IdentifierType"
     *        extendedMetaData="kind='element' name='Identifier' namespace='##targetNamespace'"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.CoverageSummaryType#getIdentifier1 <em>Identifier1</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
