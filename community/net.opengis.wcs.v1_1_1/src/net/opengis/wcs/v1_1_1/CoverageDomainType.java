 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDomainType#getSpatialDomain <em>Spatial Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDomainType#getTemporalDomain <em>Temporal Domain</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDomainType()
...
public interface CoverageDomainType extends EObject {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDomainType_SpatialDomain()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.CoverageDomainType#getSpatialDomain <em>Spatial Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDomainType_TemporalDomain()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.CoverageDomainType#getTemporalDomain <em>Temporal Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
