...
import net.opengis.ows.v1_1_0.impl.DescriptionTypeImpl;
 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.CoverageSummaryTypeImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.CoverageSummaryTypeImpl#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.CoverageSummaryTypeImpl#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.CoverageSummaryTypeImpl#getSupportedFormat <em>Supported Format</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.CoverageSummaryTypeImpl#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.CoverageSummaryTypeImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.CoverageSummaryTypeImpl#getIdentifier1 <em>Identifier1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
