 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.OperationType#getDCP <em>DCP</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.OperationType#getParameter <em>Parameter</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.OperationType#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.OperationType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.OperationType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getOperationType()
...
public interface OperationType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.ows.v1_0_0.DCPType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getOperationType_DCP()
	 * @model type="net.opengis.ows.v1_0_0.DCPType" containment="true" resolveProxies="false" required="true"
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getOperationType_Parameter()
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getOperationType_Constraint()
	 * @model type="net.opengis.ows.v1_0_0.DomainType" containment="true" resolveProxies="false"
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getOperationType_Metadata()
	 ...
	 * @see #setName(String)
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getOperationType_Name()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.OperationType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
