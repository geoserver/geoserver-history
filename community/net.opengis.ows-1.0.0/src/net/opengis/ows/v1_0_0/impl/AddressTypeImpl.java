...
import net.opengis.ows.v1_0_0.AddressType;
 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.AddressTypeImpl#getDeliveryPoint <em>Delivery Point</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.AddressTypeImpl#getCity <em>City</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.AddressTypeImpl#getAdministrativeArea <em>Administrative Area</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.AddressTypeImpl#getPostalCode <em>Postal Code</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.AddressTypeImpl#getCountry <em>Country</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.AddressTypeImpl#getElectronicMailAddress <em>Electronic Mail Address</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
	 ...
	 * @ordered
	 */
	protected EList deliveryPoint = null;
	 ...
	 * @ordered
	 */
	protected EList electronicMailAddress = null;
	...
	protected EClass eStaticClass() {
		return OWSPackage.eINSTANCE.getAddressType();
	}
	...
	public EList getDeliveryPoint() {
		if (deliveryPoint == null) {
			deliveryPoint = new EDataTypeEList(String.class, this, OWSPackage.ADDRESS_TYPE__DELIVERY_POINT);
		}
	...
	public EList getElectronicMailAddress() {
		if (electronicMailAddress == null) {
			electronicMailAddress = new EDataTypeEList(String.class, this, OWSPackage.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS);
		}
