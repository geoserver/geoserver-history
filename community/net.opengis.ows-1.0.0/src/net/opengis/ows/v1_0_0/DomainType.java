 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.DomainType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.DomainType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.DomainType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getDomainType()
...
public interface DomainType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getDomainType_Value()
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getDomainType_Metadata()
	 ...
	 * @see #setName(String)
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getDomainType_Name()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.DomainType#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
