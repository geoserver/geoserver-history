 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getResponsiblePartyType()
...
public interface ResponsiblePartyType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getResponsiblePartyType_IndividualName()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getResponsiblePartyType_OrganisationName()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getOrganisationName <em>Organisation Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getResponsiblePartyType_PositionName()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getPositionName <em>Position Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getResponsiblePartyType_ContactInfo()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getResponsiblePartyType_Role()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ResponsiblePartyType#getRole <em>Role</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
