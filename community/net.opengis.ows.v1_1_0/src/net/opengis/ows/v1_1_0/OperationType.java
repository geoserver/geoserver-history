 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationType#getDCP <em>DCP</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationType#getParameter <em>Parameter</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationType#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationType()
...
public interface OperationType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.DCPType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationType_DCP()
     * @model type="net.opengis.ows.v1_1_0.DCPType" containment="true" required="true"
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.DomainType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationType_Parameter()
     * @model type="net.opengis.ows.v1_1_0.DomainType" containment="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationType_Constraint()
     * @model type="net.opengis.ows.v1_1_0.DomainType" containment="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationType_Metadata()
     ...
     * @see #setName(String)
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationType_Name()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.OperationType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
