 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ManifestType#getReferenceGroup <em>Reference Group</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getManifestType()
...
public interface ManifestType extends BasicIdentificationType {
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.ReferenceGroupType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getManifestType_ReferenceGroup()
     * @model type="net.opengis.ows.v1_1_0.ReferenceGroupType" containment="true" required="true"
