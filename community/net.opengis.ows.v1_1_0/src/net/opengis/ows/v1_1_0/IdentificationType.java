 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.IdentificationType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.IdentificationType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.IdentificationType#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.IdentificationType#getAvailableCRSGroup <em>Available CRS Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.IdentificationType#getAvailableCRS <em>Available CRS</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getIdentificationType()
...
public interface IdentificationType extends BasicIdentificationType {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getIdentificationType_BoundingBoxGroup()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getIdentificationType_BoundingBox()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getIdentificationType_OutputFormat()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getIdentificationType_AvailableCRSGroup()
     * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getIdentificationType_AvailableCRS()
