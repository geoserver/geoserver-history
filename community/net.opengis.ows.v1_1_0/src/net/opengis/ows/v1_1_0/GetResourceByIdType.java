 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.GetResourceByIdType#getResourceID <em>Resource ID</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.GetResourceByIdType#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.GetResourceByIdType#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.GetResourceByIdType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getGetResourceByIdType()
...
public interface GetResourceByIdType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetResourceByIdType_ResourceID()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetResourceByIdType_OutputFormat()
     * @model dataType="net.opengis.ows.v1_1_0.MimeType"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetResourceByIdType#getOutputFormat <em>Output Format</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetResourceByIdType_Service()
     * @model dataType="net.opengis.ows.v1_1_0.ServiceType" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetResourceByIdType#getService <em>Service</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetResourceByIdType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetResourceByIdType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
