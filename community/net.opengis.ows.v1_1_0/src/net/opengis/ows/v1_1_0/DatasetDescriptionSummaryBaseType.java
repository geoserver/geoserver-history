 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType#getDatasetDescriptionSummary <em>Dataset Description Summary</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getDatasetDescriptionSummaryBaseType()
...
public interface DatasetDescriptionSummaryBaseType extends DescriptionType {
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.WGS84BoundingBoxType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDatasetDescriptionSummaryBaseType_WGS84BoundingBox()
     * @model type="net.opengis.ows.v1_1_0.WGS84BoundingBoxType" containment="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDatasetDescriptionSummaryBaseType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType#getIdentifier <em>Identifier</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDatasetDescriptionSummaryBaseType_BoundingBoxGroup()
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.BoundingBoxType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     * Unordered list of zero or more minimum bounding rectangles surrounding coverage data, in AvailableCRSs.  Zero or more BoundingBoxes are  allowed in addition to one or more WGS84BoundingBoxes to allow more precise specification of the Dataset area in AvailableCRSs. These Bounding Boxes shall not use any CRS not listed as an AvailableCRS. However, an AvailableCRS can be listed without a corresponding Bounding Box. If no such bounding box is recorded for a coverage, any such bounding boxes recorded for a higher level in a hierarchy of datasets shall apply to this coverage. If such bounding box(es) are recorded for a coverage, any such bounding boxes recorded for a higher level in a hierarchy of datasets shall be ignored. If multiple bounding boxes are included with the same CRS, this shall be interpreted as the union of the areas of these bounding boxes. 
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDatasetDescriptionSummaryBaseType_BoundingBox()
     * @model type="net.opengis.ows.v1_1_0.BoundingBoxType" containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDatasetDescriptionSummaryBaseType_Metadata()
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDatasetDescriptionSummaryBaseType_DatasetDescriptionSummary()
     * @model type="net.opengis.ows.v1_1_0.DatasetDescriptionSummaryBaseType" containment="true"
