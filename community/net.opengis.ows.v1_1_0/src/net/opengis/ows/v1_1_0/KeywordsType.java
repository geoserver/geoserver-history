 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.KeywordsType#getKeyword <em>Keyword</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.KeywordsType#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getKeywordsType()
...
public interface KeywordsType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getKeywordsType_Keyword()
     * @model type="net.opengis.ows.v1_1_0.LanguageStringType" containment="true" required="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getKeywordsType_Type()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.KeywordsType#getType <em>Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
