 ...
 * $Id$
 */
package net.opengis.ows.v1_1_0.impl;
...
import net.opengis.ows.v1_1_0.DocumentRoot;
 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getAbstractMetaData <em>Abstract Meta Data</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getAbstractReferenceBase <em>Abstract Reference Base</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getAccessConstraints <em>Access Constraints</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getAllowedValues <em>Allowed Values</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getAnyValue <em>Any Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getAvailableCRS <em>Available CRS</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getContactInfo <em>Contact Info</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getDatasetDescriptionSummary <em>Dataset Description Summary</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getDCP <em>DCP</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getException <em>Exception</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getExceptionReport <em>Exception Report</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getExtendedCapabilities <em>Extended Capabilities</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getFees <em>Fees</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getGetCapabilities <em>Get Capabilities</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getGetResourceByID <em>Get Resource By ID</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getHTTP <em>HTTP</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getInputData <em>Input Data</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getManifest <em>Manifest</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getMaximumValue <em>Maximum Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getMeaning <em>Meaning</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getMinimumValue <em>Minimum Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getNoValues <em>No Values</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getOperationResponse <em>Operation Response</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getOperationsMetadata <em>Operations Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getOtherSource <em>Other Source</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getOutputFormat <em>Output Format</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getPointOfContact <em>Point Of Contact</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getRange <em>Range</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getReferenceGroup <em>Reference Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getReferenceSystem <em>Reference System</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getServiceIdentification <em>Service Identification</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getServiceProvider <em>Service Provider</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getServiceReference <em>Service Reference</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getSpacing <em>Spacing</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getUOM <em>UOM</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getValuesReference <em>Values Reference</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getWGS84BoundingBox <em>WGS84 Bounding Box</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getRangeClosure <em>Range Closure</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.DocumentRootImpl#getReference1 <em>Reference1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
