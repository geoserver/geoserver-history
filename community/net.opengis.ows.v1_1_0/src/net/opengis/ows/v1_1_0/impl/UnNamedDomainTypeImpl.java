 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getAllowedValues <em>Allowed Values</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getAnyValue <em>Any Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getNoValues <em>No Values</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getValuesReference <em>Values Reference</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getMeaning <em>Meaning</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getUOM <em>UOM</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getReferenceSystem <em>Reference System</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.impl.UnNamedDomainTypeImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
