 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.MetadataType#getAbstractMetaDataGroup <em>Abstract Meta Data Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.MetadataType#getAbstractMetaData <em>Abstract Meta Data</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.MetadataType#getAbout <em>About</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getMetadataType()
...
public interface MetadataType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getMetadataType_AbstractMetaDataGroup()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getMetadataType_AbstractMetaData()
     ...
     * @see #setAbout(String)
     * @see net.opengis.ows.v1_1_0.Ows11Package#getMetadataType_About()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.MetadataType#getAbout <em>About</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
