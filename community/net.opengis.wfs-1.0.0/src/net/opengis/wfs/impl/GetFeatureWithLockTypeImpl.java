 ...
 *   <li>{@link net.opengis.wfs.impl.GetFeatureWithLockTypeImpl#getHandle <em>Handle</em>}</li>
 ...
 *   <li>{@link net.opengis.wfs.impl.GetFeatureWithLockTypeImpl#getService <em>Service</em>}</li>
 *   <li>{@link net.opengis.wfs.impl.GetFeatureWithLockTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GetFeatureWithLockTypeImpl extends EObjectImpl implements GetFeatureWithLockType {
	/**
	...
	public void setExpiry(BigInteger newExpiry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__EXPIRY, oldExpiry, expiry));
	}
	...
	public void setHandle(String newHandle) {
		...
		handle = newHandle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__HANDLE, oldHandle, handle));
	}
	...
	public void setService(String newService) {
		...
		serviceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__SERVICE, oldService, service, !oldServiceESet));
	}
	...
	public void unsetService() {
		...
		serviceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__SERVICE, oldService, SERVICE_EDEFAULT, oldServiceESet));
	}
	...
	public void setVersion(String newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WFSPackage.GET_FEATURE_WITH_LOCK_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
