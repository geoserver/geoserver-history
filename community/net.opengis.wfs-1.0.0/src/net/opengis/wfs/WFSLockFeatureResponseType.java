 ...
 * <ul>
 *   <li>{@link net.opengis.wfs.WFSLockFeatureResponseType#getLockId <em>Lock Id</em>}</li>
 *   <li>{@link net.opengis.wfs.WFSLockFeatureResponseType#getFeaturesLocked <em>Features Locked</em>}</li>
 *   <li>{@link net.opengis.wfs.WFSLockFeatureResponseType#getFeaturesNotLocked <em>Features Not Locked</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wfs.WFSPackage#getWFSLockFeatureResponseType()
 * @model extendedMetaData="name='WFS_LockFeatureResponseType' kind='elementOnly'"
 * @generated
 */
public interface WFSLockFeatureResponseType extends EObject{
	/**
	 ...
	 * @see net.opengis.wfs.WFSPackage#getWFSLockFeatureResponseType_LockId()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wfs.WFSLockFeatureResponseType#getLockId <em>Lock Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
