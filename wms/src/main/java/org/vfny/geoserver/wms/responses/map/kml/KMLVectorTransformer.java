...
public class KMLVectorTransformer extends TransformerBase {
    ...
    class KMLTranslator extends TranslatorSupport {
        ...
        public KMLTranslator(ContentHandler contentHandler) {
            ...
            KMLGeometryTransformer geometryTransformer = 
                new KMLGeometryTransformer();
            ...
            geometryTranslator = (KMLGeometryTranslator) 
                geometryTransformer.createTranslator( contentHandler );
        }
        ...
        public void encode(Object o) throws IllegalArgumentException {
            ...
            FeatureTypeStyle[] featureTypeStyles = 
                filterFeatureTypeStyles( mapLayer.getStyle() , featureType );
        ...
        protected FeatureTypeStyle[] filterFeatureTypeStyles( Style style, FeatureType featureType ) {
            ...
            return (FeatureTypeStyle[]) 
                filtered.toArray( new FeatureTypeStyle[ filtered.size() ] );
        }
