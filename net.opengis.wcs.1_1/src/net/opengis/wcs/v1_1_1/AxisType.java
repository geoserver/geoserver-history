 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.AxisType#getAvailableKeys <em>Available Keys</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.AxisType#getMeaning <em>Meaning</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.AxisType#getDataType <em>Data Type</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.AxisType#getUOM <em>UOM</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.AxisType#getReferenceSystem <em>Reference System</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.AxisType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.AxisType#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType()
...
public interface AxisType extends DescriptionType {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType_AvailableKeys()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.AxisType#getAvailableKeys <em>Available Keys</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType_Meaning()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.AxisType#getMeaning <em>Meaning</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType_DataType()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.AxisType#getDataType <em>Data Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType_UOM()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.AxisType#getUOM <em>UOM</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType_ReferenceSystem()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.AxisType#getReferenceSystem <em>Reference System</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType_Metadata()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getAxisType_Identifier()
     * @model dataType="net.opengis.wcs.v1_1_1.IdentifierType" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.AxisType#getIdentifier <em>Identifier</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
