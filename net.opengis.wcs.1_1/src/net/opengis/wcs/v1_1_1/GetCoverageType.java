 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.GetCoverageType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.GetCoverageType#getDomainSubset <em>Domain Subset</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.GetCoverageType#getRangeSubset <em>Range Subset</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.GetCoverageType#getOutput <em>Output</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getGetCoverageType()
...
public interface GetCoverageType extends RequestBaseType {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getGetCoverageType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.GetCoverageType#getIdentifier <em>Identifier</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getGetCoverageType_DomainSubset()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.GetCoverageType#getDomainSubset <em>Domain Subset</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getGetCoverageType_RangeSubset()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.GetCoverageType#getRangeSubset <em>Range Subset</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getGetCoverageType_Output()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.GetCoverageType#getOutput <em>Output</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
