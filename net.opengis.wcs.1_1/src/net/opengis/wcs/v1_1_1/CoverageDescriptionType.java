 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getDomain <em>Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getRange <em>Range</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getSupportedFormat <em>Supported Format</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDescriptionType()
...
public interface CoverageDescriptionType extends DescriptionType {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDescriptionType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getIdentifier <em>Identifier</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDescriptionType_Metadata()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDescriptionType_Domain()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getDomain <em>Domain</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDescriptionType_Range()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.CoverageDescriptionType#getRange <em>Range</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDescriptionType_SupportedCRS()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getCoverageDescriptionType_SupportedFormat()
     * @model unique="false" dataType="net.opengis.ows.v1_1_0.MimeType" required="true"
