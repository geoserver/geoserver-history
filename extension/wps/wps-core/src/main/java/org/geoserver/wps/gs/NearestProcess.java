...
public class NearestProcess implements GeoServerProcess {
		...
		try {
			...
			if (nearestFeature != null) {
				...
				results.add(createTargetFeature(nearestFeature,
						(SimpleFeatureType) targetFeatureType, nearestDistance,
						nearestBearing));
			}
			return results;
	...
	private SimpleFeature createTargetFeature(Feature feature,
			SimpleFeatureType targetFeatureType, Double nearestDistance,
			Double nearestBearing) throws ProcessException {
		try {
