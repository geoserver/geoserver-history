...
public class PropertyEncodingOrderMockData extends AbstractAppSchemaMockData {
	...
	public void addContent() {
		...
		addFeatureType(GSML_PREFIX, "GeologicUnit", "GeologicUnit.xml",
				"GeologicUnit.properties", "CGITermValue.xml",
				"CGITermValue.properties", "exposureColor.properties",
				"CompositionPart.xml", "CompositionPart.properties",
				"ControlledConcept.xml", "ControlledConcept.properties");
		addFeatureType(ER_PREFIX, "MineralOccurrence",
				"er_MineralOccurrence.xml", "er_MineralOccurrence.properties",
				"CGI_PlanarOrientation.xml", "CGI_PlanarOrientation.properties");
		addFeatureType(GSML_PREFIX, "CGI_PlanarOrientation",
				"CGI_PlanarOrientation.xml", "CGI_PlanarOrientation.properties");
	}
}
