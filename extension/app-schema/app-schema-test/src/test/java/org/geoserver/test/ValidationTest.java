...
public class ValidationTest extends AbstractAppSchemaWfsTestSupport {
	...
	public void testAttributeMinOccur0() {
		...
		assertXpathCount(
				1,
				"//gsml:GeologicUnit[@gml:id='gsml.geologicunit.gu.1']/gml:name",
				doc);
		assertXpathCount(
				1,
				"//gsml:GeologicUnit[@gml:id='gsml.geologicunit.gu.2']/gml:name",
				doc);
		assertXpathCount(
				1,
				"//gsml:GeologicUnit[@gml:id='gsml.geologicunit.gu.3']/gml:name",
				doc);
		...
		assertXpathCount(
				0,
				"//gsml:GeologicUnit[@gml:id='gsml.geologicunit.gu.2']/gsml:rank",
				doc);
	...
	public void testAttributeMinOccur1() {
		...
		try {
			...
			LOGGER
					.info("WFS GetFeature&typename=gsml:gsml:MappedFeature response:\n"
							+ prettyString(doc));
		} catch (Exception e) {
			LOGGER
		...
		assertTrue(exceptionRpt
				.contains("observationMethod requires a non null value"));
