 ...
 *
 */
public class KvpGetFeatureReader extends KvpRequestReader {

	 /**
		* Constructor with raw request string.  Calls parent.
		* @param describeFeatureTypeRequest The raw request string from the client.
		*/
		public KvpGetFeatureReader (String getFeatureRequest) {
	 ...
	 /**
		...
		*/
		private String readFilter (String filter) {
				...
				PredicateFilter filterParser = new PredicateFilter(parser);
