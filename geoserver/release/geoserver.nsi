...
;General
  ...
  ;Name and file
  Name "GeoServer 1.6.0-RC3"
  OutFile "geoserver-1.6.0-RC3.exe"


  ;Default installation folder
  InstallDir "$PROGRAMFILES\GeoServer 1.6.0-RC3"
  
  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "Software\GeoServer-1.6.0-RC3" ""
...
;Interface Settings
  ...
  !define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the \
      installation of GeoServer 1.6.0-RC3 \r\n \
...
Section "Uninstall"
  ...
  IfFileExists "$INSTDIR" 0 Removed
     MessageBox MB_YESNO|MB_ICONQUESTION \
          "Remove all files in your GeoServer 1.6.0-RC3 directory? (If you have anything you created that you want to keep, click No)" IDNO Removed
     Delete "$INSTDIR\*.*" ;
     RMDIR /r "$INSTDIR"
     Sleep 500
     IfFileExists "$INSTDIR" 0 Removed
