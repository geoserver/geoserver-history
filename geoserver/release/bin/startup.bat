...
:runJava
  cd %GEOSERVER_HOME%
  %RUN_JAVA% -DGEOSERVER_DATA_DIR="%GEOSERVER_DATA_DIR%" -Dorg.geotools.referencing.forceXY=true -DSTOP.PORT=8079 -DSTOP.KEY=geoserver -jar %GEOSERVER_HOME%\start.jar
