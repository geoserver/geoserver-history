...
public class KMLReflectorTest extends WMSTestSupport {
    ...
    public void testNoBBOXInHREF() throws Exception {
        ...
        String expectedLink = "http://localhost:80/geoserver/wms?format_options=KMPLACEMARK%3Afalse%3BKMATTR%3Atrue%3BKMSCORE%3A50%3B&service=wms&srs=EPSG%3A4326&width=1024&styles=BasicPolygons&height=1024&transparent=false&request=GetMap&layers=cite%3ABasicPolygons&format=application%2Fvnd.google-earth.kmz%2Bxml&version=1.1.1";
        assertXpathEvaluatesTo(expectedLink, "kml/Folder/NetworkLink[1]/Url/href", dom);
