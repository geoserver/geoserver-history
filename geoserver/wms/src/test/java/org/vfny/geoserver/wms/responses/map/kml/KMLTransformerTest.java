...
public class KMLTransformerTest extends WMSTestSupport {
    ...
    protected void setUp() throws Exception {
        ...
        MapLayerInfo mapLayerInfo = 
            new MapLayerInfo( (FeatureTypeInfoDTO) ftInfo.toDTO(), catalog );
    ...
    public void testVectorTransformer() throws Exception {
        ...
        KMLVectorTransformer transformer = 
            new KMLVectorTransformer( mapContext, mapLayer );
    ...
    public void testRasterTransformerInline() throws Exception {
        KMLRasterTransformer transformer 
        ...
        assertEquals( mapContext.getLayerCount(), document.getElementsByTagName( "GroundOverlay" ).getLength() );
