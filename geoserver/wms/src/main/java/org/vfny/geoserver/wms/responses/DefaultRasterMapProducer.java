...
public abstract class DefaultRasterMapProducer extends
    ...
    public void produceMap() throws WmsException {
        ...
        final Graphics2D graphic = ImageUtils.prepareTransparency(transparent,
                bgColor, preparedImage, hintsMap);
        ...
        // shapefile renderer won't log rendering errors, sigh, we have to do it
        // manually
