...
public class KMLSuperOverlayTransformer extends TransformerBase {
     ...
     * the world bounds
     */
    final static ReferencedEnvelope world = 
    ...
    class KMLSuperOverlayerTranslator extends TranslatorSupport {
        ...
        public void encode(Object o) throws IllegalArgumentException {
            ...
            double resolution = 
                Math.max( extent.getWidth() / 256d, extent.getHeight() / 256d );
            ...
            if ( top != world) {
                ...
                Envelope e00 = new Envelope(
                    top.getMinX(), top.getMinX() + top.getWidth() / 2d, 
                    top.getMaxY() - top.getHeight() / 2d, top.getMaxY()
                );
                //top right
                Envelope e01 = new Envelope( 
                    e00.getMaxX(), top.getMaxX(), e00.getMinY(), e00.getMaxY()
                );
                //bottom left
                Envelope e10 = new Envelope(
                    e00.getMinX(), e00.getMaxX(), top.getMinY(), e00.getMinY() 
                );
                //bottom right
                Envelope e11 = new Envelope( 
                    e01.getMinX(), e01.getMaxX(), e10.getMinY(), e10.getMaxY()
                );
                ...
                Envelope e0 = new Envelope( 
                    top.getMinX(), top.getMinX() + top.getWidth() / 2d,
                    top.getMinY(), top.getMaxY()
                );
                Envelope e1 = new Envelope(
                    e0.getMaxX(), top.getMaxX(), top.getMinY(), top.getMaxY()
                );
