...
public class WMSCapsTransformer extends TransformerBase {
     ...
     */
    public WMSCapsTransformer(String baseUrl, Set formats, ApplicationContext applicationContext) {
        super();
    ...
    private static class CapabilitiesTranslator extends TranslatorSupport {
        ...
        private void handleService() {
            ...
            orAtts.addAttribute("", "xlink:href", "xlink:href", "",
                RequestUtils.proxifiedBaseURL(request.getBaseUrl(),
                    wms.getGeoServer().getProxyBaseUrl()) + "wms");
        ...
        private void handleRequest() {
            ...
            String serviceUrl = RequestUtils.proxifiedBaseURL(request.getBaseUrl(),
                    request.getServiceRef().getGeoServer().getProxyBaseUrl()) + "wms?SERVICE=WMS&";
        ...
        private String getDates(final String names) {
            ...
            try {
                times = (Set) Class.forName("fr.ifremer.coverage.io.PostGridReader")
                                   .getMethod("getAvailableTimes", new Class[] { String.class })
        ...
        private String getElevations(final String names) {
            ...
            try {
                timesAndDepths = (Set) Class.forName("fr.ifremer.coverage.io.PostGridReader")
                                            .getMethod("getAvailableAltitudes",
                        new Class[] { String.class }).invoke(null, new Object[] { names });
            } catch (Exception e) {
        ...
        private String getValidRange(final String names) {
            ...
            try {
                range = (NumberRange) Class.forName("fr.ifremer.coverage.io.PostGridReader")
                                           .getMethod("getValidRange", new Class[] { String.class })
                                           .invoke(null, new Object[] { names });
            } catch (Exception e) {
