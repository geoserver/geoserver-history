 ...
 * there must be a
 * {@linkplain org.vfny.geoserver.wms.responses.GetMapProducerFactorySpi}
 * registered that can provide instances of that concrete implementation.
 * </p>
 *
 * <p>
...
public interface GetMapProducer {
    /**
     * Asks this map producer to create a map image for the provided
