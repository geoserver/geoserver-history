...
public class WMSRequests {
    ...
    public static String getBaseUrl( WMSMapContext map ) {
        return getBaseUrl( map.getRequest().getHttpServletRequest(),
     ...
     */
    public static String getTiledGetMapUrl(WMSMapContext map, MapLayer layer, Envelope bbox, String[] kvp) {
     ...
     * 
     */
    static String getGetMapUrl( String baseUrl, WMSMapContext map, MapLayer layer, Envelope bbox, String[] kvp ) {
        //parameters
        HashMap params = new HashMap();
