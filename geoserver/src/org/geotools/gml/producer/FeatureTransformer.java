...
public class FeatureTransformer extends XMLFilterImpl implements XMLReader {
    ...
    /** The feature results to process. */
     ...
     */
    public synchronized void transform(FeatureResults features,
     ...
     */
    private void walk(FeatureResults features) throws SAXException, IOException {
        contentHandler.startDocument();

        //FeatureCollectionIteration iteration = new FeatureCollectionIterat();
        FeatureResultsIteration.Handler handler;
        ...
        FeatureResultsIteration.iteration(handler, features);
     ...
     */
    class BasicOutputVisitor implements FeatureResultsIteration.Handler {
         ...
         */
        public void handleFeatureResults(FeatureResults fc, FeatureReader reader) {
            try {
                tab(indent++);

                AttributesImpl fcAtts = new AttributesImpl();

                FeatureType schema = reader.getFeatureType();

                LOGGER.finer("schema is " + schema.getNamespace());
         ...
         * coordinates
         */
        private void writeBounds(FeatureResults fc)
         ...
         * @param fc DOCUMENT ME!
         */
        public void endFeatureResults(FeatureResults fc) {
            try {
                tab(--indent);
