 ...
 * @version $Id: UniqueFIDValidationBeanInfo.java,v 1.1 2004/02/10 18:29:03 dmzwiers Exp $
 */
public class UniqueFIDValidationBeanInfo extends DefaultFeatureValidationBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors(){
			...
			for(;i<pd2.length;i++)
				pd[i] = pd2[i];
			try{
				pd[i] = createPropertyDescriptor("uniqueID",NullZeroValidation.class,resourceBundle);
