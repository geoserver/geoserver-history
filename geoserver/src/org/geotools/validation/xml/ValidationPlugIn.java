...
public class ValidationPlugIn implements PlugIn {
     ...
     * 
     * <p>
     * Will reset the processor based on the current DTO's being held in
     * memory.
     * </p>
     *
    ...
    public boolean resetProcessor() throws ValidationException {
        ...
        while (i.hasNext()) {
            ...
            org.geotools.validation.xml.PlugIn plugIn = new org.geotools.validation.xml.PlugIn(plugInName,
        ...
        while (i.hasNext()) {
            ...
            while (j.hasNext()) {
                ...
                org.geotools.validation.xml.PlugIn plugIn = (org.geotools.validation.xml.PlugIn) defaultPlugIns
     ...
     * @throws ValidationException DOCUMENT ME!
     */
    private Map loadValidations(File validationDir, Map plugInDTOs)
     ...
     * 
     * <p>
     * replaces the current configuration of DTO's but does not affect the
     * processor.
     * </p>
     *
     ...
     * 
     * <p>
     * replaces the current configuration of plugInDTO's but does not affect
     * the processor.
     * </p>
     *
     * @param plugIns List of the plugInDTO objects
     ...
     * 
     * <p>
     * replaces the current configuration of testSuiteDTO's but does not affect
     * the processor.
     * </p>
     *
     * @param testSuites List of the testSuiteDTO objects
