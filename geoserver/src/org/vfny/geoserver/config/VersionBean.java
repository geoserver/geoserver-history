...
public class VersionBean {        
    ...
    public String getFreeFsVersion() { return FREEFS_VERSION; }
        
    /** Returns Web Feature Service version */
    public String getWfsVersion() { return WFS_VERSION; }
    
    /** Returns WFS update sequence number */
    public String getWfsUpdateSequence() { return WFS_UPDATE_SEQUENCE; }
    
    /** Returns Web Feature Server name */
    public String getWfsName() { return WFS_NAME; }
