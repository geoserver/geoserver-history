 ...
 * @version $Id: LockKvpReader.java,v 1.4 2003/09/15 16:29:52 cholmesny Exp $
 */
public class LockKvpReader extends RequestKvpReader {
    /** Class logger */
     ...
     *
     * @param request The raw string to construct the request from.
     */
    public LockKvpReader(String request) {
        super(request);
    }
     ...
     *
     * @throws WfsException For any problems forming the request.
     */
    public LockRequest getRequest() throws WfsException {
        ...
        if (kvpPairs.containsKey("EXPIRY")) {
            currentRequest.setExpiry(Integer.parseInt(
                    (String) kvpPairs.get("EXPIRY")));
        }
