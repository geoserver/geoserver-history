 ...
 * @version $Id: ServiceConfigOld.java,v 1.1.2.1 2003/11/04 23:38:17 cholmesny Exp $
 */
    ...
    implements java.io.Serializable
{
   ...
   */
  public ServiceConfigOld(String name, String title, String onlineResource)
  {
    this.name = name;
    this.title = title;
  ...
  /**
   * static factory, reads a ServiceConfig from an xml file, using the
   * default root tag.
   *
   * @param configFile the path to the configuration file.
   *
   * @return the ServiceConfig object constructed from the xml elements of
   *         the file.
   *
   * @throws ConfigurationException DOCUMENT ME!
   */
  public static ServiceConfigOld getInstance(String configFile)
  ...
  /**
   * static factory, reads a ServiceConfig from an xml file, using the passed
   * in root tag.
   *
   * @param configFile the path to the configuration file.
   ...
   * @throws ConfigurationException DOCUMENT ME!
   */
  public static ServiceConfigOld getInstance(String configFile, String rootTag)
      throws ConfigurationException
  {
    ServiceConfigOld servConfig = null;
  ...
  /**
   * Searches for keyword elements beneath the given root element. They can
   * be comma delimited or in different keyword elements, both beneath the
   * Keywords element.
   *
   ...
   * @param servAbstract
   */
  void setAbstract(String servAbstract)
  {
    this.servAbstract = servAbstract;
  }
   ...
   * 0.0.14
   *
   * @return xml of the service section.
   */
  public String getWfsXml()
  {
    ...
    tempResponse.append("</Keywords>\n");
    tempResponse.append("    <OnlineResource>" + onlineResource
                        + "</OnlineResource>\n");
   ...
   *
   * @return A string representation of this service config.
   */
