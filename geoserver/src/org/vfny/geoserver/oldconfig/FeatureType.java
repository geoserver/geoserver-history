 ...
 * @version $Revision: 1.1.2.1 $ $Date: 2003/11/04 23:38:17 $
 *
...
class FeatureType
{
      ...
      throws ConfigurationException
  {
    ...
    try {
      ...
      String name = findTextFromTag(featureElem, ServiceConfigOld.NAME_TAG);
      ...
      featureType.setAbstract(findTextFromTag(featureElem,
                                              ServiceConfigOld.ABSTRACT_TAG));
      featureType.setTitle(findTextFromTag(featureElem,
                                           ServiceConfigOld.TITLE_TAG));
      featureType.setKeywords(ServiceConfigOld.getKeywords(featureElem));
   ...
   */
  void setDefaultStyle(String name)
      throws ConfigurationException
  {
