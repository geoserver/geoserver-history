...
/**
 * This class implements some library function for all the sub classes in this package. This class follows the Layer Supertype pattern as defined in Fowler's Patterns of Enterprise Application Architecture. Here the pattern is described in great detail between pages 475 and 479. The main idea is to have a super class contain all the common functionality of the sub-classes which does not pertain to particular manipulations within the classes. 
 *
 * @author Gabriel Roldán
 * @author dzwiers
 * @version $Id: GlobalLayerSupertype.java,v 1.1.2.1 2004/01/08 23:44:48 dmzwiers Exp $
 */
