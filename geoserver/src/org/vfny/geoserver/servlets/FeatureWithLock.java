 ...
 * @version $Id: FeatureWithLock.java,v 1.3 2003/09/15 23:07:16 cholmesny Exp $
 */
public class FeatureWithLock extends HttpServlet {
    /** Class logger */
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            FeatureKvpReader currentKvpRequest = new FeatureKvpReader(request
                    .getQueryString());
            FeatureRequest wfsRequest = currentKvpRequest.getRequest(true);
            tempResponse = FeatureResponse.getXmlResponse(wfsRequest);
        }
        // catches all errors; client should never see a stack trace 
         catch (WfsException wfs) {
