 ...
 */
public class JAIMapProducer implements GetMapProducer {
    ...
    public void produceMap(WMSMapContext map) throws WmsException {
        ...
        if (LOGGER.isLoggable(Level.FINE)) {
            LOGGER.fine(format + " image generated in " + t + "ms.");
        }
     ...
     */
    private void formatImageOutputStream(String format, BufferedImage image,
