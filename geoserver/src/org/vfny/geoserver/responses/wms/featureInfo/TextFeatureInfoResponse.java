 ...
 * @version $Id: TextFeatureInfoResponse.java,v 1.1 2004/07/15 21:13:14 jmacgill Exp $
 */
public class TextFeatureInfoResponse extends GetFeatureInfoDelegate {
    ...
    protected void execute(FeatureTypeInfo[] requestedLayers, Query[] queries,
        ...
        try {
            ...
            renderer.setOutput(null, paintArea);
