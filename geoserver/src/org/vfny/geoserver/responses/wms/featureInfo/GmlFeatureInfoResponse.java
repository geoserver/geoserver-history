 ...
 * <p> 
 * This class does not deals directly with GML encoding. Instead, it works
 * by taking the FeatureResults produced in <code>execute()</code> and
 * constructs a <code>GetFeaturesResult</code> wich is passed to a 
 * <code>GML2FeatureResponseDelegate</code>, as if it where the result
 * of a GetFeature WFS request.
 * </p>
 * 
...
public class GmlFeatureInfoResponse extends AbstractFeatureInfoResponse {
	...
	/**
	 * Takes the <code>FeatureResult</code>s generated by the <code>execute</code>
	 * method in the superclass and constructs a <code>GetFeaturesResult</code> wich
	 * is passed to a <code>GML2FeatureResponseDelegate</code>. 
	 */
