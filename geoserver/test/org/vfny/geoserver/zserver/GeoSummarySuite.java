...
/**
 * Tests the GeoSummary classes's setting of fields and
...
public class GeoSummarySuite extends TestCase {
	...
	LOGGER.info("Creating GeoSummary suite.");
        return suite;
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo><citation><citeinfo><title>test</title></citeinfo></citation></idinfo></metadata>");
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo><citation><citeinfo><edition>2</edition></citeinfo></citation></idinfo></metadata>");
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo><citation><citeinfo><geoform>river</geoform></citeinfo></citation></idinfo></metadata>");
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo /><spdoinfo><indspref>blorg</indspref></spdoinfo></metadata>");
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo><status><update>twice</update></status></idinfo></metadata>");
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo><spdom><bounding><westbc>-15</westbc><eastbc>20</eastbc><northbc>25</northbc><southbc>10</southbc></bounding></spdom></idinfo></metadata>");
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo><timeperd><timeinfo><rngdates><begdate>1995</begdate><enddate>19960304</enddate></rngdates></timeinfo></timeperd></idinfo></metadata>");
    }
	...
	testXmlSummary(testSum, "<metadata><idinfo><citation><citeinfo><title>test " + 
