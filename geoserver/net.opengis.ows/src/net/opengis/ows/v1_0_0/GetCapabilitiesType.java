 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getSections <em>Sections</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getGetCapabilitiesType()
...
public interface GetCapabilitiesType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getGetCapabilitiesType_AcceptVersions()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getGetCapabilitiesType_Sections()
	 * @model containment="true" resolveProxies="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getSections <em>Sections</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getGetCapabilitiesType_AcceptFormats()
	 * @model containment="true" resolveProxies="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getGetCapabilitiesType_UpdateSequence()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
