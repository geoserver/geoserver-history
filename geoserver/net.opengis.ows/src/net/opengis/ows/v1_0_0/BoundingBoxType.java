 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.BoundingBoxType#getLowerCorner <em>Lower Corner</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.BoundingBoxType#getUpperCorner <em>Upper Corner</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.BoundingBoxType#getCrs <em>Crs</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.BoundingBoxType#getDimensions <em>Dimensions</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getBoundingBoxType()
...
public interface BoundingBoxType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getBoundingBoxType_LowerCorner()
	 * @model unique="false" dataType="net.opengis.ows.v1_0_0.PositionType" required="true" many="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.BoundingBoxType#getLowerCorner <em>Lower Corner</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getBoundingBoxType_UpperCorner()
	 * @model unique="false" dataType="net.opengis.ows.v1_0_0.PositionType" required="true" many="false"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.BoundingBoxType#getUpperCorner <em>Upper Corner</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCrs(String)
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getBoundingBoxType_Crs()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.BoundingBoxType#getCrs <em>Crs</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getBoundingBoxType_Dimensions()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.BoundingBoxType#getDimensions <em>Dimensions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
