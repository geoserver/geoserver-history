 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getOrganisationName <em>Organisation Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getPositionName <em>Position Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartyType()
...
public interface ResponsiblePartyType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartyType_IndividualName()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getIndividualName <em>Individual Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartyType_OrganisationName()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getOrganisationName <em>Organisation Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartyType_PositionName()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getPositionName <em>Position Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartyType_ContactInfo()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getContactInfo <em>Contact Info</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getResponsiblePartyType_Role()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ResponsiblePartyType#getRole <em>Role</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
