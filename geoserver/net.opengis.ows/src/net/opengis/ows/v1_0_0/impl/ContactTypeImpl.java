 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ContactTypeImpl#getPhone <em>Phone</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ContactTypeImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ContactTypeImpl#getOnlineResource <em>Online Resource</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ContactTypeImpl#getHoursOfService <em>Hours Of Service</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ContactTypeImpl#getContactInstructions <em>Contact Instructions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContactTypeImpl extends EObjectImpl implements ContactType {
	...
	protected EClass eStaticClass() {
		return OWSPackage.eINSTANCE.getContactType();
	}
