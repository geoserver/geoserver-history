...
import net.opengis.ows.v1_0_0.util.OWSValidator;
...
public class OWSPackageImpl extends EPackageImpl implements OWSPackage {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static OWSPackage init() {
		...
		OWSPackageImpl theOWSPackage = (OWSPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof OWSPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new OWSPackageImpl());
	...
	protected void createNullAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "appinfo", "ows19115subset.xsd 2005-11-21"
		   });																																																																																																																																																																																																																																																																			
	}
