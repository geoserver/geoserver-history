 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ExceptionReportTypeImpl#getException <em>Exception</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ExceptionReportTypeImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.ExceptionReportTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExceptionReportTypeImpl extends EObjectImpl implements ExceptionReportType {
	...
	protected EClass eStaticClass() {
		return OWSPackage.eINSTANCE.getExceptionReportType();
	}
	...
	public EList getException() {
		if (exception == null) {
			exception = new EObjectContainmentEList(ExceptionType.class, this, OWSPackage.EXCEPTION_REPORT_TYPE__EXCEPTION);
		}
		return exception;
	}
