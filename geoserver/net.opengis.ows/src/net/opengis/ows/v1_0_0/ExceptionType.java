 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.ExceptionType#getExceptionText <em>Exception Text</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ExceptionType#getExceptionCode <em>Exception Code</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.ExceptionType#getLocator <em>Locator</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_0_0.OWSPackage#getExceptionType()
...
public interface ExceptionType extends EObject {
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getExceptionType_ExceptionText()
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getExceptionType_ExceptionCode()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ExceptionType#getExceptionCode <em>Exception Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.ows.v1_0_0.OWSPackage#getExceptionType_Locator()
	...
	/**
	 * Sets the value of the '{@link net.opengis.ows.v1_0_0.ExceptionType#getLocator <em>Locator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
