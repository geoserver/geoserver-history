...
public class ExceptionTypeImpl extends EObjectImpl implements ExceptionType {
    ...
    public EList getExceptionText() {
        if (exceptionText == null) {
            exceptionText = new EDataTypeUniqueEList(String.class, this,
                    OwsPackage.EXCEPTION_TYPE__EXCEPTION_TEXT);
        }
    ...
    public void setLocator(String newLocator) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.EXCEPTION_TYPE__LOCATOR, oldLocator, locator));
        }
    }
