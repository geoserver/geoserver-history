...
public class OperationsMetadataTypeImpl extends EObjectImpl implements OperationsMetadataType {
    ...
    public EList getOperation() {
        if (operation == null) {
            operation = new EObjectContainmentEList(OperationType.class, this,
                    OwsPackage.OPERATIONS_METADATA_TYPE__OPERATION);
        }
    ...
    public EList getParameter() {
        if (parameter == null) {
            parameter = new EObjectContainmentEList(DomainType.class, this,
                    OwsPackage.OPERATIONS_METADATA_TYPE__PARAMETER);
        }
    ...
    public EList getConstraint() {
        if (constraint == null) {
            constraint = new EObjectContainmentEList(DomainType.class, this,
                    OwsPackage.OPERATIONS_METADATA_TYPE__CONSTRAINT);
        }
    ...
    public void setExtendedCapabilities(EObject newExtendedCapabilities) {
        if (newExtendedCapabilities != extendedCapabilities) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.OPERATIONS_METADATA_TYPE__EXTENDED_CAPABILITIES,
                    newExtendedCapabilities, newExtendedCapabilities));
        }
    }
