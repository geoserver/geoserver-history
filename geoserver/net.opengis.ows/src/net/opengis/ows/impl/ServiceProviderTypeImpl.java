...
public class ServiceProviderTypeImpl extends EObjectImpl implements ServiceProviderType {
    ...
    public void setProviderName(String newProviderName) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.SERVICE_PROVIDER_TYPE__PROVIDER_NAME, oldProviderName, providerName));
        }
    }
    ...
    * @generated
    */
    public NotificationChain basicSetProviderSite(OnlineResourceType newProviderSite,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OwsPackage.SERVICE_PROVIDER_TYPE__PROVIDER_SITE, oldProviderSite,
                    newProviderSite);
    ...
    public void setProviderSite(OnlineResourceType newProviderSite) {
        if (newProviderSite != providerSite) {
            ...
            if (providerSite != null) {
                msgs = ((InternalEObject) providerSite).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - OwsPackage.SERVICE_PROVIDER_TYPE__PROVIDER_SITE,
                        null, msgs);
            }

            if (newProviderSite != null) {
                msgs = ((InternalEObject) newProviderSite).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - OwsPackage.SERVICE_PROVIDER_TYPE__PROVIDER_SITE,
                        null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.SERVICE_PROVIDER_TYPE__PROVIDER_SITE, newProviderSite,
                    newProviderSite));
        }
    }
    ...
    * @generated
    */
    public NotificationChain basicSetServiceContact(ResponsiblePartySubsetType newServiceContact,
        NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    OwsPackage.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT, oldServiceContact,
                    newServiceContact);
    ...
    public void setServiceContact(ResponsiblePartySubsetType newServiceContact) {
        if (newServiceContact != serviceContact) {
            ...
            if (serviceContact != null) {
                msgs = ((InternalEObject) serviceContact).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - OwsPackage.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT,
                        null, msgs);
            }

            if (newServiceContact != null) {
                msgs = ((InternalEObject) newServiceContact).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE - OwsPackage.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT,
                        null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.SERVICE_PROVIDER_TYPE__SERVICE_CONTACT, newServiceContact,
                    newServiceContact));
        }
    }
    ...
    */
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case OwsPackage.SERVICE_PROVIDER_TYPE__PROVIDER_NAME:
            return (PROVIDER_NAME_EDEFAULT == null) ? (providerName != null)
