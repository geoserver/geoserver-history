    ...
    public EList getParameter() {
        if (parameter == null) {
            parameter = new EObjectContainmentEList(DomainType.class, this,
                    OwsPackage.OPERATION_TYPE__PARAMETER);
        }
    ...
    public EList getConstraint() {
        if (constraint == null) {
            constraint = new EObjectContainmentEList(DomainType.class, this,
                    OwsPackage.OPERATION_TYPE__CONSTRAINT);
        }
    ...
    public EList getMetadata() {
        if (metadata == null) {
            metadata = new EObjectContainmentEList(MetadataType.class, this,
                    OwsPackage.OPERATION_TYPE__METADATA);
        }
    ...
    */
    public void setName(String newName) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, OwsPackage.OPERATION_TYPE__NAME,
                    oldName, name));
        }
    }
