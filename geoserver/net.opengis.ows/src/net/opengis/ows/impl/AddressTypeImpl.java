...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
    ...
    public void setDeliveryPoint(String newDeliveryPoint) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.ADDRESS_TYPE__DELIVERY_POINT, oldDeliveryPoint, deliveryPoint));
        }
    }
    ...
    */
    public void setCity(String newCity) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, OwsPackage.ADDRESS_TYPE__CITY,
                    oldCity, city));
        }
    }
    ...
    */
    public void setAdministrativeArea(String newAdministrativeArea) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.ADDRESS_TYPE__ADMINISTRATIVE_AREA, oldAdministrativeArea,
                    administrativeArea));
        }
    }
    ...
    */
    public void setPostalCode(String newPostalCode) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.ADDRESS_TYPE__POSTAL_CODE, oldPostalCode, postalCode));
        }
    }
    ...
    */
    public void setCountry(String newCountry) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, OwsPackage.ADDRESS_TYPE__COUNTRY,
                    oldCountry, country));
        }
    }
    ...
    */
    public void setElectronicMailAddress(String newElectronicMailAddress) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    OwsPackage.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS, oldElectronicMailAddress,
    ...
    */
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case OwsPackage.ADDRESS_TYPE__DELIVERY_POINT:
            return (DELIVERY_POINT_EDEFAULT == null) ? (deliveryPoint != null)
        ...
        case OwsPackage.ADDRESS_TYPE__ADMINISTRATIVE_AREA:
            return (ADMINISTRATIVE_AREA_EDEFAULT == null) ? (administrativeArea != null)
                                                          : (!ADMINISTRATIVE_AREA_EDEFAULT.equals(administrativeArea));

        case OwsPackage.ADDRESS_TYPE__POSTAL_CODE:
            return (POSTAL_CODE_EDEFAULT == null) ? (postalCode != null)
        ...
        case OwsPackage.ADDRESS_TYPE__ELECTRONIC_MAIL_ADDRESS:
            return (ELECTRONIC_MAIL_ADDRESS_EDEFAULT == null) ? (electronicMailAddress != null)
                                                              : (!ELECTRONIC_MAIL_ADDRESS_EDEFAULT
            .equals(electronicMailAddress));
        }
