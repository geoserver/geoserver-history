...
public class IdentificationTypeImpl extends DescriptionTypeImpl implements IdentificationType {
    ...
    public FeatureMap getBoundingBoxGroup() {
        if (boundingBoxGroup == null) {
            boundingBoxGroup = new BasicFeatureMap(this,
                    OwsPackage.IDENTIFICATION_TYPE__BOUNDING_BOX_GROUP);
        }
    ...
    public FeatureMap getAvailableCRSGroup() {
        if (availableCRSGroup == null) {
            availableCRSGroup = new BasicFeatureMap(this,
                    OwsPackage.IDENTIFICATION_TYPE__AVAILABLE_CRS_GROUP);
        }
    ...
    public void setAvailableCRS(String newAvailableCRS) {
        ((FeatureMap.Internal) getAvailableCRSGroup()).set(OwsPackage.Literals.IDENTIFICATION_TYPE__AVAILABLE_CRS,
            newAvailableCRS);
    }
    ...
    public EList getMetadata() {
        if (metadata == null) {
            metadata = new EObjectContainmentEList(MetadataType.class, this,
                    OwsPackage.IDENTIFICATION_TYPE__METADATA);
        }
