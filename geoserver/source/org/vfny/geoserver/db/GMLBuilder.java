...
public class GMLBuilder {
	 ...
	 /**
		...
		*/
		public void initializeGeometry(Geometry geometry, String featureType, String srs, String tagName) {
	 ...
	 /**
		...
		*/ 
		...
		private class GeometryWriter {
				 ...
				 */ 
				private void initializeGeometry( Geometry geometry, String featureType, String srs, String tagName ) { 
						...
						if( verbose ) {
								...
								abstractGeometryStart1 = "\n   <" + featureType + "." + tagName + ">\n    <gml:" + geometry.getGeometryType() + " gid=\"";
								...
								// the start tags for the geometry (up to coordinates)
								abstractGeometryStart1 = "<" + featureType + "." + tagName + "><gml:" + geometry.getGeometryType() + " gid=\"";
								abstractGeometryStart2 = "\" srsName=\"http://www.opengis.net/gml/srs/epsg.xml#" + srs + "\">";

								// the start tags for the geometry (up to coordinates)
								abstractGeometryEnd = "</gml:" + geometry.getGeometryType() + "></" + featureType + "." + tagName + ">";
