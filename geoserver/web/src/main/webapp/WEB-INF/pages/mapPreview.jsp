 ...
 <logic:iterate id="it_value" indexId="idx" name="mapPreviewForm" property="DSNameList">
	...
	<tr >
		 ...
		 <td>
			...
			<a href="<bean:write property="BaseUrl" name="mapPreviewForm"/>wms/kml_reflect?superoverlay=true&layers=<bean:write property='<%= "EscapedFTNamespaceList[" + idx + "]" %>' name="mapPreviewForm"/>" target="_blank">KML</a>&nbsp;&nbsp;
