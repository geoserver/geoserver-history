 ...
 <logic:iterate id="it_value" indexId="idx" name="mapPreviewForm" property="DSNameList">
	...
	<tr >
		 ...
		 <td>
			...
			<a href="<bean:write property="BaseUrl" name="mapPreviewForm"/>wms/kml_reflect?layers=<bean:write property='<%= "FTNamespaceList[" + idx + "]" %>' name="mapPreviewForm"/>&legend=true" target="_blank">KML</a>&nbsp;&nbsp;
