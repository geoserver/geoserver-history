 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.InterpolationMethodsType#getInterpolationMethod <em>Interpolation Method</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.InterpolationMethodsType#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getInterpolationMethodsType()
...
public interface InterpolationMethodsType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.wcs.v1_1_1.InterpolationMethodType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getInterpolationMethodsType_InterpolationMethod()
     * @model type="net.opengis.wcs.v1_1_1.InterpolationMethodType" containment="true" required="true"
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getInterpolationMethodsType_Default()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.InterpolationMethodsType#getDefault <em>Default</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
