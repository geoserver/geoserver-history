 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.OutputType#getGridCRS <em>Grid CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.OutputType#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.OutputType#isStore <em>Store</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getOutputType()
...
public interface OutputType extends EObject {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getOutputType_GridCRS()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.OutputType#getGridCRS <em>Grid CRS</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getOutputType_Format()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.OutputType#getFormat <em>Format</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getOutputType_Store()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.OutputType#isStore <em>Store</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.v1_1_1.OutputType#isStore <em>Store</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetStore()
     * @see #isStore()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.v1_1_1.OutputType#isStore <em>Store</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
