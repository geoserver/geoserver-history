 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.ContentsType#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.ContentsType#getSupportedCRS <em>Supported CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.ContentsType#getSupportedFormat <em>Supported Format</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.ContentsType#getOtherSource <em>Other Source</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getContentsType()
...
public interface ContentsType extends EObject {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getContentsType_CoverageSummary()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getContentsType_SupportedCRS()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getContentsType_SupportedFormat()
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.OnlineResourceType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getContentsType_OtherSource()
     * @model type="net.opengis.ows.v1_1_0.OnlineResourceType" containment="true"
