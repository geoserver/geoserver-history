 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getGridCRS <em>Grid CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getTransformation <em>Transformation</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getImageCRS <em>Image CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getPolygon <em>Polygon</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getSpatialDomainType()
...
public interface SpatialDomainType extends EObject {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getSpatialDomainType_BoundingBoxGroup()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getSpatialDomainType_BoundingBox()
     * @model type="net.opengis.ows.v1_1_0.BoundingBoxType" containment="true" required="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getSpatialDomainType_GridCRS()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getGridCRS <em>Grid CRS</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getSpatialDomainType_Transformation()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getTransformation <em>Transformation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getSpatialDomainType_ImageCRS()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.SpatialDomainType#getImageCRS <em>Image CRS</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getSpatialDomainType_Polygon()
