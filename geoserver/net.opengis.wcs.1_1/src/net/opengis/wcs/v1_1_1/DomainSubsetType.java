 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.DomainSubsetType#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.DomainSubsetType#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.DomainSubsetType#getTemporalSubset <em>Temporal Subset</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getDomainSubsetType()
...
public interface DomainSubsetType extends EObject {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getDomainSubsetType_BoundingBoxGroup()
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getDomainSubsetType_BoundingBox()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.DomainSubsetType#getBoundingBox <em>Bounding Box</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getDomainSubsetType_TemporalSubset()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.DomainSubsetType#getTemporalSubset <em>Temporal Subset</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
