 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldType#getDefinition <em>Definition</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldType#getNullValue <em>Null Value</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldType#getInterpolationMethods <em>Interpolation Methods</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldType#getAxis <em>Axis</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldType()
...
public interface FieldType extends DescriptionType {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.FieldType#getIdentifier <em>Identifier</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldType_Definition()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.FieldType#getDefinition <em>Definition</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.CodeType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldType_NullValue()
     * @model type="net.opengis.ows.v1_1_0.CodeType" containment="true"
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldType_InterpolationMethods()
     * @model containment="true" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.FieldType#getInterpolationMethods <em>Interpolation Methods</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link net.opengis.wcs.v1_1_1.AxisType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldType_Axis()
     * @model type="net.opengis.wcs.v1_1_1.AxisType" containment="true"
