 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.SpatialDomainTypeImpl#getBoundingBoxGroup <em>Bounding Box Group</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.SpatialDomainTypeImpl#getBoundingBox <em>Bounding Box</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.SpatialDomainTypeImpl#getGridCRS <em>Grid CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.SpatialDomainTypeImpl#getTransformation <em>Transformation</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.SpatialDomainTypeImpl#getImageCRS <em>Image CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.SpatialDomainTypeImpl#getPolygon <em>Polygon</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
