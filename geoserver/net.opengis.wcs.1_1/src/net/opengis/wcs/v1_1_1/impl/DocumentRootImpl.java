 ...
 * $Id$
 */
package net.opengis.wcs.v1_1_1.impl;

import net.opengis.ows.v1_1_0.ReferenceGroupType;

import net.opengis.wcs.v1_1_1.AvailableKeysType;
import net.opengis.wcs.v1_1_1.AxisSubsetType;
import net.opengis.wcs.v1_1_1.CapabilitiesType;
import net.opengis.wcs.v1_1_1.ContentsType;
import net.opengis.wcs.v1_1_1.CoverageDescriptionsType;
import net.opengis.wcs.v1_1_1.CoverageSummaryType;
import net.opengis.wcs.v1_1_1.CoveragesType;
import net.opengis.wcs.v1_1_1.DescribeCoverageType;
import net.opengis.wcs.v1_1_1.DocumentRoot;
...
import net.opengis.wcs.v1_1_1.Wcs111Package;
 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getAvailableKeys <em>Available Keys</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getAxisSubset <em>Axis Subset</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getCoverage <em>Coverage</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getCoverageDescriptions <em>Coverage Descriptions</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getCoverages <em>Coverages</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getCoverageSummary <em>Coverage Summary</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getDescribeCoverage <em>Describe Coverage</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGetCapabilities <em>Get Capabilities</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGetCoverage <em>Get Coverage</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGridBaseCRS <em>Grid Base CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGridCRS <em>Grid CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGridCS <em>Grid CS</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGridOffsets <em>Grid Offsets</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGridOrigin <em>Grid Origin</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getGridType <em>Grid Type</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getInterpolationMethods <em>Interpolation Methods</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getTemporalDomain <em>Temporal Domain</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.impl.DocumentRootImpl#getTemporalSubset <em>Temporal Subset</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
