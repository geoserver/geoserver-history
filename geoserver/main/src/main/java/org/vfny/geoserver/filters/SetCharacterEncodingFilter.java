 ...
 *      configured for this request, either conditionally or unconditionally
 *      based on the <code>ignore</code> initialization parameter.  This
 *      parameter is required, so there is no default.</li>
 *      <li><strong>ignore</strong> - If set to "true", any character
 *      encoding specified by the client is ignored, and the value returned by
 *      the <code>selectEncoding()</code> method is set.  If set to "false,
 ...
 * incoming request (such as the values of the <code>Accept-Language</code>
...
public class SetCharacterEncodingFilter implements Filter {
     ...
     * the characteristics of the current request and/or filter initialization
     ...
     * initialization parameter for this filter.</p>
     *
     * @param request The servlet request we are processing
     *
     * @return DOCUMENT ME!
