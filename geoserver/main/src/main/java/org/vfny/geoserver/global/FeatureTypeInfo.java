...
//    private String alias;
     ...
     * @author David Winslow, OpenGeo (not really, I just autogenerated it with eclipse.  But it's dumb code so I thought I'd put a name on it.)
     */
    private static class DummyFeatureTypeInfo implements org.geoserver.catalog.FeatureTypeInfo{
		...
		public FeatureSource getFeatureSource(ProgressListener listener,
