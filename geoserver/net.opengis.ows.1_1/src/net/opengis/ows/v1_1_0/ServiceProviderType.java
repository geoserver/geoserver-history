 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceProviderType#getProviderName <em>Provider Name</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceProviderType#getProviderSite <em>Provider Site</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceProviderType#getServiceContact <em>Service Contact</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceProviderType()
...
public interface ServiceProviderType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceProviderType_ProviderName()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ServiceProviderType#getProviderName <em>Provider Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceProviderType_ProviderSite()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ServiceProviderType#getProviderSite <em>Provider Site</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceProviderType_ServiceContact()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ServiceProviderType#getServiceContact <em>Service Contact</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
