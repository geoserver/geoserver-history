 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getSections <em>Sections</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getBaseUrl <em>Base Url</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getGetCapabilitiesType()
...
public interface GetCapabilitiesType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetCapabilitiesType_AcceptVersions()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetCapabilitiesType_Sections()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getSections <em>Sections</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetCapabilitiesType_AcceptFormats()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetCapabilitiesType_UpdateSequence()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getGetCapabilitiesType_BaseUrl()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.GetCapabilitiesType#getBaseUrl <em>Base Url</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
