 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceIdentificationType#getServiceType <em>Service Type</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceIdentificationType#getServiceTypeVersion <em>Service Type Version</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceIdentificationType#getProfile <em>Profile</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceIdentificationType#getFees <em>Fees</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceIdentificationType#getAccessConstraints <em>Access Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceIdentificationType()
...
public interface ServiceIdentificationType extends DescriptionType {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceIdentificationType_ServiceType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ServiceIdentificationType#getServiceType <em>Service Type</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceIdentificationType_ServiceTypeVersion()
     * @model unique="false" dataType="net.opengis.ows.v1_1_0.VersionType" required="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceIdentificationType_Profile()
     ...
     * @see #setFees(String)
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceIdentificationType_Fees()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ServiceIdentificationType#getFees <em>Fees</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceIdentificationType_AccessConstraints()
