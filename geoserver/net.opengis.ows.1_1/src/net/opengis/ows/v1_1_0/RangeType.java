 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.RangeType#getMinimumValue <em>Minimum Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.RangeType#getMaximumValue <em>Maximum Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.RangeType#getSpacing <em>Spacing</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.RangeType#getRangeClosure <em>Range Closure</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getRangeType()
...
public interface RangeType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getRangeType_MinimumValue()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.RangeType#getMinimumValue <em>Minimum Value</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getRangeType_MaximumValue()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.RangeType#getMaximumValue <em>Maximum Value</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getRangeType_Spacing()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.RangeType#getSpacing <em>Spacing</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getRangeType_RangeClosure()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.RangeType#getRangeClosure <em>Range Closure</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.ows.v1_1_0.RangeType#getRangeClosure <em>Range Closure</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetRangeClosure()
     * @see #getRangeClosure()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.ows.v1_1_0.RangeType#getRangeClosure <em>Range Closure</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
