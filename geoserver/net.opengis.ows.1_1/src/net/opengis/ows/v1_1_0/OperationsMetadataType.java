 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationsMetadataType#getOperation <em>Operation</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationsMetadataType#getParameter <em>Parameter</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationsMetadataType#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.OperationsMetadataType#getExtendedCapabilities <em>Extended Capabilities</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationsMetadataType()
...
public interface OperationsMetadataType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.OperationType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationsMetadataType_Operation()
     * @model type="net.opengis.ows.v1_1_0.OperationType" containment="true" lower="2"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationsMetadataType_Parameter()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationsMetadataType_Constraint()
     * @model type="net.opengis.ows.v1_1_0.DomainType" containment="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getOperationsMetadataType_ExtendedCapabilities()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.OperationsMetadataType#getExtendedCapabilities <em>Extended Capabilities</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
