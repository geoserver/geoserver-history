 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ValueType#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getValueType()
...
public interface ValueType extends EObject {
     ...
     * @see #setValue(String)
     * @see net.opengis.ows.v1_1_0.Ows11Package#getValueType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ValueType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
