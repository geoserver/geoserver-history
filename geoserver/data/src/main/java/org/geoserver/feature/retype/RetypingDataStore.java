...
public class RetypingDataStore implements DataStore {
     ...
     * @throws IOException
     */
    FeatureTypeMap getTypeMapBackwards(String externalTypeName)
        throws IOException {
     ...
     * @throws IOException
     */
    void updateMap(FeatureTypeMap map, boolean forceUpdate)
        throws IOException {
        try {
     ...
     * @throws IOException
     */
    protected FeatureType transformFeatureType(FeatureType original)
        throws IOException {
