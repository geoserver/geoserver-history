...
public interface WfsPackage extends EPackage {
     ...
     * @ordered
     */
    int GET_CAPABILITIES_TYPE__BASE_URL = OwsPackage.GET_CAPABILITIES_TYPE__BASE_URL;
     ...
     * @ordered
     */
    int WFS_CAPABILITIES_TYPE__FEATURE_TYPE_LIST = OwsPackage.CAPABILITIES_BASE_TYPE_FEATURE_COUNT
        + 0;
     ...
     * @ordered
     */
    int WFS_CAPABILITIES_TYPE__SERVES_GML_OBJECT_TYPE_LIST = OwsPackage.CAPABILITIES_BASE_TYPE_FEATURE_COUNT
        + 1;
     ...
     * @ordered
     */
    int WFS_CAPABILITIES_TYPE__SUPPORTS_GML_OBJECT_TYPE_LIST = OwsPackage.CAPABILITIES_BASE_TYPE_FEATURE_COUNT
        + 2;
     ...
     * @ordered
     */
    int WFS_CAPABILITIES_TYPE__FILTER_CAPABILITIES = OwsPackage.CAPABILITIES_BASE_TYPE_FEATURE_COUNT
        + 3;
