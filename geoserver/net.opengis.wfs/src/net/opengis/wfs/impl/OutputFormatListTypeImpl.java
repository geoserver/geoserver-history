...
public class OutputFormatListTypeImpl extends EObjectImpl
    ...
    public void setFormat(String newFormat) {
        ((FeatureMap.Internal) getGroup()).set(WfsPackage.Literals.OUTPUT_FORMAT_LIST_TYPE__FORMAT,
            newFormat);
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case WfsPackage.OUTPUT_FORMAT_LIST_TYPE__FORMAT:
            return (FORMAT_EDEFAULT == null) ? (getFormat() != null)
                                             : (!FORMAT_EDEFAULT.equals(getFormat()));
        }
