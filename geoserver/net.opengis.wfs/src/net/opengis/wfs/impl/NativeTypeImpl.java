...
public class NativeTypeImpl extends EObjectImpl implements NativeType {
    ...
    public void setSafeToIgnore(boolean newSafeToIgnore) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.NATIVE_TYPE__SAFE_TO_IGNORE, oldSafeToIgnore, safeToIgnore,
                    !oldSafeToIgnoreESet));
        }
    }
    ...
    public void unsetSafeToIgnore() {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.UNSET,
                    WfsPackage.NATIVE_TYPE__SAFE_TO_IGNORE, oldSafeToIgnore,
                    SAFE_TO_IGNORE_EDEFAULT, oldSafeToIgnoreESet));
        }
    }
    ...
    */
    public void setVendorId(String newVendorId) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.NATIVE_TYPE__VENDOR_ID, oldVendorId, vendorId));
        }
    }
    ...
    */
    public boolean eIsSet(int featureID) {
        ...
        case WfsPackage.NATIVE_TYPE__VENDOR_ID:
            return (VENDOR_ID_EDEFAULT == null) ? (vendorId != null)
                                                : (!VENDOR_ID_EDEFAULT.equals(vendorId));
        }
