...
public class QueryTypeImpl extends EObjectImpl implements QueryType {
    ...
    public EList getPropertyName() {
        if (propertyName == null) {
            propertyName = new EDataTypeUniqueEList(String.class, this,
                    WfsPackage.QUERY_TYPE__PROPERTY_NAME);
        }
    ...
    public EList getFunction() {
        if (function == null) {
            function = new EDataTypeUniqueEList(Function.class, this,
                    WfsPackage.QUERY_TYPE__FUNCTION);
        }
