...
public class GMLObjectTypeTypeImpl extends EObjectImpl implements GMLObjectTypeType {
    ...
    public void setName(QName newName) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.GML_OBJECT_TYPE_TYPE__NAME, oldName, name));
        }
    }
    ...
    */
    public void setTitle(String newTitle) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.GML_OBJECT_TYPE_TYPE__TITLE, oldTitle, title));
        }
    }
    ...
    */
    public void setAbstract(String newAbstract) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.GML_OBJECT_TYPE_TYPE__ABSTRACT, oldAbstract, abstract_));
        }
    }
    ...
    public EList getKeywords() {
        if (keywords == null) {
            keywords = new EObjectContainmentEList(KeywordsType.class, this,
                    WfsPackage.GML_OBJECT_TYPE_TYPE__KEYWORDS);
        }
    ...
    public NotificationChain basicSetOutputFormats(OutputFormatListType newOutputFormats,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    WfsPackage.GML_OBJECT_TYPE_TYPE__OUTPUT_FORMATS, oldOutputFormats,
                    newOutputFormats);
    ...
    */
    public void setOutputFormats(OutputFormatListType newOutputFormats) {
        if (newOutputFormats != outputFormats) {
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.GML_OBJECT_TYPE_TYPE__OUTPUT_FORMATS, newOutputFormats,
                    newOutputFormats));
        }
    }
