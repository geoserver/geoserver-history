...
public class MetadataURLTypeImpl extends EObjectImpl implements MetadataURLType {
    ...
    public void setValue(String newValue) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.METADATA_URL_TYPE__VALUE, oldValue, value));
        }
    }
    ...
    public void setFormat(String newFormat) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.METADATA_URL_TYPE__FORMAT, oldFormat, format));
        }
    }
    ...
    public void setType(String newType) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.METADATA_URL_TYPE__TYPE, oldType, type));
        }
    }
