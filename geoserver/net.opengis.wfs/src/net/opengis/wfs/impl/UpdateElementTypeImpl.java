...
public class UpdateElementTypeImpl extends EObjectImpl
    ...
    public EList getProperty() {
        if (property == null) {
            property = new EObjectContainmentEList(PropertyType.class, this,
                    WfsPackage.UPDATE_ELEMENT_TYPE__PROPERTY);
        }
    ...
    public void setFilter(Filter newFilter) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.UPDATE_ELEMENT_TYPE__FILTER, oldFilter, filter));
        }
    }
    ...
    public void setHandle(String newHandle) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.UPDATE_ELEMENT_TYPE__HANDLE, oldHandle, handle));
        }
    }
