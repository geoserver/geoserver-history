 ...
 * @generated
 */
public class FeaturesNotLockedTypeImpl extends EObjectImpl
    implements FeaturesNotLockedType {
    /**
    ...
    public FeatureMap getGroup() {
        if (group == null) {
            group = new BasicFeatureMap(this,
                    WfsPackage.FEATURES_NOT_LOCKED_TYPE__GROUP);
        }
    ...
    public EList getFeatureId() {
        if (featureId == null) {
            featureId = new EDataTypeUniqueEList(FeatureId.class, this,
                    WfsPackage.FEATURES_NOT_LOCKED_TYPE__FEATURE_ID);
        }
