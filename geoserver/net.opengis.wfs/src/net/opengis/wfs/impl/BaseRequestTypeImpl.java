...
public abstract class BaseRequestTypeImpl extends EObjectImpl implements BaseRequestType {
    ...
    public void setHandle(String newHandle) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.BASE_REQUEST_TYPE__HANDLE, oldHandle, handle));
        }
    }
    ...
    */
    public void setService(String newService) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.BASE_REQUEST_TYPE__SERVICE, oldService, service, !oldServiceESet));
        }
    }
    ...
    public void unsetService() {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.UNSET,
                    WfsPackage.BASE_REQUEST_TYPE__SERVICE, oldService, SERVICE_EDEFAULT,
                    oldServiceESet));
        }
    }
    ...
    */
    public void setVersion(String newVersion) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.BASE_REQUEST_TYPE__VERSION, oldVersion, version, !oldVersionESet));
        }
    }
    ...
    */
    public void unsetVersion() {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.UNSET,
                    WfsPackage.BASE_REQUEST_TYPE__VERSION, oldVersion, VERSION_EDEFAULT,
                    oldVersionESet));
        }
    }
    ...
    */
    ...
    public void setBaseUrl(String newBaseUrl) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.BASE_REQUEST_TYPE__BASE_URL, oldBaseUrl, baseUrl));
        }
    }
