...
public class TransactionSummaryTypeImpl extends EObjectImpl implements TransactionSummaryType {
    ...
    public void setTotalInserted(BigInteger newTotalInserted) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_INSERTED, oldTotalInserted,
                    totalInserted));
        }
    }
    ...
    */
    public void setTotalUpdated(BigInteger newTotalUpdated) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_UPDATED, oldTotalUpdated,
                    totalUpdated));
        }
    }
    ...
    */
    public void setTotalDeleted(BigInteger newTotalDeleted) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET,
                    WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_DELETED, oldTotalDeleted,
                    totalDeleted));
        }
    }
    ...
    */
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_INSERTED:
            return (TOTAL_INSERTED_EDEFAULT == null) ? (totalInserted != null)
                                                     : (!TOTAL_INSERTED_EDEFAULT.equals(totalInserted));

        case WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_UPDATED:
            return (TOTAL_UPDATED_EDEFAULT == null) ? (totalUpdated != null)
                                                    : (!TOTAL_UPDATED_EDEFAULT.equals(totalUpdated));

        case WfsPackage.TRANSACTION_SUMMARY_TYPE__TOTAL_DELETED:
            return (TOTAL_DELETED_EDEFAULT == null) ? (totalDeleted != null)
