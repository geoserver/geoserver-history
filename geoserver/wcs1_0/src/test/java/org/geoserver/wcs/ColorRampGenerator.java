...
public class ColorRampGenerator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("<ColorMapEntry color=\"#000000\" quantity=\"" + (min - res) + "\" opacity=\"0.0\"/>");
        for (int c = 0; c <= intervals; c++) {
            ...
            System.out.println("<ColorMapEntry color=\"#" + hexColor + "\" quantity=\"" + (min + (c * res)) + "\"/>");
        }
        System.out.println("<ColorMapEntry color=\"#000000\" quantity=\"" + (max + res) + "\" opacity=\"0.0\"/>");
    }
