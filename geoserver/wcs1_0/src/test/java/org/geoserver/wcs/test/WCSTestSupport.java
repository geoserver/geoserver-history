...
public class WCSTestSupport extends KvpRequestReaderTestSupport {
    ...
    protected static final Schema WCS10_SCHEMA;
    
    static {
        try {
            final SchemaFactory factory = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
            WCS10_SCHEMA = factory.newSchema(new File("./schemas/wcs/1.0.0/getCoverage.xsd"));
        } catch(Exception e) {
    ...
    protected void populateDataDirectory(MockData dataDirectory) throws Exception {
        ...
        dataDirectory.addCoverage(ROTATED_CAD, WCSTestSupport.class.getResource("rotated.tiff"), TIFF, null);
        dataDirectory.addCoverage(WORLD, WCSTestSupport.class.getResource("world.tiff"), TIFF, null);
    }
