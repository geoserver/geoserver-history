...
public class CoverageResource extends MapResource {
    ...
    private Map getCoverageConfigMap(CoverageConfig cc) {
        ...
        envPoints.add(Double.valueOf(env.getLowerCorner().getOrdinate(0)));
        envPoints.add(Double.valueOf(env.getLowerCorner().getOrdinate(1)));
        envPoints.add(Double.valueOf(env.getUpperCorner().getOrdinate(0)));
        envPoints.add(Double.valueOf(env.getUpperCorner().getOrdinate(1)));
