...
import org.geotools.gce.BaseGridFormat;
...
/**
 * This class extends Resource to handle the GET and PUT requests to 
 * manage the upload of the GeoTIFF files.
 * 
...
public class CoverageStoreFileResource extends Resource {
    ...
    /**
     * This function handles the GET request to verify 
     * if the CoverageStore or the Coverage are available.
     */
    ...
    /**
     * This function handles the PUT requests managing the construction 
     * of the coverage store and the coverage if necessary.
     */
    ...
    public void handlePut(){
		...
		if (format instanceof BaseGridFormat) {
			cvReader = (AbstractGridCoverage2DReader) ((BaseGridFormat) format).getReader(uploadedFile);
    ...
    private File handleUpload(String coverageName, String extension, Request request) 
    ...
    /**
     * This function manages the save of the configuration for 
     * the CoverageStore and the Coverage 
     */
