 ...
 *
 */
public class QuantileGenerator extends Restlet {
	final private RulesBuilder builder = new RulesBuilder();
	private Data dt;
	
	public QuantileGenerator(Data dt) {
		this.dt = dt;
	}
	...
	public void handle(Request request, Response response) {
		...
		List<Rule> rules = this.generateQuantile(attributes);
		JSONArray json = null;
	...
	private List<Rule> generateQuantile(Map attributes) {
