...
public class RulesBuilder {
	...
	public List<Rule> quantileClassification(FeatureCollection features,
		...
		try {
			...
			System.out
					.println("RulesBuilder: failed to build Quantile Classification");
			e.printStackTrace();
		}
		return null;
	}
	...
	public List<Rule> equalIntervalClassification(FeatureCollection features,
		...
		try {
			...
			System.out
					.println("RulesBuilder: failed to build EqualInterval Classification");
			e.printStackTrace();
	...
	public List<Rule> uniqueIntervalClassification(FeatureCollection features,
		...
		try {
			Function classify = ff.function("UniqueInterval", ff
					.property(property), ff.literal(classNumber));
			groups = (Classifier) classify.evaluate(features);
			if (groups instanceof RangedClassifier)
				return this.rangedRules((RangedClassifier) groups, property);
			...
			System.out
					.println("RulesBuilder: failed to build UniqueInterval Classification");
			e.printStackTrace();
		}
		return null;
	}
