 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.AvailableKeysType#getKey <em>Key</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getAvailableKeysType()
...
public interface AvailableKeysType extends EObject {
     ...
     * @see net.opengis.wcs.wcsPackage#getAvailableKeysType_Key()
