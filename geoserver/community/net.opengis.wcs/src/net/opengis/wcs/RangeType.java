 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.RangeType#getField <em>Field</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getRangeType()
...
public interface RangeType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.wcs.FieldType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.wcsPackage#getRangeType_Field()
     * @model type="net.opengis.wcs.FieldType" containment="true" required="true"
