 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.DCPType#getHTTP <em>HTTP</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getDCPType()
...
public interface DCPType extends EObject {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getDCPType_HTTP()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.DCPType#getHTTP <em>HTTP</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
