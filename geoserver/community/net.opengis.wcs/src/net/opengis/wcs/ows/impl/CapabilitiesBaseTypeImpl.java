 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.impl.CapabilitiesBaseTypeImpl#getServiceIdentification <em>Service Identification</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.CapabilitiesBaseTypeImpl#getServiceProvider <em>Service Provider</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.CapabilitiesBaseTypeImpl#getOperationsMetadata <em>Operations Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.CapabilitiesBaseTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.CapabilitiesBaseTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CapabilitiesBaseTypeImpl extends EObjectImpl implements CapabilitiesBaseType {
     ...
     * @ordered
     */
    protected static final Object SERVICE_PROVIDER_EDEFAULT = null;
     ...
     * @ordered
     */
    protected Object serviceProvider = SERVICE_PROVIDER_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return owcsPackage.Literals.CAPABILITIES_BASE_TYPE;
    }
    ...
    public NotificationChain basicSetServiceIdentification(ServiceIdentificationType newServiceIdentification, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_IDENTIFICATION, oldServiceIdentification, newServiceIdentification);
    ...
    public void setServiceIdentification(ServiceIdentificationType newServiceIdentification) {
        if (newServiceIdentification != serviceIdentification) {
            ...
            if (serviceIdentification != null)
                msgs = ((InternalEObject)serviceIdentification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_IDENTIFICATION, null, msgs);
            if (newServiceIdentification != null)
                msgs = ((InternalEObject)newServiceIdentification).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_IDENTIFICATION, null, msgs);
            msgs = basicSetServiceIdentification(newServiceIdentification, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_IDENTIFICATION, newServiceIdentification, newServiceIdentification));
    }
     ...
     * @generated
     */
    public void setServiceProvider(Object newServiceProvider) {
        Object oldServiceProvider = serviceProvider;
        serviceProvider = newServiceProvider;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_PROVIDER, oldServiceProvider, serviceProvider));
    }
    ...
    public NotificationChain basicSetOperationsMetadata(OperationsMetadataType newOperationsMetadata, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, owcsPackage.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA, oldOperationsMetadata, newOperationsMetadata);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setOperationsMetadata(OperationsMetadataType newOperationsMetadata) {
        if (newOperationsMetadata != operationsMetadata) {
            ...
            if (operationsMetadata != null)
                msgs = ((InternalEObject)operationsMetadata).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - owcsPackage.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA, null, msgs);
            if (newOperationsMetadata != null)
                msgs = ((InternalEObject)newOperationsMetadata).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - owcsPackage.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA, null, msgs);
            msgs = basicSetOperationsMetadata(newOperationsMetadata, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA, newOperationsMetadata, newOperationsMetadata));
    }
    ...
    public void setUpdateSequence(String newUpdateSequence) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.CAPABILITIES_BASE_TYPE__UPDATE_SEQUENCE, oldUpdateSequence, updateSequence));
    }
    ...
    public void setVersion(Object newVersion) {
        ...
        version = newVersion;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.CAPABILITIES_BASE_TYPE__VERSION, oldVersion, version));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_IDENTIFICATION:
                return basicSetServiceIdentification(null, msgs);
            case owcsPackage.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_PROVIDER:
                return getServiceProvider();
            case owcsPackage.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA:
                return getOperationsMetadata();
            case owcsPackage.CAPABILITIES_BASE_TYPE__UPDATE_SEQUENCE:
                return getUpdateSequence();
            case owcsPackage.CAPABILITIES_BASE_TYPE__VERSION:
                return getVersion();
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case owcsPackage.CAPABILITIES_BASE_TYPE__SERVICE_PROVIDER:
                return SERVICE_PROVIDER_EDEFAULT == null ? serviceProvider != null : !SERVICE_PROVIDER_EDEFAULT.equals(serviceProvider);
            case owcsPackage.CAPABILITIES_BASE_TYPE__OPERATIONS_METADATA:
