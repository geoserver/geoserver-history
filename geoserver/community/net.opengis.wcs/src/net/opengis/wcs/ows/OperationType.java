 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.OperationType#getDCP <em>DCP</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.OperationType#getParameter <em>Parameter</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.OperationType#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.OperationType#getMetadata <em>Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.OperationType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getOperationType()
...
public interface OperationType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.wcs.ows.DCPType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationType_DCP()
     * @model type="net.opengis.wcs.ows.DCPType" containment="true" required="true"
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationType_Parameter()
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationType_Constraint()
     * @model type="net.opengis.wcs.ows.DomainType" containment="true"
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationType_Metadata()
     ...
     * @see #setName(String)
     * @see net.opengis.wcs.ows.owcsPackage#getOperationType_Name()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.OperationType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
