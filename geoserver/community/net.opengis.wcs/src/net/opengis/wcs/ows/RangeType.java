 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.RangeType#getMinimumValue <em>Minimum Value</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.RangeType#getMaximumValue <em>Maximum Value</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.RangeType#getSpacing <em>Spacing</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.RangeType#getRangeClosure <em>Range Closure</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getRangeType()
...
public interface RangeType extends EObject {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getRangeType_MinimumValue()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.RangeType#getMinimumValue <em>Minimum Value</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getRangeType_MaximumValue()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.RangeType#getMaximumValue <em>Maximum Value</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getRangeType_Spacing()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.RangeType#getSpacing <em>Spacing</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getRangeType_RangeClosure()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.RangeType#getRangeClosure <em>Range Closure</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.opengis.wcs.ows.RangeType#getRangeClosure <em>Range Closure</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetRangeClosure()
     * @see #getRangeClosure()
    ...
    /**
     * Returns whether the value of the '{@link net.opengis.wcs.ows.RangeType#getRangeClosure <em>Range Closure</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
