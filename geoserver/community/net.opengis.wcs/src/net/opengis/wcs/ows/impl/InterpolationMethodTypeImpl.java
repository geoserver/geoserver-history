 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.impl.InterpolationMethodTypeImpl#getNullResistance <em>Null Resistance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterpolationMethodTypeImpl extends InterpolationMethodBaseTypeImpl implements InterpolationMethodType {
    ...
    protected EClass eStaticClass() {
        return owcsPackage.Literals.INTERPOLATION_METHOD_TYPE;
    }
    ...
    public void setNullResistance(String newNullResistance) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.INTERPOLATION_METHOD_TYPE__NULL_RESISTANCE, oldNullResistance, nullResistance));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case owcsPackage.INTERPOLATION_METHOD_TYPE__NULL_RESISTANCE:
