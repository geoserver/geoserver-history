 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.ServiceIdentificationType#getServiceType <em>Service Type</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.ServiceIdentificationType#getServiceTypeVersion <em>Service Type Version</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.ServiceIdentificationType#getProfile <em>Profile</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.ServiceIdentificationType#getFees <em>Fees</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.ServiceIdentificationType#getAccessConstraints <em>Access Constraints</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getServiceIdentificationType()
...
public interface ServiceIdentificationType extends DescriptionType {
     ...
     * @see #setServiceType(Object)
     * @see net.opengis.wcs.ows.owcsPackage#getServiceIdentificationType_ServiceType()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType" required="true"
     *        extendedMetaData="kind='element' name='ServiceType' namespace='##targetNamespace'"
     * @generated
     */
    Object getServiceType();

    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.ServiceIdentificationType#getServiceType <em>Service Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    void setServiceType(Object value);
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getServiceIdentificationType_ServiceTypeVersion()
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getServiceIdentificationType_Profile()
     ...
     * @see #setFees(String)
     * @see net.opengis.wcs.ows.owcsPackage#getServiceIdentificationType_Fees()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.ServiceIdentificationType#getFees <em>Fees</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getServiceIdentificationType_AccessConstraints()
