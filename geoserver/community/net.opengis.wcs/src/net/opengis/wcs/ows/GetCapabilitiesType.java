 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.GetCapabilitiesType#getSections <em>Sections</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getGetCapabilitiesType()
...
public interface GetCapabilitiesType extends EObject {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getGetCapabilitiesType_AcceptVersions()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.GetCapabilitiesType#getAcceptVersions <em>Accept Versions</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getGetCapabilitiesType_Sections()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.GetCapabilitiesType#getSections <em>Sections</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getGetCapabilitiesType_AcceptFormats()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.GetCapabilitiesType#getAcceptFormats <em>Accept Formats</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getGetCapabilitiesType_UpdateSequence()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.GetCapabilitiesType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
