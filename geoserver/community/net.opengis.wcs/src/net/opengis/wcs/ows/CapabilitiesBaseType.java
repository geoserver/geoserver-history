 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.CapabilitiesBaseType#getServiceIdentification <em>Service Identification</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.CapabilitiesBaseType#getOperationsMetadata <em>Operations Metadata</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.CapabilitiesBaseType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getCapabilitiesBaseType()
...
public interface CapabilitiesBaseType extends EObject {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getCapabilitiesBaseType_ServiceIdentification()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.CapabilitiesBaseType#getServiceIdentification <em>Service Identification</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setServiceProvider(Object)
     * @see net.opengis.wcs.ows.owcsPackage#getCapabilitiesBaseType_ServiceProvider()
     * @model dataType="org.eclipse.emf.ecore.xml.type.AnySimpleType"
     *        extendedMetaData="kind='element' name='ServiceProvider' namespace='http://www.opengis.net/ows'"
     * @generated
     */
    Object getServiceProvider();

    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    void setServiceProvider(Object value);
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getCapabilitiesBaseType_OperationsMetadata()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.CapabilitiesBaseType#getOperationsMetadata <em>Operations Metadata</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getCapabilitiesBaseType_UpdateSequence()
     * @model dataType="net.opengis.wcs.ows.UpdateSequenceType"
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getCapabilitiesBaseType_Version()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.CapabilitiesBaseType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
