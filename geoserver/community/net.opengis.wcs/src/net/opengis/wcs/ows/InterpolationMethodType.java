 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.InterpolationMethodType#getNullResistance <em>Null Resistance</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getInterpolationMethodType()
...
public interface InterpolationMethodType extends InterpolationMethodBaseType {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getInterpolationMethodType_NullResistance()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.InterpolationMethodType#getNullResistance <em>Null Resistance</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
