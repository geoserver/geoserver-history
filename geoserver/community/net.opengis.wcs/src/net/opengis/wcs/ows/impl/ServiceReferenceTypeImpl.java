 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.impl.ServiceReferenceTypeImpl#getRequestMessage <em>Request Message</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.ServiceReferenceTypeImpl#getRequestMessageReference <em>Request Message Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceReferenceTypeImpl extends ReferenceTypeImpl implements ServiceReferenceType {
    ...
    protected EClass eStaticClass() {
        return owcsPackage.Literals.SERVICE_REFERENCE_TYPE;
    }
    ...
    public NotificationChain basicSetRequestMessage(EObject newRequestMessage, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, owcsPackage.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE, oldRequestMessage, newRequestMessage);
    ...
    public void setRequestMessage(EObject newRequestMessage) {
        if (newRequestMessage != requestMessage) {
            ...
            if (requestMessage != null)
                msgs = ((InternalEObject)requestMessage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - owcsPackage.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE, null, msgs);
            if (newRequestMessage != null)
                msgs = ((InternalEObject)newRequestMessage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - owcsPackage.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE, null, msgs);
            msgs = basicSetRequestMessage(newRequestMessage, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE, newRequestMessage, newRequestMessage));
    }
    ...
    public void setRequestMessageReference(String newRequestMessageReference) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE_REFERENCE, oldRequestMessageReference, requestMessageReference));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case owcsPackage.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case owcsPackage.SERVICE_REFERENCE_TYPE__REQUEST_MESSAGE_REFERENCE:
