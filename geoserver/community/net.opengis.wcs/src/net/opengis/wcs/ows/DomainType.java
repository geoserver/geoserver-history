 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.DomainType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getDomainType()
...
public interface DomainType extends UnNamedDomainType {
     ...
     * @see #setName(String)
     * @see net.opengis.wcs.ows.owcsPackage#getDomainType_Name()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.DomainType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
