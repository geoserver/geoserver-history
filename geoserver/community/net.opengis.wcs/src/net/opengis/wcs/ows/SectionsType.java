 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.SectionsType#getSection <em>Section</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getSectionsType()
...
public interface SectionsType extends EObject {
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getSectionsType_Section()
