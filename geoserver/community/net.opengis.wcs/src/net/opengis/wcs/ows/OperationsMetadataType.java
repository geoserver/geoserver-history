 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.OperationsMetadataType#getOperation <em>Operation</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.OperationsMetadataType#getParameter <em>Parameter</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.OperationsMetadataType#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.OperationsMetadataType#getExtendedCapabilities <em>Extended Capabilities</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.ows.owcsPackage#getOperationsMetadataType()
...
public interface OperationsMetadataType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.wcs.ows.OperationType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationsMetadataType_Operation()
     * @model type="net.opengis.wcs.ows.OperationType" containment="true" lower="2"
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationsMetadataType_Parameter()
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationsMetadataType_Constraint()
     * @model type="net.opengis.wcs.ows.DomainType" containment="true"
     ...
     * @see net.opengis.wcs.ows.owcsPackage#getOperationsMetadataType_ExtendedCapabilities()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.ows.OperationsMetadataType#getExtendedCapabilities <em>Extended Capabilities</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
