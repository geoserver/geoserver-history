 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.ows.impl.RangeTypeImpl#getMinimumValue <em>Minimum Value</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.RangeTypeImpl#getMaximumValue <em>Maximum Value</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.RangeTypeImpl#getSpacing <em>Spacing</em>}</li>
 *   <li>{@link net.opengis.wcs.ows.impl.RangeTypeImpl#getRangeClosure <em>Range Closure</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RangeTypeImpl extends EObjectImpl implements RangeType {
    ...
    protected EClass eStaticClass() {
        return owcsPackage.Literals.RANGE_TYPE;
    }
    ...
    public NotificationChain basicSetMinimumValue(ValueType newMinimumValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, owcsPackage.RANGE_TYPE__MINIMUM_VALUE, oldMinimumValue, newMinimumValue);
    ...
    public void setMinimumValue(ValueType newMinimumValue) {
        if (newMinimumValue != minimumValue) {
            ...
            if (minimumValue != null)
                msgs = ((InternalEObject)minimumValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - owcsPackage.RANGE_TYPE__MINIMUM_VALUE, null, msgs);
            if (newMinimumValue != null)
                msgs = ((InternalEObject)newMinimumValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - owcsPackage.RANGE_TYPE__MINIMUM_VALUE, null, msgs);
            msgs = basicSetMinimumValue(newMinimumValue, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.RANGE_TYPE__MINIMUM_VALUE, newMinimumValue, newMinimumValue));
    }
    ...
    public NotificationChain basicSetMaximumValue(ValueType newMaximumValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, owcsPackage.RANGE_TYPE__MAXIMUM_VALUE, oldMaximumValue, newMaximumValue);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setMaximumValue(ValueType newMaximumValue) {
        if (newMaximumValue != maximumValue) {
            ...
            if (maximumValue != null)
                msgs = ((InternalEObject)maximumValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - owcsPackage.RANGE_TYPE__MAXIMUM_VALUE, null, msgs);
            if (newMaximumValue != null)
                msgs = ((InternalEObject)newMaximumValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - owcsPackage.RANGE_TYPE__MAXIMUM_VALUE, null, msgs);
            msgs = basicSetMaximumValue(newMaximumValue, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.RANGE_TYPE__MAXIMUM_VALUE, newMaximumValue, newMaximumValue));
    }
    ...
    public NotificationChain basicSetSpacing(ValueType newSpacing, NotificationChain msgs) {
        ...
        spacing = newSpacing;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, owcsPackage.RANGE_TYPE__SPACING, oldSpacing, newSpacing);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setSpacing(ValueType newSpacing) {
        if (newSpacing != spacing) {
            NotificationChain msgs = null;
            if (spacing != null)
                msgs = ((InternalEObject)spacing).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - owcsPackage.RANGE_TYPE__SPACING, null, msgs);
            if (newSpacing != null)
                msgs = ((InternalEObject)newSpacing).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - owcsPackage.RANGE_TYPE__SPACING, null, msgs);
            msgs = basicSetSpacing(newSpacing, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.RANGE_TYPE__SPACING, newSpacing, newSpacing));
    }
    ...
    public void setRangeClosure(RangeClosureType newRangeClosure) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, owcsPackage.RANGE_TYPE__RANGE_CLOSURE, oldRangeClosure, rangeClosure, !oldRangeClosureESet));
    }
    ...
    public void unsetRangeClosure() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, owcsPackage.RANGE_TYPE__RANGE_CLOSURE, oldRangeClosure, RANGE_CLOSURE_EDEFAULT, oldRangeClosureESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case owcsPackage.RANGE_TYPE__MINIMUM_VALUE:
                return basicSetMinimumValue(null, msgs);
            case owcsPackage.RANGE_TYPE__MAXIMUM_VALUE:
                return basicSetMaximumValue(null, msgs);
            case owcsPackage.RANGE_TYPE__SPACING:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case owcsPackage.RANGE_TYPE__SPACING:
                return getSpacing();
            case owcsPackage.RANGE_TYPE__RANGE_CLOSURE:
