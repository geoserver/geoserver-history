 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.CoverageDescriptionsType#getCoverageDescription <em>Coverage Description</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionsType()
...
public interface CoverageDescriptionsType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.wcs.CoverageDescriptionType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.wcs.wcsPackage#getCoverageDescriptionsType_CoverageDescription()
     * @model type="net.opengis.wcs.CoverageDescriptionType" containment="true" required="true"
