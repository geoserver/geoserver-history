 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.OutputTypeImpl#getGridCRS <em>Grid CRS</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.OutputTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.OutputTypeImpl#isStore <em>Store</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputTypeImpl extends EObjectImpl implements OutputType {
    ...
    protected EClass eStaticClass() {
        return wcsPackage.Literals.OUTPUT_TYPE;
    }
    ...
    public NotificationChain basicSetGridCRS(GridCrsType newGridCRS, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, wcsPackage.OUTPUT_TYPE__GRID_CRS, oldGridCRS, newGridCRS);
    ...
    public void setGridCRS(GridCrsType newGridCRS) {
        if (newGridCRS != gridCRS) {
            ...
            if (gridCRS != null)
                msgs = ((InternalEObject)gridCRS).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - wcsPackage.OUTPUT_TYPE__GRID_CRS, null, msgs);
            if (newGridCRS != null)
                msgs = ((InternalEObject)newGridCRS).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - wcsPackage.OUTPUT_TYPE__GRID_CRS, null, msgs);
            msgs = basicSetGridCRS(newGridCRS, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.OUTPUT_TYPE__GRID_CRS, newGridCRS, newGridCRS));
    }
    ...
    public void setFormat(Object newFormat) {
        ...
        format = newFormat;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.OUTPUT_TYPE__FORMAT, oldFormat, format));
    }
    ...
    public void setStore(boolean newStore) {
        ...
        storeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.OUTPUT_TYPE__STORE, oldStore, store, !oldStoreESet));
    }
    ...
    public void unsetStore() {
        ...
        storeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wcsPackage.OUTPUT_TYPE__STORE, oldStore, STORE_EDEFAULT, oldStoreESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case wcsPackage.OUTPUT_TYPE__GRID_CRS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wcsPackage.OUTPUT_TYPE__GRID_CRS:
                return getGridCRS();
            case wcsPackage.OUTPUT_TYPE__FORMAT:
                return getFormat();
            case wcsPackage.OUTPUT_TYPE__STORE:
