 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.TimePeriodTypeImpl#getBeginPosition <em>Begin Position</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.TimePeriodTypeImpl#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.TimePeriodTypeImpl#getTimeResolution <em>Time Resolution</em>}</li>
 *   <li>{@link net.opengis.wcs.impl.TimePeriodTypeImpl#getFrame <em>Frame</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimePeriodTypeImpl extends EObjectImpl implements TimePeriodType {
    ...
    protected EClass eStaticClass() {
        return wcsPackage.Literals.TIME_PERIOD_TYPE;
    }
    ...
    public void setBeginPosition(Object newBeginPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.TIME_PERIOD_TYPE__BEGIN_POSITION, oldBeginPosition, beginPosition));
    }
    ...
    public void setEndPosition(Object newEndPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.TIME_PERIOD_TYPE__END_POSITION, oldEndPosition, endPosition));
    }
    ...
    public void setTimeResolution(Object newTimeResolution) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.TIME_PERIOD_TYPE__TIME_RESOLUTION, oldTimeResolution, timeResolution));
    }
    ...
    public void setFrame(String newFrame) {
        ...
        frameESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, wcsPackage.TIME_PERIOD_TYPE__FRAME, oldFrame, frame, !oldFrameESet));
    }
    ...
    public void unsetFrame() {
        ...
        frameESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, wcsPackage.TIME_PERIOD_TYPE__FRAME, oldFrame, FRAME_EDEFAULT, oldFrameESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wcsPackage.TIME_PERIOD_TYPE__BEGIN_POSITION:
                return getBeginPosition();
            case wcsPackage.TIME_PERIOD_TYPE__END_POSITION:
                return getEndPosition();
            case wcsPackage.TIME_PERIOD_TYPE__TIME_RESOLUTION:
                return getTimeResolution();
            case wcsPackage.TIME_PERIOD_TYPE__FRAME:
                return getFrame();
        }
