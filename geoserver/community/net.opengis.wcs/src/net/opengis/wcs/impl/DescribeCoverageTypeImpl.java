 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.impl.DescribeCoverageTypeImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescribeCoverageTypeImpl extends RequestBaseTypeImpl implements DescribeCoverageType {
    ...
    protected EClass eStaticClass() {
        return wcsPackage.Literals.DESCRIBE_COVERAGE_TYPE;
    }
    ...
    public EList getIdentifier() {
        if (identifier == null) {
            identifier = new EDataTypeEList(String.class, this, wcsPackage.DESCRIBE_COVERAGE_TYPE__IDENTIFIER);
        }
        return identifier;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case wcsPackage.DESCRIBE_COVERAGE_TYPE__IDENTIFIER:
