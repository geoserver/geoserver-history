 ...
 */
public class ModelGridCoverageVerticalDomainResource extends MapResource {
    ...
    public ModelGridCoverageVerticalDomainResource(GeoServer geoServer, Catalog catalog){
        super();
    ...
    public Map getSupportedFormats() {
        ...
        m.put("html", new FreemarkerFormat("HTMLTemplates/gridcoveragevdomain.ftl", getClass(), MediaType.TEXT_HTML));
        m.put("json", new JSONFormat());
        m.put("xml", new AutoXMLFormat("VerticalDomain"));
    ...
    public static Map getMap(CoverageInfo theCoverage) {
        ...
        List<String> vDomain = getVdomain(theCoverage);
        m.put("lowerLimit", vDomain.get(0) != null ? vDomain.get(0) : "[None]");
        m.put("upperLimit", vDomain.get(1) != null ? vDomain.get(1) : "[None]");
        m.put("resolution", vDomain.get(2) != null ? vDomain.get(2) : "[None]");
        m.put("verticalDatumType", vDomain.get(3) != null ? vDomain.get(3) : "[None]");
        m.put("verticalAxisDimension", vDomain.get(4) != null ? vDomain.get(4) : "[None]");
