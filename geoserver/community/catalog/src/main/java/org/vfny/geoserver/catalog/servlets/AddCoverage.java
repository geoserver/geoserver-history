...
import org.vfny.geoserver.catalog.requests.readers.AddCoverageKvpReader;
import org.vfny.geoserver.catalog.requests.readers.AddCoverageXmlReader;
...
public class AddCoverage extends CATALOGService {
    ...
    protected KvpRequestReader getKvpReader(Map params) {
        return new AddCoverageKvpReader(params, this);
    }
    ...
    protected XmlRequestReader getXmlRequestReader() {
        return new AddCoverageXmlReader(this);
    }
}
