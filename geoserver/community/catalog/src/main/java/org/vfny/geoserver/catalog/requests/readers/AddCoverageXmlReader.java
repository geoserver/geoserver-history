...
import org.vfny.geoserver.catalog.requests.AddCoverageHandler;
...
/**
 * reads in a AddCoverage CATALOG request from a XML stream
 *
 * @author $Author: Alessio Fabiani (GeoSolutions)
 */
public class AddCoverageXmlReader extends XmlRequestReader {
    /**
     * Creates a new AddCoverageXmlReader object.
     */
    public AddCoverageXmlReader(CATALOGService service) {
        super(service);
    }
    ...
    public Request read(Reader reader, HttpServletRequest req)
        ...
        AddCoverageHandler contentHandler = new AddCoverageHandler((CATALOGService) getServiceRef());
