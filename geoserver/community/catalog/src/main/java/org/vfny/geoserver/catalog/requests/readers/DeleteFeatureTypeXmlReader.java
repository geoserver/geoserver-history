...
import org.vfny.geoserver.catalog.requests.DeleteFeatureTypeHandler;
...
/**
 * reads in a DeleteFeatureType CATALOG request from a XML stream
 *
 * @author $Author: Alessio Fabiani (GeoSolutions)
 */
public class DeleteFeatureTypeXmlReader extends XmlRequestReader {
    /**
     * Creates a new DeleteFeatureTypeXmlReader object.
     */
    public DeleteFeatureTypeXmlReader(CATALOGService service) {
        super(service);
    }
    ...
    public Request read(Reader reader, HttpServletRequest req)
        ...
        /** create a DeleteFeatureType request class to return */
        InputSource requestSource = new InputSource(reader);

        // instantiante parsers and content handlers
        DeleteFeatureTypeHandler contentHandler = new DeleteFeatureTypeHandler((CATALOGService) getServiceRef());
