...
import org.vfny.geoserver.catalog.requests.UpdateHandler;
...
/**
 * reads in a UpdateCatalog CATALOG request from a XML stream
 *
 * @author $Author: Alessio Fabiani (GeoSolutions)
 */
public class UpdateXmlReader extends XmlRequestReader {
    /**
     * Creates a new UpdateXmlReader object.
     */
    public UpdateXmlReader(CATALOGService service) {
        super(service);
    }
    ...
    public Request read(Reader reader, HttpServletRequest req)
        ...
        /** create a UpdateCatalog request class to return */
        InputSource requestSource = new InputSource(reader);

        // instantiante parsers and content handlers
        UpdateHandler contentHandler = new UpdateHandler((CATALOGService) getServiceRef());
