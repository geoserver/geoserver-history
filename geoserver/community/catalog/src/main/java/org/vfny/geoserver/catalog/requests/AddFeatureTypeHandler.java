 ...
 */
public class AddFeatureTypeHandler extends XMLFilterImpl implements ContentHandler {
    /** Class logger */
     ...
     */
    private AddFeatureTypeRequest request = null;

    /** Local variable to track current tag */
    private String currentTag = new String();

    public AddFeatureTypeHandler(CATALOGService service) {
        super();
        request = new AddFeatureTypeRequest(service);
    }

    /**
     * Returns the UpdateCatalog request.
     *
     * @return UpdateCatalog request.
     */
    public AddFeatureTypeRequest getRequest(HttpServletRequest req) {
    ...
    public void startElement(String namespaceURI, String localName, String rawName, Attributes atts)
        ...
        if (currentTag.equals("AddFeatureType")) {
    ...
    public void characters(char[] ch, int start, int length)
        ...
        if (currentTag.equals("Data")) {
            request.setData(s);
            LOGGER.finest("found data: " + s);
        }
    }
}
