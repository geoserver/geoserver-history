 ...
 */
public class UpdateHandler extends XMLFilterImpl implements ContentHandler {
    /** Class logger */
    private static Logger LOGGER = Logger.getLogger("org.vfny.geoserver.requests.catalog");

    /**
     * Internal UpdateCatalog request for construction.
     */
    ...
    public UpdateHandler(CATALOGService service) {
        super();
        request = new UpdateRequest(service);
    }
     ...
     */
    public UpdateRequest getRequest(HttpServletRequest req) {
    ...
    public void startElement(String namespaceURI, String localName, String rawName, Attributes atts)
        ...
        if (currentTag.equals("UpdateCatalog")) {
