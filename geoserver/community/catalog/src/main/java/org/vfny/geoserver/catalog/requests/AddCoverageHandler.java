...
public class AddCoverageHandler extends XMLFilterImpl implements ContentHandler {
     ...
     */
    private AddCoverageRequest request = null;

    /** Local variable to track current tag */
    private String currentTag = new String();

    public AddCoverageHandler(CATALOGService service) {
        super();
        request = new AddCoverageRequest(service);
    }
     ...
     */
    public AddCoverageRequest getRequest(HttpServletRequest req) {
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if (currentTag.equals("AddCoverage")) {
