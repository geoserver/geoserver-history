 ...
 * <p>
 * This class should not be used if you intend to use springs session factory support ({@link LocalSessionFactoryBean}.
 * See {@link GeoServerSessionFactoryBean} for this case.
 * </p>
 * 
 * @author Justin Deoliveira, The Open Planning Project
 * 
 */
public class ConfigurationInitializer implements BeanFactoryPostProcessor, ApplicationContextAware {
    ...
    public static void postProcessConfiguration(Configuration cfg,
            ApplicationContext applicationContext) {
