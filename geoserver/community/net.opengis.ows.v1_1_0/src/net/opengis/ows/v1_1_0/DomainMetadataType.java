 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.DomainMetadataType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DomainMetadataType#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getDomainMetadataType()
...
public interface DomainMetadataType extends EObject {
     ...
     * @see #setValue(String)
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDomainMetadataType_Value()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.DomainMetadataType#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDomainMetadataType_Reference()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.DomainMetadataType#getReference <em>Reference</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
