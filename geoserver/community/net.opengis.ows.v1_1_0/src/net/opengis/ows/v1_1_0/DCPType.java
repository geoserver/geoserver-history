 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.DCPType#getHTTP <em>HTTP</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getDCPType()
...
public interface DCPType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDCPType_HTTP()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.DCPType#getHTTP <em>HTTP</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
