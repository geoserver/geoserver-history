 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ContactType#getPhone <em>Phone</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ContactType#getAddress <em>Address</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ContactType#getOnlineResource <em>Online Resource</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ContactType#getHoursOfService <em>Hours Of Service</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ContactType#getContactInstructions <em>Contact Instructions</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getContactType()
...
public interface ContactType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getContactType_Phone()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ContactType#getPhone <em>Phone</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getContactType_Address()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ContactType#getAddress <em>Address</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getContactType_OnlineResource()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ContactType#getOnlineResource <em>Online Resource</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getContactType_HoursOfService()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ContactType#getHoursOfService <em>Hours Of Service</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getContactType_ContactInstructions()
     * @model dataType="org.eclipse.emf.ecore.xml.type.String"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ContactType#getContactInstructions <em>Contact Instructions</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
