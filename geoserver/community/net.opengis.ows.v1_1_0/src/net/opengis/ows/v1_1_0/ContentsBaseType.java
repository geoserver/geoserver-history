 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ContentsBaseType#getDatasetDescriptionSummary <em>Dataset Description Summary</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ContentsBaseType#getOtherSource <em>Other Source</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getContentsBaseType()
...
public interface ContentsBaseType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getContentsBaseType_DatasetDescriptionSummary()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getContentsBaseType_OtherSource()
