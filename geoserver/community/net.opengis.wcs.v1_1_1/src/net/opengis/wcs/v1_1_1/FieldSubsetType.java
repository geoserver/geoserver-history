 ...
 * <ul>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldSubsetType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldSubsetType#getInterpolationType <em>Interpolation Type</em>}</li>
 *   <li>{@link net.opengis.wcs.v1_1_1.FieldSubsetType#getAxisSubset <em>Axis Subset</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldSubsetType()
...
public interface FieldSubsetType extends EObject {
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldSubsetType_Identifier()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.FieldSubsetType#getIdentifier <em>Identifier</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldSubsetType_InterpolationType()
    ...
    /**
     * Sets the value of the '{@link net.opengis.wcs.v1_1_1.FieldSubsetType#getInterpolationType <em>Interpolation Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * The list contents are of type {@link net.opengis.wcs.v1_1_1.AxisSubsetType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.wcs.v1_1_1.Wcs111Package#getFieldSubsetType_AxisSubset()
     * @model type="net.opengis.wcs.v1_1_1.AxisSubsetType" containment="true"
