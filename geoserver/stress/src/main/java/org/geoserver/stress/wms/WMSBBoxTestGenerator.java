...
public class WMSBBoxTestGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        generator.generatePlan(randomBboxCount, url, new String[] {"topp:states"}, "StatesWMSGetMap");
        generator.generatePlan(randomBboxCount, url, new String[] {"tiger:poly_landmarks", "tiger:tiger_roads", "tiger:poly_landmarks"}, "NycTigerWMSGetMap");
    }
