...
public class TransactionTest extends WFSTestSupport {
    ...
    public void testInsert1() throws Exception {
        String xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\" "
            ...
            + "</sf:PrimitiveGeoFeature>" + "</wfs:Insert>"
            ...
            + "</sf:AggregateGeoFeature>" + "</wfs:Insert>"
            + "</wfs:Transaction>";
    ...
    public void testInsertWithNoSRS() throws Exception {
        ...
        String insert = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\" "
            ...
            + "<cgf:Points>" + "<cgf:pointProperty>" + "<gml:Point>"
            + "<gml:pos>100 100</gml:pos>" + "</gml:Point>"
            + "</cgf:pointProperty>" + "<cgf:id>t0002</cgf:id>"
    ...
    public void testInsertWithSRS() throws Exception {
        ...
        String insert = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\" "
            ...
            + "<cgf:pointProperty>" + "<gml:Point>" + "<gml:pos>1 1</gml:pos>"
            + "</gml:Point>" + "</cgf:pointProperty>"
        ...
        getFeature = "<wfs:GetFeature " + "service=\"WFS\" version=\"1.1.0\" "
            ...
            + "xmlns:ogc=\"http://www.opengis.net/ogc\" "
            + "xmlns:wfs=\"http://www.opengis.net/wfs\" " + "> "
            + "<wfs:Query typeName=\"cgf:Points\"> " + "</wfs:Query> "
            + "</wfs:GetFeature>";
        dom = postAsDOM("wfs", getFeature);
        print(dom);
    ...
    public void testInsertWithGMLProperties() throws Exception {
        String xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\" "
            ...
            + "</gml:location>" + "<gml:name>two</gml:name>"
        ...
        xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\" "
            ...
            + "</sf:location>" + "<sf:name>three</sf:name>"
            + "<sf:foo>3</sf:foo>" + "</sf:WithGMLProperties>"
            + "</wfs:Insert>" + "</wfs:Transaction>";
    ...
    public void testUpdateWithGMLProperties() throws Exception {
        String xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\""
            ...
            + "   <wfs:Property>" + "     <wfs:Name>gml:name</wfs:Name>"
            + "     <wfs:Value>two</wfs:Value>" + "   </wfs:Property>"
            + "   <wfs:Property>" + "     <wfs:Name>gml:location</wfs:Name>"
            + "     <wfs:Value>" + "        <gml:Point>"
            + "          <gml:coordinates>2,2</gml:coordinates>"
            + "        </gml:Point>" + "     </wfs:Value>"
            + "   </wfs:Property>" + "   <wfs:Property>"
            + "     <wfs:Name>sf:foo</wfs:Name>"
            + "     <wfs:Value>2</wfs:Value>" + "   </wfs:Property>"
        ...
        xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\""
            ...
            + " xmlns:wfs=\"http://www.opengis.net/wfs\">"
            + " <wfs:Update typeName=\"sf:WithGMLProperties\">"
            + "   <wfs:Property>" + "     <wfs:Name>sf:name</wfs:Name>"
            + "     <wfs:Value>trhee</wfs:Value>" + "   </wfs:Property>"
            + "   <wfs:Property>" + "     <wfs:Name>sf:location</wfs:Name>"
            + "     <wfs:Value>" + "        <gml:Point>"
            + "          <gml:coordinates>3,3</gml:coordinates>"
            + "        </gml:Point>" + "     </wfs:Value>"
            + "   </wfs:Property>" + "   <wfs:Property>"
            + "     <wfs:Name>sf:foo</wfs:Name>"
            + "     <wfs:Value>3</wfs:Value>" + "   </wfs:Property>"
            + "   <ogc:Filter>" + "     <ogc:PropertyIsEqualTo>"
            + "       <ogc:PropertyName>foo</ogc:PropertyName>"
    ...
    public void testInsertWithBoundedBy() throws Exception {
        String xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\" "
            ...
            + "<wfs:Insert>" + " <cite:BasicPolygons>" + " <gml:boundedBy>"
            + "  <gml:Envelope>"
            + "<gml:lowerCorner>-1.0 2.0</gml:lowerCorner>"
            + "<gml:upperCorner>2.0 5.0</gml:upperCorner>"
            + "  </gml:Envelope>" + " </gml:boundedBy>" + "  <cite:the_geom>"
            + "    <gml:MultiPolygon>" + "      <gml:polygonMember>"
            + "         <gml:Polygon>" + "<gml:exterior>" + "<gml:LinearRing>"
            + "<gml:posList>-1.0 5.0 2.0 5.0 2.0 2.0 -1.0 2.0 -1.0 5.0</gml:posList>"
            + "</gml:LinearRing>" + "</gml:exterior>"
            + "         </gml:Polygon>" + "      </gml:polygonMember>"
            + "    </gml:MultiPolygon>" + "  </cite:the_geom>"
            + "  <cite:ID>foo</cite:ID>" + " </cite:BasicPolygons>"
            + "</wfs:Insert>" + "</wfs:Transaction>";
        ...
        assertEquals("1",
            getFirstElementByTagName(dom, "wfs:totalInserted").getFirstChild()
                .getNodeValue());
        assertTrue(dom.getElementsByTagName("ogc:FeatureId").getLength() > 0);
    }
    ...
    public void testInsert2() throws Exception {
        ...
        assertEquals(1,
            dom.getElementsByTagName("cite:RoadSegments").getLength());
        ...
        assertEquals("4.2582 52.0643 4.2584 52.0648",
    ...
    public void testUpdate() throws Exception {
        String xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\""
            ...
            + "   <wfs:Property>" + "     <wfs:Name>cite:the_geom</wfs:Name>"
            + "     <wfs:Value>"
        ...
        assertEquals("1",
            getFirstElementByTagName(dom, "wfs:totalUpdated").getFirstChild()
                .getNodeValue());
    ...
    public void testUpdateWithInvalidProperty() throws Exception {
        String xml = "<wfs:Transaction service=\"WFS\" version=\"1.1.0\""
            ...
            + " xmlns:wfs=\"http://www.opengis.net/wfs\">"
            + " <wfs:Update typeName=\"cite:RoadSegments\">"
            + "   <wfs:Property>" + "     <wfs:Name>INVALID</wfs:Name>"
            + "     <wfs:Value>INVALID</wfs:Value>" + "   </wfs:Property>"
            + "   <ogc:Filter>" + "     <ogc:PropertyIsEqualTo>"
            + "       <ogc:PropertyName>FID</ogc:PropertyName>"
            + "       <ogc:Literal>102</ogc:Literal>"
            + "     </ogc:PropertyIsEqualTo>" + "   </ogc:Filter>"
