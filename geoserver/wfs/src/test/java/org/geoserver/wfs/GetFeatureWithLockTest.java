...
public class GetFeatureWithLockTest extends WFSTestSupport {
    ...
    public void testGetFeatureWithLockReleaseActionSome()
        ...
        xml = "<wfs:Transaction" + "  service=\"WFS\"" + "  version=\"1.0.0\""
            ...
            + "  <wfs:Update typeName=\"cdf:Locks\">" + "    <wfs:Property>"
            + "      <wfs:Name>cdf:id</wfs:Name>"
            + "      <wfs:Value>gfwlrs0003</wfs:Value>" + "    </wfs:Property>"
            + "    <ogc:Filter>" + "      <ogc:FeatureId fid=\"" + fid1
        ...
        xml = "<wfs:Transaction" + "  service=\"WFS\"" + "  version=\"1.0.0\""
            ...
            + "  <wfs:Update typeName=\"cdf:Locks\">" + "    <wfs:Property>"
            + "      <wfs:Name>cdf:id</wfs:Name>"
            + "      <wfs:Value>gfwlrs0004</wfs:Value>" + "    </wfs:Property>"
            + "    <ogc:Filter>" + "      <ogc:FeatureId fid=\"" + fid2
            + "\"/>" + "    </ogc:Filter>" + "  </wfs:Update>"
            + "</wfs:Transaction>";
