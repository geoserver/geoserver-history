 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceReferenceType#getRequestMessage <em>Request Message</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ServiceReferenceType#getRequestMessageReference <em>Request Message Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceReferenceType()
...
public interface ServiceReferenceType extends ReferenceType {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceReferenceType_RequestMessage()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ServiceReferenceType#getRequestMessage <em>Request Message</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getServiceReferenceType_RequestMessageReference()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ServiceReferenceType#getRequestMessageReference <em>Request Message Reference</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
