 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getServiceIdentification <em>Service Identification</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getOperationsMetadata <em>Operations Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getCapabilitiesBaseType()
...
public interface CapabilitiesBaseType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getCapabilitiesBaseType_ServiceIdentification()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getServiceIdentification <em>Service Identification</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getCapabilitiesBaseType_ServiceProvider()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getServiceProvider <em>Service Provider</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getCapabilitiesBaseType_OperationsMetadata()
     * @model containment="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getOperationsMetadata <em>Operations Metadata</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getCapabilitiesBaseType_UpdateSequence()
     * @model dataType="net.opengis.ows.v1_1_0.UpdateSequenceType"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getUpdateSequence <em>Update Sequence</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getCapabilitiesBaseType_Version()
     * @model dataType="net.opengis.ows.v1_1_0.VersionType" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.CapabilitiesBaseType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
