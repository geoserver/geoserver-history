 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.HTTPType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.HTTPType#getGet <em>Get</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.HTTPType#getPost <em>Post</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getHTTPType()
...
public interface HTTPType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getHTTPType_Group()
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.RequestMethodType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getHTTPType_Get()
     * @model type="net.opengis.ows.v1_1_0.RequestMethodType" containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getHTTPType_Post()
     * @model type="net.opengis.ows.v1_1_0.RequestMethodType" containment="true" transient="true" volatile="true" derived="true"
