 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ExceptionReportType#getException <em>Exception</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ExceptionReportType#getLang <em>Lang</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ExceptionReportType#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getExceptionReportType()
...
public interface ExceptionReportType extends EObject {
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.ExceptionType}.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * <!-- begin-model-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getExceptionReportType_Exception()
     * @model type="net.opengis.ows.v1_1_0.ExceptionType" containment="true" required="true"
     ...
     * @see #setLang(String)
     * @see net.opengis.ows.v1_1_0.Ows11Package#getExceptionReportType_Lang()
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ExceptionReportType#getLang <em>Lang</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getExceptionReportType_Version()
     * @model dataType="net.opengis.ows.v1_1_0.VersionType1" required="true"
    ...
    /**
     * Sets the value of the '{@link net.opengis.ows.v1_1_0.ExceptionReportType#getVersion <em>Version</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
