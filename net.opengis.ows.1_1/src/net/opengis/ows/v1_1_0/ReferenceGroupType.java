 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.ReferenceGroupType#getAbstractReferenceBaseGroup <em>Abstract Reference Base Group</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.ReferenceGroupType#getAbstractReferenceBase <em>Abstract Reference Base</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getReferenceGroupType()
...
public interface ReferenceGroupType extends BasicIdentificationType {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getReferenceGroupType_AbstractReferenceBaseGroup()
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.AbstractReferenceBaseType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getReferenceGroupType_AbstractReferenceBase()
     * @model type="net.opengis.ows.v1_1_0.AbstractReferenceBaseType" containment="true" required="true" transient="true" changeable="false" volatile="true" derived="true"
