 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_1_0.DescriptionType#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DescriptionType#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.opengis.ows.v1_1_0.DescriptionType#getKeywords <em>Keywords</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.ows.v1_1_0.Ows11Package#getDescriptionType()
...
public interface DescriptionType extends EObject {
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDescriptionType_Title()
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDescriptionType_Abstract()
     * @model type="net.opengis.ows.v1_1_0.LanguageStringType" containment="true"
     ...
     * The list contents are of type {@link net.opengis.ows.v1_1_0.KeywordsType}.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see net.opengis.ows.v1_1_0.Ows11Package#getDescriptionType_Keywords()
     * @model type="net.opengis.ows.v1_1_0.KeywordsType" containment="true"
