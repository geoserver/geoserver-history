 ...
 * <ul>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.CapabilitiesBaseTypeImpl#getServiceIdentification <em>Service Identification</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.CapabilitiesBaseTypeImpl#getServiceProvider <em>Service Provider</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.CapabilitiesBaseTypeImpl#getOperationsMetadata <em>Operations Metadata</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.CapabilitiesBaseTypeImpl#getUpdateSequence <em>Update Sequence</em>}</li>
 *   <li>{@link net.opengis.ows.v1_0_0.impl.CapabilitiesBaseTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CapabilitiesBaseTypeImpl extends EObjectImpl implements CapabilitiesBaseType {
	...
	protected EClass eStaticClass() {
		return OWSPackage.eINSTANCE.getCapabilitiesBaseType();
	}
