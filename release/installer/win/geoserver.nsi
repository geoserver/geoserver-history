...
;General
  ...
  ;Name and file
  Name "GeoServer 2.0-alpha2"
  OutFile "geoserver-2.0-alpha2.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\GeoServer 2.0-alpha2"
  
  ;Get installation folder from registry if available
  InstallDirRegKey HKCU "Software\GeoServer-2.0-alpha2" ""
...
;Interface Settings
  ...
  !define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the \
                                installation of GeoServer 2.0-alpha2.  \
...
Section "Uninstall"
  ...
  IfFileExists "$INSTDIR" 0 Removed
     MessageBox MB_YESNO|MB_ICONQUESTION \
          "Remove all files in your GeoServer 2.0-alpha2 directory? (If you have anything you created that you want to keep, click No)" IDNO Removed
     Delete "$INSTDIR\*.*"
     RMDIR /r "$INSTDIR"
     Sleep 500
     IfFileExists "$INSTDIR" 0 Removed
